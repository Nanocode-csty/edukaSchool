...
class Preinscritos2026Seeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $estudiantesData = [
            ['dni' => '10001234', 'nombres' => 'Ana', 'apellidos' => 'García López', 'genero' => 'F', 'fecha_nac' => '2015-03-15'],
            ['dni' => '10001235', 'nombres' => 'Carlos', 'apellidos' => 'Rodríguez Martínez', 'genero' => 'M', 'fecha_nac' => '2014-07-22'],
            ['dni' => '10001236', 'nombres' => 'María', 'apellidos' => 'Fernández Gómez', 'genero' => 'F', 'fecha_nac' => '2015-01-10'],
            ['dni' => '10001237', 'nombres' => 'Luis', 'apellidos' => 'González Díaz', 'genero' => 'M', 'fecha_nac' => '2014-11-05'],
            ['dni' => '10001238', 'nombres' => 'Carmen', 'apellidos' => 'López Sánchez', 'genero' => 'F', 'fecha_nac' => '2015-05-18'],
            ['dni' => '10001239', 'nombres' => 'Miguel', 'apellidos' => 'Martínez Ruiz', 'genero' => 'M', 'fecha_nac' => '2014-09-30'],
            ['dni' => '10001240', 'nombres' => 'Isabel', 'apellidos' => 'Sánchez Moreno', 'genero' => 'F', 'fecha_nac' => '2015-02-28'],
            ['dni' => '10001241', 'nombres' => 'Antonio', 'apellidos' => 'Pérez Álvarez', 'genero' => 'M', 'fecha_nac' => '2014-12-12'],
            ['dni' => '10001242', 'nombres' => 'Rosa', 'apellidos' => 'Martín Romero', 'genero' => 'F', 'fecha_nac' => '2015-04-07'],
            ['dni' => '10001243', 'nombres' => 'Francisco', 'apellidos' => 'Ruiz Navarro', 'genero' => 'M', 'fecha_nac' => '2014-08-25'],
        ];
        ...
        foreach ($estudiantesData as $index => $data) {
            ...
            if (!$matriculaExistente) {
                ...
                // Generar fecha aleatoria dentro del período de preinscripción (noviembre-diciembre 2025)
                $fechaPreinscripcion = Carbon::create(2025, 11, 1)->addDays(rand(0, 60)); // 1 nov al 31 dic 2025

                Matricula::create([
                    'estudiante_id' => $estudiante->estudiante_id,
                    'numero_matricula' => $numeroMatricula,
                    'fecha_matricula' => $fechaPreinscripcion,
                    'estado' => 'Pre-inscrito',
        ...
        // Actualizar fechas de preinscripciones existentes que no estén en el período correcto
        $this->command->info("\n=== AJUSTANDO FECHAS DE PREINSCRIPCIONES EXISTENTES ===");
        $matriculasPreinscritasExistentes = Matricula::where('estado', 'Pre-inscrito')
            ->where('anio_academico', $anioActual)
            ->where('fecha_matricula', '>', Carbon::create(2025, 12, 31))
            ->get();

        $fechasAjustadas = 0;
        foreach ($matriculasPreinscritasExistentes as $matricula) {
            $nuevaFecha = Carbon::create(2025, 11, 1)->addDays(rand(0, 60));
            $matricula->update(['fecha_matricula' => $nuevaFecha]);
            $fechasAjustadas++;
        }

        $this->command->info("✓ Fechas de preinscripción ajustadas: {$fechasAjustadas}");
