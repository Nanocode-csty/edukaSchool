...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            SET
                permite_preinscripcion = COALESCE(JSON_EXTRACT(configuracion, '$.permite_preinscripcion'), false) = true,
                permite_inscripcion = COALESCE(JSON_EXTRACT(configuracion, '$.permite_inscripcion'), false) = true,
                permite_matricula = COALESCE(JSON_EXTRACT(configuracion, '$.permite_matricula'), false) = true,
                clases_activas = COALESCE(JSON_EXTRACT(configuracion, '$.clases_activas'), false) = true
        ");
