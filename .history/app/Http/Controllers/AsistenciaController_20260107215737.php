    ...
    public function descargarReporteHistorial($reporteId)
    {
        ...
        try {
            ...
            if (!$reporte->archivo_path || !file_exists(storage_path('app/public/' . $reporte->archivo_path))) {
                return back()->with('error', 'El archivo del reporte no existe o ha sido eliminado.');
            }

            // Construir el nombre del archivo para descarga
            $nombreArchivo = $reporte->archivo_nombre ?: 'reporte_asistencia.' . $reporte->formato;
