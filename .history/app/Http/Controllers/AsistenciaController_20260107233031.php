...
class AsistenciaController extends Controller
{
    ...
    public function exportarExcelAdmin(Request $request)
    {
        ...
        try {
            ...
            // Guardar el reporte en la base de datos antes de descargar
            ...
            \Log::info('EXPORTANDO EXCEL - Guardando reporte automaticamente', [
            ...
            \Log::info('EXCEL EXPORTADO - Reporte guardado', [
                'reporte_id' => $reporteGenerado->id,
    ...
    private function generarNombreReporte($tipoReporte, $formato, $fechaInicio, $fechaFin)
    {
        ...
        // Para archivos exportados, incluir el formato
