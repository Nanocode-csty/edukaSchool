...
class AsistenciaController extends Controller
{
    ...
    public function reportes()
    {
        ...
        // Obtener datos para filtros adicionales (solo aquellos con registros de asistencia)
        $niveles = InfNivel::whereHas('grados', function($q) {
            $q->whereHas('cursos', function($cq) {
                $cq->whereHas('matriculas', function($mq) {
                    $mq->whereHas('asistenciasAsignatura');
                });
            });
        })->orderBy('nombre')->get();
        ...
        // Get all active teachers for comparative reports (they will be filtered by JavaScript)
        // Only include teachers that have a persona relationship
