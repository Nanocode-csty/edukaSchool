...
class AsistenciaController extends Controller
{
    ...
    public function exportarPDFAdmin(Request $request)
    {
        ...
        try {
            ...
            // Redirigir de vuelta a la página de reportes con mensaje de éxito
            return redirect()->route('asistencia.reportes')->with('success', 'Reporte generado exitosamente. Puedes descargarlo desde "Reportes Generados Recientemente".');
