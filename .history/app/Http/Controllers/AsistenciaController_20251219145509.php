    ...
    public function exportarPDFAdmin(Request $request)
    {
        ...
        try {
            ...
            if ($asistencias->isEmpty()) {
                ...
                // Crear registros demo con distribución garantizada
                // 17 presentes, 2 ausentes, 1 tardanza para 20 registros
                for ($i = 0; $i < min(20, $totalRegistros); $i++) {
                    // Distribución garantizada: índices 0-16 = P, 17-18 = A, 19 = T
                    if ($i >= 0 && $i <= 16) {
                        $codigo = 'P'; // Presentes (17 registros)
                    } elseif ($i >= 17 && $i <= 18) {
                        $codigo = 'A'; // Ausentes (2 registros)
                    } elseif ($i == 19) {
                        $codigo = 'T'; // Tardanza (1 registro)
                    } else {
                        $codigo = 'P'; // Default
                    }
