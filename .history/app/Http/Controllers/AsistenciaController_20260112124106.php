...
class AsistenciaController extends Controller
{
    ...
    public function docenteVerAsistencias()
    {
        try {
            ...
            return view('asistencia.docente-ver-asistencias', compact('sesiones', 'cursos_docente'));
    ...
    public function docenteVerAsistencia($sesionClase)
    {
        try {
            ...
            return view('asistencia.docente-ver-asistencias', compact('sesion', 'asistencias', 'cursos_docente'));
