...
class AsistenciaController extends Controller
{
    ...
    {
        try {
            $query = AsistenciaAsignatura::with(['matricula.estudiante', 'matricula.grado', 'matricula.seccion', 'tipoAsistencia', 'cursoAsignatura.asignatura', 'cursoAsignatura.profesor']);
