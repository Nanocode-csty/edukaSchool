    ...
    public function reporteGeneral(Request $request)
    {
        ...
        if ($cursoId) {
            ...
            if ($curso) {
                ...
                $estudiantesCurso = $matriculas->where('curso_id', $cursoId);
            ...
            // Estadísticas por todos los cursos - agrupar por curso_id de las matrículas
            $cursosAgrupados = $matriculas->groupBy('curso_id');
            foreach ($cursosAgrupados as $cursoId => $matriculasCurso) {
                $curso = \App\Models\InfCurso::with(['grado', 'seccion'])->find($cursoId);
                if ($curso) {
