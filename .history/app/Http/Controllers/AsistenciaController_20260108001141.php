...
class AsistenciaController extends Controller
{
    ...
    public function exportarExcelAdmin(Request $request)
    {
        ...
        try {
            ...
            // Para peticiones normales, descargar directamente
            return $pdf->download($this->generarNombreReporte($request->tipo_reporte, 'excel', $request->fecha_inicio, $request->fecha_fin) . '.xlsx');
        ...
        try {
            ...
            if (strtolower($formato) === 'pdf') {
                ...
                foreach ($asistencias as $asistencia) {
                    ...
                    $sheet->setCellValue('A' . $row, $asistencia->fecha ? $asistencia->fecha->format
