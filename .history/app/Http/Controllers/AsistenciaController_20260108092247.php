    ...
    public function getTablaAsistencias(Request $request)
    {
        try {
            ...
            if ($request->filled('fecha_inicio') && $request->filled('fecha_fin')) {
                ...
                $query->whereBetween('asistencias_diarias.fecha',
            }
            ...
            \Log::info('Method completed successfully, returning basic response');

            // Return a very simple text response to avoid JSON encoding issues
            return response('SUCCESS: Method executed without errors', 200)
