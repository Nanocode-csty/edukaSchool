...
class AsistenciaController extends Controller
{
    ...
    public function reportes()
    {
        ...
        // Si no hay registros en el período académico, usar datos de todos los tiempos
        if ($totalAsistencias == 0) {
            $fechaInicioAnio = AsistenciaDiaria::min('fecha') ?: now()->subMonths(6)->startOfMonth();
            $fechaFinAnio = AsistenciaDiaria::max('fecha') ?: now()->endOfMonth();
            $totalAsistencias = AsistenciaDiaria::whereBetween('fecha', [$fechaInicioAnio, $fechaFinAnio])->count();
        }
