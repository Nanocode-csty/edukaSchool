...
class AsistenciaController extends Controller
{
    ...
    public function representanteDetalle(Request $request, $estudiante_id)
    {
        try {
            ...
            // Usar una consulta más específica para evitar conflictos de nombres de columnas
            $estudiante = \App\Models\InfEstudiante::whereHas('representantes', function($query) use ($representante) {
                $query->where('representante_id', $representante->representante_id);
            })
