    ...
    public function exportarExcelAdmin(Request $request)
    {
        ...
        try {
            ...
            foreach ($asistencias as $asistencia) {
                $nombres = $asistencia->matricula->estudiante->persona->nombres ?? 'Sin nombre';
                $apellidoPaterno = $asistencia->matricula->estudiante->persona->apellido_paterno ?? '';
                $apellidoMaterno = $asistencia->matricula->estudiante->persona->apellido_materno ?? '';
                $apellidos = trim($apellidoPaterno . ' ' . $apellidoMaterno) ?: 'Sin apellidos';
