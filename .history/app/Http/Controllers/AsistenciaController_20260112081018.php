...
class AsistenciaController extends Controller
{
    ...
    public function getTablaAsistencias(Request $request)
    {
        try {
            ...
            // Aplicar filtros de fecha usando la misma lógica que la consulta principal
            $fechasDefault = session('asistencia_fechas_default', []);
            $statsFechaInicio = $request->filled('fecha_inicio') ? $request->fecha_inicio : ($fechasDefault['fecha_inicio'] ?? null);
