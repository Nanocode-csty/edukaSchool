...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        \Log::info('Profile update - Validation passed', [
            ...
            'request_has_file' => $request->hasFile('photo'),
            'request_file_valid' => $request->hasFile('photo') ? $request->file('photo')->isValid() : 'N/A',
            'all_request_files' => $request->allFiles(),
            'user_before_update' => [
                'id' => $user->usuario_id,
        ...
        try {
            ...
            \Log::info('User updated successfully', [
                'user_foto_url_after' => $user->foto_url,
                'user_updated_at' => $user->updated_at,
                'user_all_attributes' => $user->toArray()
            ]);

            // Force refresh the user model to ensure we have the latest data
            $user->refresh();
            \Log::info('User refreshed', [
                'refreshed_foto_url' => $user->foto_url,
                'refreshed_updated_at' => $user->updated_at
            ]);
