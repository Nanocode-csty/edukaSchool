...
class AsistenciaController extends Controller
{
    ...
    public function docenteDashboard()
    {
        ...
        // Debug: Check sesiones for this docente
        \Log::info('Docente Dashboard - Checking sesiones', [
            'docente_id' => $docente->profesor_id,
            'today' => today()->format('Y-m-d'),
            'total_sesiones_hoy' => \App\Models\SesionClase::whereDate('fecha', today())->count(),
            'sesiones_docente_hoy' => \App\Models\SesionClase::whereHas('cursoAsignatura', function($query) use ($docente) {
        ...
        \Log::info('Docente Dashboard - Clases encontradas', [
            'count' => $clases_hoy->count(),
            'clases' => $clases_hoy->map(function($c) {
                return [
                    'id' => $c->sesion_id,
                    'asignatura' => $c->cursoAsignatura->asignatura->nombre ?? 'N/A',
