...
class AsistenciaController extends Controller
{
    ...
    public function docenteDashboard()
    {
        ...
        if (!Auth::user()->persona || !Auth::user()->persona->docente) {
            // Log para debugging
            \Log::warning('Docente sin relación configurada', [
                'user_id' => Auth::id(),
            ...
            return redirect()->route('rutarrr1')->with('error',
                'Tu cuenta de docente no está completamente configurada. Contacta al administrador.');
        }
        ...
        $clases_hoy = \App\Models\SesionClase::with(['cursoAsignatura.curso.grado', 'cursoAsignatura.curso.seccion', 'cursoAsignatura.asignatura', 'aula'])
            ...
            ->map(function($sesion) {
                ...
                $sesion->tiene_asistencia_hoy = AsistenciaDiaria::where('sesion_clase_id', $sesion->id)
