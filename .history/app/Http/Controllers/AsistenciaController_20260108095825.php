...
class AsistenciaController extends Controller
{
    ...
    public function getTablaAsistencias(Request $request)
    {
        try {
            ...
            // Use AsistenciaDiaria table which contains attendance records
            ...
            $asistencias->getCollection()->transform(function ($asistencia) {
                try {
                    ...
                    $sesionClase = $asistencia->sesionClase;
                    $cursoAsignatura = $sesionClase ? $sesionClase->cursoAsignatura : null;
                    ...
                    return [
                        ...
                        'idGrado' => $matricula ? $matricula->idGrado : null,
                        'idSeccion' => $matricula ? $matricula->idSeccion : null,
