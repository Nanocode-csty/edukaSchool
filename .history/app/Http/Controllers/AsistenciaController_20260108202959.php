...
class AsistenciaController extends Controller
{
    ...
    public function exportarPDFAdmin(Request $request)
    {
        ...
        try {
            ...
            if (strtolower($request->get('formato', 'pdf')) === 'pdf') {
    ...
    public function exportarExcelAdmin(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request->get('filtros_aplicados', []))) {
                ...
                foreach ($request->get('filtros_aplicados', []) as $key => $value) {
                    if ($value && $value !== '') {
            ...
            if ($request->filled('tipo_reporte')) {
                switch ($request->tipo_reporte) {
                    case 'por_curso':
                        ...
                        break;
                    case 'por_estudiante':
                        if ($request                                    $filtrosAplicados['Docente'] = $docente->persona->nombres . ' ' . $docente->persona->apellidos;
