...
class AsistenciaController extends Controller
{
    ...
    public function getTablaAsistencias(Request $request)
    {
        try {
            ...
            // Solo matrículas activas - TEMPORALMENTE DESACTIVADO PARA DEBUG
            // $query->whereHas('matricula', function($q) {
            //     $q->where('estado', 'Activo');
            // });

            // Si no hay filtros aplicados, mostrar todas las asistencias por defecto (sin límite de tiempo)
            if (!$request->filled('fecha_inicio') && !$request->filled('fecha_fin') &&
                ...
                // Mostrar todas las asistencias sin filtro de tiempo por defecto
