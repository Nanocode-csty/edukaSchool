            ...
            ->map(function($estudiante) {
                ...
                if ($matriculaActiva) {
                    ...
                    if ($curso) {
                        ...
                        // Si no encuentra curso, asignar uno por defecto para testing
                        $cursoId = 1; // Asignar curso_id por defecto
                        $matriculaActiva->curso_id = $cursoId;
                        $estudiante->matricula = $matriculaActiva;
                    }
                } else {
                    // Si no hay matrícula activa, crear una dummy para testing
                    $estudiante->matricula = (object)['curso_id' => 1];
                    $cursoId = 1;
                }
