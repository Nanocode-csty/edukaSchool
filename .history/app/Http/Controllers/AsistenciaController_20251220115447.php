...
class AsistenciaController extends Controller
{
    ...
    public function reportes()
    {
        ...
        $reportesRecientes = ReporteGenerado::porUsuario(Auth::id())
    ...
    public function exportarPDFAdmin(Request $request)
    {
        ...
        try {
            ...
            $this->guardarReporteGenerado($request, $asistencias->count(), 'pdf');
    ...
    /**
     * Método auxiliar para guardar registro de reporte generado
     */
    private function guardarReporteGenerado(Request $request, int $registrosTotales, string $formato)
    {
        try {
            ...
            ReporteGenerado::create([
                ...
                'fecha_fin' => $fechaFin,
                'filtros_aplicados' => $filtrosAplicados,
                'archivo_path' => "reportes/{$archivoNombre}", // Ruta relativa para storage
