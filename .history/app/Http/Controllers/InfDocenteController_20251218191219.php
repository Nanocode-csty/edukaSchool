...
class InfDocenteController extends Controller
{
    ...
    public function apiIndex()
    {
        $docentes = InfDocente::with('persona')
            ...
            ->select('profesores.profesor_id as id', 'personas.nombres', 'personas.apellido_paterno', 'personas.apellido_materno')
            ...
            ->map(function($docente) {
                return [
                    ...
                    'apellidos' => $docente->apellido_paterno . ' ' . $docente->apellido_materno
                ];
            });
