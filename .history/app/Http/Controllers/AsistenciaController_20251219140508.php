    ...
    public function exportarPDFAdmin(Request $request)
    {
        ...
        try {
            ...
            if ($asistencias->isEmpty()) {
                ...
                // Simular algunos registros para el PDF
                for ($i = 0; $i < min(20, $totalRegistros); $i++) {
                    $asistenciasDemo->push((object)[
                        ...
                        'tipoAsistencia' => (object)['codigo' => rand(0, 1) ? 'P' : 'A'], // Presente o Ausente
            ...
            \Log::info('Exportar PDF - PDF generado, iniciando descarga');
