            ...
            try {
                ...
                foreach ($admins as $admin) {
                    Notificacion::create([
                        ...
                        'tipo' => 'justificacion_nueva',
                        'titulo' => 'Nueva Justificación Solicitada',
                        'mensaje' => "Se ha solicitado una justificación para el estudiante {$matricula->estudiante->persona->nombres} {$matricula->estudiante->persona->apellidos} correspondiente a la fecha {$request->fecha_falta}.",
                        'datos' => [
                            'justificacion_id' => $justificacion->id,
