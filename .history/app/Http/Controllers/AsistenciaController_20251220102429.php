...
class AsistenciaController extends Controller
{
    ...
    public function reportes()
    {
        ...
        $estudiantes = InfEstudiante::with(['persona', 'matricula'])
            ...
            ->map(function($estudiante) {
                ...
                if ($estudiante->matricula) {
                    ...
                    $curso = InfCurso::where('grado_id', $estudiante->matricula->idGrado)
                        ->where('seccion_id', $estudiante->matricula->idSeccion)
                        ->first();

                    if ($curso) {
                        $cursoId = $curso->curso_id;
                        // Set it on the matricula object for the view
                        $estudiante->matricula->curso_id = $cursoId;
                    }
                }

                // Also set it directly on the estudiante for backup
                $estudiante->curso_id_calculado = $cursoId;
