...
class NotasController extends Controller
{
    ...
    public function verNotasEstudiante($id)
    {
        ...
        // TEMPORARY: Return a simple response to test if route works
        return response()->json(['message' => 'Route reached successfully', 'estudiante_id' => $id]);

        $esAccesoAutorizado = false;
        $rolUsuario = auth()->check() ? auth()->user()->rol : null;
