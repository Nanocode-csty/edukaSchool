...
class InfEstudiante extends Model
{
    ...
    {
        return $this->belongsToMany(InfRepresentante::class, 'estudianterepresentante', 'estudiante_id', 'representante_id');
    }
    ...
    {
        return trim(($this->persona?->apellido_paterno ?? '') . ' ' . ($this->persona?->apellido_materno ?? ''));
    }
