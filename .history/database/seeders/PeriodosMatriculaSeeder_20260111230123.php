...
class PeriodosMatriculaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Crear años lectivos si no existen
        $aniosLectivos = [
            [
                'nombre' => '2025-2026',
                'descripcion' => 'Año Lectivo 2025-2026',
                'fecha_inicio' => Carbon::create(2025, 3, 1), // 1 de marzo 2025
                'fecha_fin' => Carbon::create(2025, 12, 20),  // 20 de diciembre 2025
                'estado' => 'INACTIVO'
            ],
            [
                'nombre' => '2026-2027',
                'descripcion' => 'Año Lectivo 2026-2027',
                'fecha_inicio' => Carbon::create(2026, 3, 1), // 1 de marzo 2026
                'fecha_fin' => Carbon::create(2026, 12, 20),  // 20 de diciembre 2026
                'estado' => 'ACTIVO'
            ]
        ];

        foreach ($aniosLectivos as $anioData) {
            InfAnioLectivo::updateOrCreate(
                ['nombre' => $anioData['nombre']],
                $anioData
            );
        }

        // Obtener los años lectivos
        $anio2025 = InfAnioLectivo::where('nombre', '2025-2026')->first();
        $anio2026 = InfAnioLectivo::where('nombre', '2026-2027')->first();
        ...
        // Períodos para 2026
        if ($anio2026) {
            $this->crearPeriodosParaAnio($anio2026, 2026);
        }
