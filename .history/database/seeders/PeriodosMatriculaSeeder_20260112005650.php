...
class PeriodosMatriculaSeeder extends Seeder
{
    ...
    /**
     * Crear períodos específicos para 2026 con fechas corregidas según requerimiento del usuario
     */
    private function crearPeriodosParaAnio2026(InfAnioLectivo $anioLectivo): void
    {
        $periodos = [
            [
                'nombre' => 'Pre-inscripción ' . $anioLectivo->nombre,
                'codigo' => 'PREINSCRIPCION_2026',
                'descripcion' => 'Período para pre-inscripciones anticipadas (noviembre-diciembre 2025)',
                'fecha_inicio' => Carbon::create(2025, 11, 1), // Según requerimiento del usuario
                'fecha_fin' => Carbon::create(2025, 12, 31),   // Según requerimiento del usuario
                'ano_lectivo_id' => $anioLectivo->ano_lectivo_id,
                'tipo_periodo' => 'PREINSCRIPCION',
                'orden' => 1,
                'estado' => 'ACTIVO',
            ...
            [
                'nombre' => 'Inscripciones ' . $anioLectivo->nombre,
                'codigo' => 'INSCRIPCION_2026',
                'descripcion' => 'Período regular de inscripciones',
                'fecha_inicio' => $anioLectivo->fecha_inicio->copy(), // Inicio del año lectivo (marzo 2026)
                'fecha_fin' => $anioLectivo->fecha_inicio->copy()->addDays(14), // 2 semanas después
                'ano_lectivo_id' => $anioLectivo->ano_lectivo_id,
                'tipo_periodo' => 'INSCRIPCION',
                'orden' => 2,
        ...
        $this->command->info('Períodos creados para el año 2026 con fechas corregidas');
    }
}
