...
class PresentationSeeder extends Seeder
{
    ...
    private function crearCursosYEstudiantes()
    {
        ...
        // Obtener grados de primaria (1° a 6°)
        $gradosPrimaria = InfGrado::whereHas('nivel', function($q) {
        ...
        foreach ($gradosPrimaria as $grado) {
            ...
            foreach ($asignaturasParaCurso as $asignaturaData) {
                $asignatura = InfAsignatura::firstOrCreate(
                    ...
                    array_merge($asignaturaData, ['estado' => 'Activo'])
                );
    ...
    private function crearEstudianteParaCurso($curso, $numero)
    {
        ...
        $persona = Persona::create([
            ...
            'email' => 'estudiante' . $numero . '@educa.com',
            'estado' => 'Activo'
        ]);
        ...
        $estudiante = InfEstudiante::create([
            ...
            'codigo_estudiante' => 'EST' . date('Y') . str_pad($numero, 4, '0', STR_PAD_LEFT),
            'estado' => 'Activo'
        ]);
    ...
    {
        $aulasData = [
            ['nombre' => 'Aula 101', 'capacidad' => 25, 'ubicación' => 'Primer piso'],
            ['nombre' => 'Aula 102', 'capacidad' => 25, 'ubicación' => 'Primer piso'],
            ['nombre' => 'Aula 201', 'capacidad' => 30, 'ubicación' => 'Segundo piso'],
            ['nombre' => 'Aula 202', 'capacidad' => 30, 'ubicación' => 'Segundo piso'],
        ];
    ...
    private function crearDatosRepresentantes()
    {
        ...
        foreach ($estudiantes as $estudiante) {
            ...
            $dniRepresentante = 'REP' . str_pad($representanteCreados + 1, 6, '0', STR_PAD_LEFT);
            ...
            $personaRepresentante = Persona::firstOrCreate(
                ...
                [
                    ...
                    'telefono' => '988888' . str_pad($representanteCreados + 1, 3, '0', STR_PAD_LEFT),
                    'email' => 'representante' . ($representanteCreados + 1) . '@educa.com',
                    'estado' => 'Activo'
                ]
            );
            ...
            $representante = InfRepresentante::firstOrCreate(
                ...
                [
                    'codigo_representante' => 'REP' . date('Y') . str_pad($representanteCreados + 1, 4, '0', STR_PAD_LEFT),
                    'estado' => 'Activo'
                ]
            );
