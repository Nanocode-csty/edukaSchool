...
class CompleteDatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        // Step 3: Create matriculas for each student (delete existing first)
        echo "Step 3: Creating matriculas...\n";

        // Delete existing matriculas for these students
        Matricula::whereIn('estudiante_id', $estudiantesIds)->delete();
