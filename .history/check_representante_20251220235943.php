...
echo "\nChecking InfRepresentante record...\n";
$representante = \App\Models\InfRepresentante::where('persona_id', $persona->id_persona)->first();
if ($representante) {
    echo "InfRepresentante found: ID {$representante->representante_id}\n";
} else {
    echo "InfRepresentante not found\n";
}
