    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            ...
            <div class="logo-header" style="background-color: #0e4067; margin: 0 !important; padding: 0 !important; border: none !important; border-bottom: 1px solid #0e4067 !important; height: 70px !important; position: relative !important;">
                ...
                <!-- Sidebar Toggle Button (izquierda, desde 991px) -->
                <button class="btn btn-link text-white p-2 sidebar-toggle d-lg-none" onclick="toggleCustomSidebar()" title="Menú lateral" style="font-size: 1.2rem; position: absolute; top: 50%; left: 15px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    <i class="fas fa-bars"></i>
                </button>

                <!-- Options Menu Toggle Button (centrado, desde 991px) -->
                <button class="btn btn-link text-white p-2 options-toggle d-lg-none" onclick="toggleMobileMenu()" title="Opciones" style="font-size: 1.2rem; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
            ...
            <!-- Mobile Navbar Bar -->
            <div id="mobile-navbar-bar" class="mobile-navbar-bar d-md-none">
                <div class="mobile-navbar-content">
                    ...
                    <!-- Notificaciones -->
                    <div class="mobile-navbar-item" onclick="document.getElementById('navbarDropdown').click()" title="Notificaciones">
                    ...
                    <!-- ¿Necesitas ayuda? -->
                    <div class="mobile-navbar-item" onclick="handleContactClick(event)" title="¿Necesitas ayuda?">
                        <i class="fa fa-envelope"></i>
                        <span>Ayuda</span>
                    </div>

                    <!-- Foto de perfil -->
                    <div class="mobile-navbar-item" onclick="document.querySelector('.profile-pic').click()" title="Perfil">
