...
<body>
    ...
    <style>
        ...
        /* Additional fixes for Atlantis theme interference */
        .navbar-toggler.sidenav-toggler {
            display: inline-block !important;
            visibility: visible !important;
            opacity: 1 !important;
        ...
        .navbar-toggler.sidenav-toggler i {
            color: white !important;
        ...
        /* Force all toggle buttons to be visible regardless of Atlantis theme */
        .logo-header .navbar-toggler,
        .logo-header .topbar-toggler,
        .logo-header .nav-toggle {
            display: inline-block !important;
  ...
  <div class="custom-template">
   ...
   <div class="custom-toggle">
    ...
    <script>
        ...
        // Force show toggle buttons immediately
        (function() {
            // Force show all toggle buttons immediately
            function forceShowButtons() {
                // Force show sidebar toggle button
                const sidebarToggler = document.querySelector('.navbar-toggler.sidenav-toggler');
                if (sidebarToggler) {
                    sidebarToggler.style.display = 'inline-block !important';
                    sidebarToggler.style.visibility = 'visible !important';
                    sidebarToggler.style.opacity = '1 !important';
                    sidebarToggler.style.position = 'static !important';
                    sidebarToggler.style.float = 'none !important';
                    sidebarToggler.classList.remove('hide');
                }

                // Force show topbar toggle button
                const topbarToggler = document.querySelector('.topbar-toggler.more');
                if (topbarToggler) {
                    topbarToggler.style.display = 'inline-block !important';
                    topbarToggler.style.visibility = 'visible !important';
                    topbarToggler.style.opacity = '1 !important';
                    topbarToggler.style.position = 'static !important';
                    topbarToggler.style.float = 'none !important';
                    topbarToggler.classList.remove('hide');
                }

                // Force show nav toggle button
                const navToggle = document.querySelector('.nav-toggle');
                if (navToggle) {
                    navToggle.style.display = 'inline-block !important';
                    navToggle.style.visibility = 'visible !important';
                    navToggle.style.opacity = '1 !important';
                    navToggle.style.position = 'static !important';
                    navToggle.style.float = 'none !important';
                    navToggle.classList.remove('hide');

                    const navToggleBtn = navToggle.querySelector('.btn');
                    if (navToggleBtn) {
                        navToggleBtn.style.display = 'inline-block !important';
                        navToggleBtn.style.visibility = 'visible !important';
                        navToggleBtn.style.opacity = '1 !important';
                        navToggleBtn.classList.remove('hide');
                    }
                }
            }
            ...
            // Run again after a short delay to override any Atlantis theme interference
            setTimeout(forceShowButtons, 100);
            setTimeout(forceShowButtons, 500);
            setTimeout(forceShowButtons, 1000);
        })();

        // Manual sidebar toggle functionality
        document.addEventListener('DOMContentLoaded', function() {
            const toggleButtons = document.querySelectorAll('.sidenav-toggler, .topbar-toggler.more, .nav-toggle .btn');
            ...
            // Force show buttons one more time after everything is loaded
            setTimeout(function() {
                const allButtons = document.querySelectorAll('.navbar-toggler.sidenav-toggler, .topbar-toggler.more, .nav-toggle .btn');
                ...
                console.log('All toggle buttons forced visible');
            }, 1500);
        });
    </script>
