            ...
            customSidebar.innerHTML = `
                ...
                <nav class="custom-sidebar-nav">
                    @if (auth()->user()->hasRole('Administrador'))
                        ...
                        <!-- GESTIÓN ACADÉMICA Section -->
                        <div class="custom-nav-group">
                            <div class="custom-group-title">GESTIÓN ACADÉMICA</div>

                            <!-- Períodos Académicos -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-calendar-alt"></i>
                                    </div>
                                    <span class="custom-section-title">Períodos Académicos</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-content">
                                    <a href="{{ route('matriculas.periodos') }}" class="custom-nav-link">
                                        <i class="fas fa-eye"></i>
                                        <span>Ver Períodos</span>
                                    </a>
                                    <a href="{{ route('matriculas.periodo.actual') }}" class="custom-nav-link">
                                        <i class="fas fa-info-circle"></i>
                                        <span>Período Actual (API)</span>
                                    </a>
                                </div>
                            </div>
                        </div>
