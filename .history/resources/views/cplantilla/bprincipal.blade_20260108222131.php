        ...
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            ...
            <div class="logo-header" style="background-color: #0e4067; margin: 0 !important; padding: 0 !important; border: none !important; border-bottom: 1px solid #0e4067 !important; height: 70px !important; position: relative !important;">
                ...
                <div style="display: flex; align-items: center; height: 70px;">
                    <a class="logo" href="{{ route('rutarrr1') }}" style="margin: 0 !important; padding: 0 !important; display: inline-block;">
                    ...
                    <button class="btn btn-link text-white p-2 sidebar-toggle d-inline-block ml-3" onclick="toggleCustomSidebar()" title="Menú lateral" style="font-size: 1.2rem; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    ...
                    @if (auth()->user()->hasRole('Docente'))
                        ...
                        <div class="custom-nav-section">
                            ...
                            <div class="custom-section-content" id="docente-principal-content">
                                ...
                                <!-- Gestión de Asistencias Submenu -->
                                <div class="custom-nav-submenu">
                                    <div class="custom-submenu-header" data-toggle="docente-gestion">
                                        <i class="fas fa-clipboard-list"></i>
                                        <span>Gestión de Asistencias</span>
                                        <i class="fas fa-chevron-right custom-submenu-arrow"></i>
                                    </div>
                                    <div class="custom-submenu-content" id="docente-gestion-content">
                                        <a href="{{ route('asistencia.docente.index') }}" class="custom-nav-link">
                                            <i class="fas fa-clipboard-check"></i>
                                            <span>Tomar Asistencia</span>
                                        </a>
                                        <a href="{{ route('asistencia.docente.index') }}?view=history" class="custom-nav-link">
                                ...
                                <!-- Reportes Submenu -->
                                <div class="custom-nav-submenu">
                                    <div class="custom-submenu-header" data-toggle="docente-reportes">
                                        <i class="fas fa-chart-bar"></i>
                                        <span>Reportes</span>
                                        <i class="fas fa-chevron-right custom-submenu-arrow"></i>
                                    </div>
                                    <div class="custom-submenu-content" id="docente-reportes-content">
                                        <a href="{{ route('asistencia.docente.dashboard') }}?tab=reportes" class="custom-nav-link">
                                            <i class="fas fa-file-alt"></i>
                                            <span>Reportes de Asistencia</span>
                                        </a>
                                        <a href="{{ route('asistencia.docente.dashboard') }}?tab=estadisticas" class="custom-nav-link">
