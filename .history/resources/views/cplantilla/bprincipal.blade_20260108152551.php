...
-->
  ...
  =========================*/
    ...
    <script>
        ...
        // Sidebar toggle functionality - let Atlantis handle it natively
        function initSidebarToggle() {
            // Atlantis already handles sidebar toggling automatically
            // Just ensure the buttons exist and are clickable
            console.log('Sidebar toggle initialized - Atlantis handles the rest');
        }
    </script>
