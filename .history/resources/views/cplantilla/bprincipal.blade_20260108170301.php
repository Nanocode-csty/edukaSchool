...
<body>
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            <!-- Logo Header -->
            <div class="logo-header" style="background-color: #0e4067; margin: 0 !important; padding: 0 !important; border: none !important; height: 70px !important; position: relative !important;">
                ...
                <button class="btn btn-link text-white p-2" onclick="toggleCustomSidebar()" title="Toggle Sidebar" style="font-size: 1.2rem; position: absolute; top: 50%; right: 15px; transform: translateY(-50%);">
