        ...
        <div class="main-header">
            ...
            <div class="logo-header" style="background-color: #0e4067;">
                ...
                <button class="navbar-toggler sidenav-toggler ml-auto" type="button"
                    id="sidebarToggle" aria-expanded="false" aria-label="Toggle navigation"
                    style="display: block !important; visibility: visible !important; opacity: 1 !important; position: relative !important; z-index: 1000 !important; background: rgba(255,255,255,0.1) !important; border: 1px solid rgba(255,255,255,0.3) !important; border-radius: 4px !important; padding: 8px !important; margin-left: 10px !important;">
                    <span class="navbar-toggler-icon">
                        <i class="fas fa-bars" style="color: white !important; font-size: 18px !important;"></i>
                    </span>
                </button>
...
-->
  ...
  =========================*/
    ...
    <script>
        ...
        // Sidebar toggle functionality - use Atlantis native behavior
        function initSidebarToggle() {
            // For large screens: use the existing topbar-toggler (three dots)
            const topbarToggler = document.querySelector('.topbar-toggler.more');
            if (topbarToggler) {
                topbarToggler.addEventListener('click', function(e) {
                    e.preventDefault();
                    // Atlantis handles this automatically
                });
            }

            // For small screens: use the navbar-toggler (hamburger)
            const navbarToggler = document.querySelector('.navbar-toggler.sidenav-toggler');
            if (navbarToggler) {
                navbarToggler.addEventListener('click', function(e) {
                    // Atlantis handles this automatically - just ensure it works
