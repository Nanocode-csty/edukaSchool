    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header">
            ...
            <div class="logo-header" style="background-color: #0e4067;">
                ...
                <button class="topbar-toggler more"><i class="fas fa-ellipsis-v" style="color: white;"></i></button>
                ...
                <div class="sidebar-content">
                    <div class="user nuevo-user">
                        ...
                        <div class="info">
                            ...
                            <button class="btn btn-link text-white float-right p-0 sidenav-toggler" style="font-size: 18px; line-height: 1;" aria-label="Close sidebar">
