        ...
        <div class="main-header">
            ...
            <div class="logo-header" style="background-color: #0e4067;">
                ...
                <button class="navbar-toggler sidenav-toggler ml-auto" type="button" data-toggle="collapse"
                    ...
                    <span class="navbar-toggler-icon" style="color: white; font-size: 18px; font-weight: bold;">
                        ⋮
                    </span>
                </button>
                <button class="topbar-toggler more" style="display: none !important;"><i class="fas fa-ellipsis-v" style="color: white;"></i></button>
                <div class="nav-toggle" style="display: none !important;">
                    <button class="btn btn-toggle sidenav-overlay-toggler toggled"><i
                            class="fas fa-ellipsis-v" style="color: white;"></i></button>
                </div>
            </div>
