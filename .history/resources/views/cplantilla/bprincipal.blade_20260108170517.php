    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            ...
            <div class="logo-header" style="background-color: #0e4067; margin: 0 !important; padding: 0 !important; border: none !important; border-bottom: 1px solid #0e4067 !important; height: 70px !important; position: relative !important;">
                ...
                <button class="btn btn-link text-white p-2" onclick="console.log('Button clicked'); toggleCustomSidebar()" title="Toggle Sidebar" style="font-size: 1.2rem; position: absolute; top: 50%; right: 15px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            customStyles.textContent = `
                #custom-sidebar-overlay {
                    ...
                    z-index: 99999 !important; /* Aumentado para asegurar visibilidad */
