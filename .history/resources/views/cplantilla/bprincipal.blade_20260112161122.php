...
-->
     ...
     ">
        ...
        ">
                            ...
                            <div class="row g-3">
                            @if(auth()->user()->hasRole('Docente'))
                            <!-- DEBUG: Enlace temporal para estadísticas -->
                            <div class="col-12 mb-3">
                                <div class="alert alert-info">
                                    <strong>DEBUG - Enlaces de prueba:</strong><br>
                                    <a href="/asistencia/docente/estadisticas" class="btn btn-primary btn-sm mr-2" onclick="console.log('Click en enlace directo');">
                                        📊 Enlace Directo (/asistencia/docente/estadisticas)
                                    </a>
                                    <a href="{{ route('asistencia.docente.estadisticas') }}" class="btn btn-success btn-sm mr-2" onclick="console.log('Click en helper Laravel');">
                                        📊 Helper Laravel ({{ route('asistencia.docente.estadisticas') }})
                                    </a>
                                    <button onclick="window.location.href='/asistencia/docente/estadisticas'; console.log('Click en JavaScript redirect');" class="btn btn-warning btn-sm">
                                        📊 JavaScript Redirect
                                    </button>
                                    <br><small class="text-muted">Prueba cada enlace y dime cuál funciona</small>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="custom-nav-group">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="academica-content">
                                    ...
                                    <a href="{{ route('periodos.index') }}" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-calendar-check"></i>
