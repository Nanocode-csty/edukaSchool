            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <!-- SECCIONES POR ROL -->
                        {{-- Debug: Rol actual: {{ auth()->user()->rol }} - Usuario ID: {{ auth()->user()->usuario_id }} - Persona ID: {{ auth()->user()->persona_id }} - Roles: {{ auth()->user()->getRoleNames() ? implode(', ', auth()->user()->getRoleNames()) : 'Sin roles' }} --}}
                        @if (auth()->user()->rol == 'administrador')
