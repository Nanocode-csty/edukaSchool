...
<body>
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin-bottom: 0 !important; padding-bottom: 0 !important;">
            <!-- Logo Header -->
            <div class="logo-header" style="background-color: #0e4067; margin-bottom: 0 !important; padding-bottom: 0 !important;">

                <a class="logo" href="{{ route('rutarrr1') }}" style="margin-bottom: 0 !important; padding-bottom: 0 !important;">

                    <img src="{{ asset('imagenes/Imagen1.png') }}" alt="Logo de la empresa" style="height: 70px; margin-bottom: 0 !important; padding-bottom: 0 !important;">
                </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            customStyles.textContent = `
                ...
                /* MANTENEDORES - Marrón claro para headers */
                .academica-header,
                .estudiantil-header,
                .docente-header,
                .plan-header,
