                ...
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                                    ...
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="{{ route('asistencia.reporte-general') }}">
                                                <span class="sub-item">Reportes y Estadísticas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.dashboard') }}">
                                                <span class="sub-item">Dashboard de Asistencia</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        @if (auth()->user()->rol == 'Profesor')
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#asistencia-profesor"
                                    class="collapsed d-flex align-items-center justify-content-between"
                                    aria-expanded="false" style="background-color: #3a6f92 !important; border-radius: 9px;">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-calendar-check"></i>
                                        <p class="mb-0 ms-2">Asistencias</p>
                                    </div>                                </a>
                                <div class="collapse" id="asistencia-profesor">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ route('asistencia.index') }}">
                                                <span class="sub-item">Registrar Asistencia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.dashboard') }}">
                                                <span class="sub-item">Mi Dashboard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.reporte-curso', ['cursoAsignaturaId' => 1]) }}">
                                                <span class="sub-item">Reportes de Clase</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        @if (auth()->user()->rol == 'Representante')
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#asistencia-representante"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-calendar-check"></i>
                                        <p class="mb-0 ms-2">Asistencia</p>
                                    </div>
                                </a>
                                    ...
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="{{ route('asistencia.justificar') }}">
                                                <span class="sub-item">📝 Justificar Inasistencias</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.dashboard') }}">
