    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header">
            ...
            <div class="logo-header" style="background-color: #0e4067;">
                ...
                <button class="btn btn-link text-white p-2" onclick="toggleCustomSidebar()" title="Toggle Sidebar" style="font-size: 1.2rem;">
...
-->
  ...
  =========================*/
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            customSidebar.innerHTML = `
                ...
                <nav class="custom-sidebar-nav">
                    @if (auth()->user()->hasRole('Administrador'))
                        ...
                        <div class="custom-nav-section">
                            <div class="custom-section-header academica-header" data-toggle="academica">
                                <div class="custom-section-icon">
                            ...
                            <div class="custom-section-content" id="academica-content">
                                <a href="{{ route('asignaturas.index') }}" class="custom-nav-link">
                                    <i class="fas fa-book"></i>
                                    <span>Asignaturas</span>
                                </a>
                                <a href="{{ route('periodos-evaluacion.index') }}" class="custom-nav-link">
                                    <i class="fas fa-calendar-alt"></i>
                                    <span>Periodos</span>
                                </a>
                                <a href="{{ route('registrarcurso.index') }}" class="custom-nav-link">
                        ...
                        <!-- Gestión Estudiantil Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header estudiantil-header" data-toggle="estudiantil">
                                <div class="custom-section-icon">
                                    <i class="fas fa-users"></i>
                                </div>
                                <span class="custom-section-title">Gestión Estudiantil</span>
                                <i class="fas fa-chevron-down custom-section-arrow"></i>
                            </div>
                            <div class="custom-section-content" id="estudiantil-content">
                                <a href="{{ route('estudiante.index') }}" class="custom-nav-link">
                                    <i class="fas fa-user-plus"></i>
                                    <span>Estudiantes</span>
                                </a>
                                <a href="{{ route('registrarrepresentante.index') }}" class="custom-nav-link">
                        ...
                        <!-- Gestión Docente Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header docente-header" data-toggle="docente">
                                <div class="custom-section-icon">
                                    <i class="fas fa-chalkboard-teacher"></i>
                                </div>
                                <span class="custom-section-title">Gestión Docente</span>
                                <i class="fas fa-chevron-down custom-section-arrow"></i>
                            </div>
                            <div class="custom-section-content" id="docente-content">
                                <a href="{{ route('registrardocente.index') }}" class="custom-nav-link">
                                    <i class="fas fa-user-graduate"></i>
                                    <span>Docentes</span>
                                </a>
                                <a href="{{ route('cursoasignatura.index') }}" class="custom-nav-link">
                        ...
                        <!-- Plan Educativo Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header plan-header" data-toggle="plan">
                                <div class="custom-section-icon">
                            ...
                            <div class="custom-section-content" id="plan-content">
                                <a href="{{ route('registrarnivel.index') }}" class="custom-nav-link">
                                    <i class="fas fa-layer-group"></i>
                                    <span>Niveles</span>
                                </a>
                                <a href="{{ route('aulas.index') }}" class="custom-nav-link">
                                    <i class="fas fa-door-open"></i>
                                    <span>Aulas</span>
                                </a>
                                <a href="{{ route('grados.index') }}" class="custom-nav-link">
                                    <i class="fas fa-sort-numeric-up"></i>
                                    <span>Grados</span>
                                </a>
                                <a href="{{ route('secciones.index') }}" class="custom-nav-link">
                                    <i class="fas fa-th-large"></i>
                                    <span>Secciones</span>
                                </a>
                                <a href="{{ route('aniolectivo.index') }}" class="custom-nav-link">
                        ...
                        <!-- Sistema Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header sistema-header" data-toggle="sistema">
                                <div class="custom-section-icon">
                            ...
                            <div class="custom-section-content" id="sistema-content">
                                <a href="{{ route('feriados.index') }}" class="custom-nav-link">
                                    <i class="fas fa-calendar-times"></i>
                                    <span>Feriados</span>
                                </a>
                                <a href="{{ route('comunicado.index') }}" class="custom-nav-link">
                        ...
                        <!-- Usuarios Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header usuarios-header" data-toggle="usuarios">
                                <div class="custom-section-icon">
                            ...
                            <div class="custom-section-content" id="usuarios-content">
                                <a href="{{ route('usuarios.index') }}" class="custom-nav-link">
            ...
            customStyles.textContent = `
                #custom-sidebar-overlay {
                    ...
                    background: linear-gradient(180deg, #0e4067 0%, #1a4d7a 100%);
                    color: white;
                ...
                .matriculas-header {
                    background: linear-gradient(135deg, #347f65 0%, #2e8b57 100%);
                    box-shadow: 0 2px 8px rgba(52, 127, 101, 0.3);
                }

                .pagos-header {
                    background: linear-gradient(135deg, #b68a39 0%, #daa520 100%);
                    box-shadow: 0 2px 8px rgba(182, 138, 57, 0.3);
                }

                .asistencias-header {
                    background: linear-gradient(135deg, #3a6f92 0%, #4682b4 100%);
                    box-shadow: 0 2px 8px rgba(58, 111, 146, 0.3);
                }
        ...
        function toggleCustomSidebar() {
            ...
            try {
                ...
                if (sidebar) {
                    ...
                    console.log('custom sidebar element not found - trying fallback');
                    // Fallback to original sidebar if custom one doesn't exist
                    const fallbackSidebar = document.querySelector('.sidebar');
                    if (fallbackSidebar) {
                        if (sidebarVisible) {
                            fallbackSidebar.style.setProperty('transform', 'translateX(-100%)', 'important');
                            sidebarVisible = false;
                        } else {
                            fallbackSidebar.style.setProperty('transform', 'translateX(0)', 'important');
                            sidebarVisible = true;
                        }
                        console.log('fallback sidebar used');
                    } else {
                        console.log('no sidebar found at all');
                    }
                }
            } catch (error) {
                console.error('Error in toggleCustomSidebar:', error);
            }
        }
    </script>
    ...
    @if (Request::is('rutarrr1'))
        ...
        /* Override Atlantis framework styles */
        .sidebar-force-hidden.sidebar,
        .sidebar.sidebar-force-hidden {
            display: none !important;
            visibility: hidden !important;
            opacity: 0 !important;
        }

        /* Ensure main panel adjusts when sidebar is hidden */
