        ...
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            ...
            <div id="mobile-navbar-bar" class="mobile-navbar-bar d-md-none mobile-navbar-hidden">
                <div class="mobile-navbar-content">
                    ...
                    <div class="mobile-navbar-item" onclick="document.getElementById('quick').classList.toggle('d-none')" title="Operaciones Frecuentes">
            ...
            <style>
                ...
                /* Animación escalonada para los elementos del navbar */
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item {
                    animation: slideInUp 0.6s ease-out forwards;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(1) { animation-delay: 0.1s; }
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(2) { animation-delay: 0.15s; }
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(3) { animation-delay: 0.2s; }
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(4) { animation-delay: 0.25s; }
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(5) { animation-delay: 0.3s; }
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(6) { animation-delay: 0.35s; }
