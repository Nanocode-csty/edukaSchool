            ...
            <div class="logo-header" style="height: 70px !important;">
                ...
                <style>
                    ...
                    nav.navbar * {
                        ...
                        background-color: #053255 !important;
                        box-shadow: none !important;
                        outline: none !important;
                    }
                ...
                <div style="display: flex; align-items: center; height: 70px;">
                    <a class="logo" href="{{ route('rutarrr1') }}"
                        ...
                        <img src="{{ asset('imagenes/Imagen1.png') }}" alt="Logo de la empresa"
                    ...
                    <button class="btn btn-link text-white p-2 sidebar-toggle d-inline-block ml-3"
                        onclick="toggleCustomSidebar()" title="Menú lateral"
                        style="font-size: 1.2rem; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right notification-dropdown"
                                    ...
                                    <li class="dropdown-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>Notificaciones</span>
                                            <a href="{{ route('notificaciones.index') }}" class="text-primary">Ver
                                                todas</a>
                                        </div>
                                    </li>
                                    <li>
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="{{ auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?v=' . time() : asset('adminlte/assets/img/profile.jpg') }}"
                                        class="avatar-img rounded-circle">
                                </div>
                            </a>
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="dashboard">
                                <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ route('asistencia.docente.tomar-asistencia') }}">
                                                <span class="sub-item">Tomar Asistencia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.docente.ver-asistencias') }}">
                                                <span class="sub-item">Ver Asistencias</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.docente.reportes') }}">
                                                <span class="sub-item">Reportes de Asistencia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('asistencia.docente.estadisticas') }}">
                        ...
                        @if (auth()->user()->hasRole('Estudiante'))
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#estudiante-dashboard"
                                    class="collapsed d-flex align-items-center justify-content-between"
                                    aria-expanded="false"
                                    style="background-color: #ffc107 !important ; border-radius: 9px; color: #333 !important;">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-user-graduate"></i>
                                        <p style="color: #333 !important; margin-bottom: 0;">Mi Panel</p>
                                    </div>
                                </a>
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                ...
                                <div class="ml-md-auto py-2 py-md-0">
                                    ...
                                    <a href="{{ route('landing') }}" target="_blanck"
   ...
   <div class="custom-toggle">
    ...
    <script>
        if (performance.getEntriesByType("navigation")[0]?.type === "back_forward") {
            location.href = "{{ route('login.index') }}"; // redirige directo si vuelve con botón atrás
        }
    </script>
            ...
            customSidebar.innerHTML = `
                <div class="custom-sidebar-header">
                    <div class="custom-user-info">
                        <img src="{{ auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?v=' . time() : asset('imagenes/imgDocente.png') }}" alt="User" class="custom-user-avatar">
                ...
                <nav class="custom-sidebar-nav">
                    @if (auth()->user()->hasRole('Administrador'))
                        <!-- PERÍODOS ACADÉMICOS Section -->
                        <div class="custom-nav-group">
                            <div class="custom-group-title">PERÍODOS ACADÉMICOS</div>

                            <!-- Dashboard de Períodos -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos-dashboard">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-tachometer-alt"></i>
                                    </div>
                                    <span class="custom-section-title">Dashboard</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-dashboard-content">
                                    <a href="{{ route('periodos.dashboard') }}" class="custom-nav-link">
                            ...
                            <!-- Gestión de Períodos -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos-gestion">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-calendar-alt"></i>
                                    </div>
                                    <span class="custom-section-title">Gestión de Períodos</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-gestion-content">
                                    <a href="{{ route('periodos.index') }}" class="custom-nav-link">
                                        <i class="fas fa-list"></i>
                                        <span>Ver Períodos</span>
                                    </a>
                                    <a href="{{ route('periodos.create') }}" class="custom-nav-link">
                            ...
                            <!-- Notificaciones -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos-notificaciones">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-bell"></i>
                                    </div>
                                    <span class="custom-section-title">Notificaciones</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-notificaciones-content">
                                    <a href="{{ route('periodos.notificaciones') }}" class="custom-nav-link">
                            ...
                            <!-- Descuentos -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos-descuentos">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-percent"></i>
                                    </div>
                                    <span class="custom-section-title">Descuentos</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-descuentos-content">
                                    <a href="{{ route('periodos.descuentos') }}" class="custom-nav-link">
                            ...
                            <!-- Historial -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header periodos-header" data-toggle="periodos-historial">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-history"></i>
                                    </div>
                                    <span class="custom-section-title">Historial</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="periodos-historial-content">
                                    <a href="{{ route('periodos.historial-matriculas') }}" class="custom-nav-link">
                                        <i class="fas fa-file-alt"></i>
                                        <span>Matrículas por Período</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="custom-nav-group">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="notas-content">
                                    <a href="{{ route('notas.inicio') }}" class="custom-nav-link">
                                        <i class="fas fa-edit"></i>
                                        <span>Registrar Calificaciones</span>
                                    </a>
                                    <a href="{{ route('notas.consulta') }}" class="custom-nav-link">
                    ...
                    @endif
                        ...
                        <div class="custom-nav-section">
                            ...
                            <div class="custom-section-content" id="docente-principal-content">
                                ...
                                <a href="{{ route('asistencia.docente.tomar-asistencia') }}" class="custom-nav-link">
                                    <i class="fas fa-clipboard-check"></i>
                                    <span>Tomar Asistencia</span>
                                </a>
                                <a href="{{ route('asistencia.docente.ver-asistencias') }}" class="custom-nav-link">
                                    <i class="fas fa-eye"></i>
                                    <span>Ver Asistencias</span>
                                </a>
                                <a href="{{ route('asistencia.docente.reportes') }}" class="custom-nav-link">
                                    <i class="fas fa-file-alt"></i>
                                    <span>Reportes de Asistencia</span>
                                </a>
                                <a href="{{ route('asistencia.docente.estadisticas') }}" class="custom-nav-link">
                                    <i class="fas fa-chart-line"></i>
