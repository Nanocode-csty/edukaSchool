    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            customStyles.textContent = `
                ...
                /* Asegurar que todos los headers de mantenedores tengan el color correcto */
                .custom-nav-group .custom-section-header {
                    background: #deb887 !important;
                    color: #5d4e37 !important;
                    border: 2px solid #c69c6d !important;
                }
        ...
        function toggleCustomSidebar() {
            ...
            try {
                ...
                if (sidebar) {
                    ...
                    if (fallbackSidebar) {
                        if (sidebarVisible) {
                            fallbackSidebar.style.setProperty('display', 'none', 'important');
                            sidebarVisible = false;
                        } else {
                            fallbackSidebar.style.setProperty('display', 'block', 'important');
                            sidebarVisible = true;
                        }
