...
<link href="{{ asset('Content/themes/nuna_int/css/style_ReporteSubvenciones.css') }}" rel="stylesheet">
 -->
    ...
    <style>
        ...
        .navbar-header .topbar-toggler.more {
            position: relative !important;
            vertical-align: middle !important;
            display: flex !important;
            align-items: center !important;
    ...
    <script>
        // Force icon centering when DOM is ready
        document.addEventListener('DOMContentLoaded', function() {
            const iconButton = document.querySelector('.topbar-toggler.more');
            if (iconButton) {
                const icon = iconButton.querySelector('i.icon-options-vertical');
                if (icon) {
                    // Force absolute positioning and centering
