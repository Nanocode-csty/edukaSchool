    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (sidebar) {
                ...
                // Set sidebar as overlay (fixed position) with better height calculation
                sidebar.style.setProperty('position', 'fixed', 'important');
                sidebar.style.setProperty('top', headerHeight + 'px', 'important');
                sidebar.style.setProperty('left', '0', 'important');
                // Use a larger height for better visibility on large screens
                sidebar.style.setProperty('height', 'calc(100vh - ' + headerHeight + 'px)', 'important');
                sidebar.style.setProperty('min-height', '500px', 'important'); // Minimum height
                ...
                sidebar.style.setProperty('width', '260px', 'important'); // Fixed width

                // Start hidden
                sidebar.classList.add('sidebar-overlay-hidden');
                ...
                // Specifically force sidebar content elements
                ...
                if (sidebarContent) {
                    ...
                    sidebarContent.style.setProperty('opacity', '1', 'important');
                }

                if (sidebarWrapper) {
                    sidebarWrapper.style.setProperty('display', 'block', 'important');
                ...
                collapseLinks.forEach(link => {
                    link.addEventListener('click', function(e) {
                        ...
                        if (targetElement) {
                            ...
                            // Toggle rotate icon if exists
                            const icon = this.querySelector('.rotate-icon, .fa-angle-down');
                            if (icon) {
                                icon.style.transform = targetElement.classList.contains('show') ? 'rotate(180deg)' : 'rotate(0deg)';
                            }
                        }
                    });
                });

                console.log('Sidebar initialized as overlay, elements found:', allElements.length);
            ...
            try {
                ...
                if (sidebar) {
                    if (sidebarVisible) {
                        ...
                        sidebar.classList.remove('sidebar-overlay-hidden');
                        sidebarVisible = true;
