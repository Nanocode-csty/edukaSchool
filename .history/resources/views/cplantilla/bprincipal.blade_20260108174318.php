  ...
  =========================*/
    ...
    <script>
        ...
        function toggleMobileNotifications() {
            ...
            // Trigger the desktop notifications dropdown
            const navbarDropdown = document.getElementById('navbarDropdown');
            if (navbarDropdown) {
                navbarDropdown.click();
                console.log('Notificaciones toggled');
            } else {
                console.log('navbarDropdown not found');
            }
        }
        ...
        function toggleMobileProfile() {
            ...
            // Trigger the profile dropdown
            const profilePic = document.querySelector('.profile-pic');
            if (profilePic) {
                profilePic.click();
                console.log('Perfil toggled');
            } else {
