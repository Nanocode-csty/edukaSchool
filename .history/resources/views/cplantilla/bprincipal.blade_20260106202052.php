            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <!-- SECCIONES POR ROL -->
                        {{-- Debug: Rol actual: {{ auth()->user()->rol }} - Usuario ID: {{ auth()->user()->usuario_id }} - Persona ID: {{ auth()->user()->persona_id }} - Roles: {{ auth()->user()->getRoleNames() ? implode(', ', auth()->user()->getRoleNames()) : 'Sin roles' }} - HasRole admin: {{ auth()->user()->hasRole('administrador') ? 'SI' : 'NO' }} --}}
                        @if (auth()->user()->rol == 'administrador')
                        ...
                        <li class="nav-item active mt-3">
                            ...
                            <div class="collapse" id="notas">
                                <ul class="nav nav-collapse">
                                    @if (auth()->user()->rol == 'administrador' || auth()->user()->rol == 'docente')
                                        <li>
