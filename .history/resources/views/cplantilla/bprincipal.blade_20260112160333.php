        ...
        ">
                            ...
                            <div class="col-12 mb-3">
                                <div class="alert alert-info">
                                    <strong>DEBUG - Enlace temporal:</strong>
                                    <a href="{{ route('asistencia.docente.estadisticas') }}" class="btn btn-primary btn-sm ml-2">
                                        📊 Ir a Estadísticas ({{ route('asistencia.docente.estadisticas') }})
                                    </a>
                                    <br><small class="text-muted">URL generada por Laravel: {{ route('asistencia.docente.estadisticas') }}</small>
                                </div>
                            </div>
                            @endif
