    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (sidebar) {
                ...
                if (mainPanel) {
                    mainPanel.style.setProperty('margin-left', '260px', 'important');
                    mainPanel.style.setProperty('width', 'calc(100% - 260px)', 'important');
                }

                console.log('Sidebar initialized as visible, elements found:', allElements.length);
        ...
        function toggleCustomSidebar() {
            ...
            try {
                ...
                console.log('mainPanel found:', !!mainPanel);
