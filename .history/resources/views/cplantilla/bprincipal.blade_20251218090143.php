...
<head>
    ...
    <!-- 🔹 jQuery primero - defer para mejor performance -->
    <script src="https://code.jquery.com/jquery-3.6.4.min.js" defer></script>
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js" defer></script>

    <!-- Fonts and icons - optimizado -->
    <script src="{{ asset('adminlte/assets/js/plugin/webfont/webfont.min.js') }}" defer></script>
    <script>
    ...
    <!-- Bootstrap 5 CSS - preload para prioridad -->
    ...
    <!-- CSS Files - preload critical -->
    <link rel="preload" href="{{ asset('adminlte/assets/css/bootstrap.min.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('adminlte/assets/css/atlantis.min.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    <!-- Google Fonts - optimizado y combinado -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&family=Open+Sans:ital,wght@0,300;0,400;1,300;1,400&display=swap" rel="stylesheet">

    <!-- Font Awesome - preload -->
    <link rel="preload" href="{{ asset('adminlte/plugins/fontawesome-free/css/all.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('adminlte/plugins/fontawesome-free/css/all.css') }}"></noscript>

    <!-- PARA EL CALENDAR - defer -->
    <script src="{{ asset('https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/es.js') }}" defer></script>
    <script src="{{ asset('https://cdn.jsdelivr.net/npm/flatpickr') }}" defer></script>

    <!-- Bootstrap Notify - defer -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-notify/0.2.0/js/bootstrap-notify.min.js" defer></script>
                                                        ...
                                                        @if (($hoy->between($fechaInicio, $fechaLimite) && $publico == auth()->user()->rol) || $publico == 'General')
                                                            <div
                                                                ...
                                                                <img src="{{ $foto }}" alt="Flyer"
                                                                    class="flyer-img lazy" loading="lazy"
