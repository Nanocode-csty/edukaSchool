    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            ...
            <div class="logo-header" style="background-color: #0e4067; margin: 0 !important; padding: 0 !important; border: none !important; border-bottom: 1px solid #0e4067 !important; height: 70px !important; position: relative !important;">
                ...
                <a class="logo" href="{{ route('rutarrr1') }}" style="margin: 0 !important; padding: 0 !important; display: block; height: 100%;">
                ...
                <button class="btn btn-link text-white p-2 mobile-options-toggle d-md-none" onclick="toggleMobileMenu()" title="Opciones" style="font-size: 1.2rem; position: absolute; top: 50%; right: 60px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    <i class="fas fa-ellipsis-v"></i>
                </button>

                <!-- Mobile Sidebar Toggle Button -->
                <button class="btn btn-link text-white p-2 mobile-sidebar-toggle d-md-none" onclick="toggleCustomSidebar()" title="Menú lateral" style="font-size: 1.2rem; position: absolute; top: 50%; right: 15px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    <i class="fas fa-bars"></i>
                </button>

                <!-- Sidebar Toggle Button (Desktop) -->
                <button class="btn btn-link text-white p-2 d-none d-md-block" onclick="console.log('Button clicked'); toggleCustomSidebar()" title="Toggle Sidebar" style="font-size: 1.2rem; position: absolute; top: 50%; right: 15px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
                    <i class="fas fa-bars"></i>
                </button>
            ...
            <!-- Mobile Menu Overlay -->
            <div id="mobile-menu-overlay" class="mobile-menu-overlay d-md-none">
                <div class="mobile-menu-content">
                    ...
                    <div class="mobile-menu-body">
                        <!-- Ir a inicio -->
                        <a class="mobile-menu-item evitar-recarga" href="{{ route('rutarrr1') }}">
                            <i class="fas fa-home"></i>
                            <span>Ir a inicio</span>
                        </a>

                        <!-- Notificaciones -->
                        <div class="mobile-menu-item" onclick="document.getElementById('navbarDropdown').click()">
                        ...
                        <!-- ¿Necesitas ayuda? -->
                        <div class="mobile-menu-item" onclick="handleContactClick(event)">
                            <i class="fa fa-envelope"></i>
                            <span>¿Necesitas ayuda?</span>
                        </div>

                        <!-- Foto de perfil -->
                        <div class="mobile-menu-item" onclick="document.querySelector('.profile-pic').click()">
                            ...
                            <div class="mobile-profile-info">
                                <div class="mobile-user-name">{{ auth()->user()->nombres }}</div>
                                <div class="mobile-user-role">{{ auth()->user()->rol }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            try {
                ...
                if (mobileMenu) {
                    if (mobileMenu.style.display === 'flex') {
                        ...
                        console.log('menú móvil ocultado exitosamente');
                    } else {
                        // Mostrar menú móvil
                        console.log('mostrando menú móvil');
                        mobileMenu.style.setProperty('display', 'flex', 'important');
                        document.body.style.overflow = 'hidden'; // Prevenir scroll del fondo
                        console.log('menú móvil mostrado exitosamente');
                    }
                } else {
                    console.log('elemento mobile-menu-overlay no encontrado');
                }
            } catch (error) {
