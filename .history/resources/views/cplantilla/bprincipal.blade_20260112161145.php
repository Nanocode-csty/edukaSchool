        ...
        ">
                            ...
                            <div class="col-12 mb-3">
                                <div class="alert alert-info">
                                    <strong>DEBUG - Solución final:</strong><br>
                                    <button onclick="navigateToStats()" class="btn btn-success btn-lg">
                                        📊 IR A ESTADÍSTICAS DE ASISTENCIA
                                    </button>
                                    <script>
                                        function navigateToStats() {
                                            console.log('Navegando a estadísticas...');
                                            window.location.href = '/asistencia/docente/estadisticas';
                                        }
                                    </script>
                                    <br><small class="text-muted">Este botón debería funcionar correctamente</small>
                                </div>
                            </div>
                            @endif
