                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="{{ auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) : asset('adminlte/assets/img/profile.jpg') }}"
                                    ...
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img
                                                    src="{{ auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) : asset('adminlte/assets/img/profile.jpg') }}"
