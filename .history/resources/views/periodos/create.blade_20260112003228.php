...
$(document).ready(function() {
    ...
    function obtenerAnioSeleccionado() {
        const anioSeleccionado = $('select[name="ano_lectivo_id"]').find('option:selected').text();
        // Extraer solo el número del año (ej: "2025" de "2025")
        const match = anioSeleccionado.match(/^(\d{4})/);
