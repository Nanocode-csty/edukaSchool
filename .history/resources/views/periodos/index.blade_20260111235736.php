                ...
                <div class="collapse show" id="collapseTablaPeriodos">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <div class="table-responsive table-container" style="position: relative;">
                            <!-- Overlay de carga -->
                            @include('ccomponentes.loader', ['id' => 'tableLoadingOverlay'])
...
<style>
    ...
    /* Spinner de carga con puntos animados sobre tabla */
    .table-loading-overlay .spinner-dots {
        display: flex;
        align-items: center;
        gap: 4px;
        background: rgba(10, 139, 179, 0.1);
        padding: 15px 20px;
        border-radius: 25px;
        border: 2px solid #0A8CB3;
    }

    .table-loading-overlay .spinner-dots .dot {
        width: 8px;
        height: 8px;
        border-radius: 50%;
        background-color: #0A8CB3;
        animation: tableDotPulse 1.4s ease-in-out infinite;
    }

    .table-loading-overlay .spinner-dots .dot:nth-child(1) { animation-delay: 0s; }
    .table-loading-overlay .spinner-dots .dot:nth-child(2) { animation-delay: 0.2s; }
    .table-loading-overlay .spinner-dots .dot:nth-child(3) { animation-delay: 0.4s; }
    .table-loading-overlay .spinner-dots .dot:nth-child(4) { animation-delay: 0.6s; }
    .table-loading-overlay .spinner-dots .dot:nth-child(5) { animation-delay: 0.8s; }

    @keyframes tableDotPulse {
        0%, 80%, 100% {
            opacity: 0.3;
            transform: scale(0.8);
        }
