...
$(document).ready(function() {
    ...
    // Función para configurar automáticamente las opciones según el tipo de período
    function configurarOpcionesPorTipo(tipo) {
        ...
        switch(tipo) {
            case 'PREINSCRIPCION':
                $('#permite_preinscripcion').prop('checked', true);
                break;
            case 'INSCRIPCION':
                $('#permite_inscripcion').prop('checked', true);
                break;
            case 'MATRICULA':
                $('#permite_matricula').prop('checked', true);
                break;
            case 'ACADEMICO':
                $('#clases_activas').prop('checked', true);
                break;
            case 'CIERRE':
                // El período de cierre puede tener configuraciones específicas o ninguna por defecto
                break;
        }
    }
    ...
    $('select[name="tipo_periodo"]').on('change', function() {
        ...
        if (tipo) {
            ...
            configurarOpcionesPorTipo(tipo);
        } else {
            // Si no hay tipo seleccionado, limpiar código y opciones
