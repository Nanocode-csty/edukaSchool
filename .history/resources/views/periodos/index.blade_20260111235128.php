                        ...
                        <div class="row mb-3 align-items-end" id="filtrosContainer">
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-primary">
                                    ...
                                    <small id="filterStatus" class="text-muted ms-2 d-none">
...
<style>
    ...
    /* Spinner de carga con puntos animados */
    .spinner-dots {
        display: flex;
        align-items: center;
        gap: 3px;
    ...
    .spinner-dots .dot:nth-child(5) { animation-delay: 0.8s; }
