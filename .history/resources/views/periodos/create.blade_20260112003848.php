...
$(document).ready(function() {
    ...
    // Función para obtener el año del año lectivo seleccionado (síncrona)
    function obtenerAnioSeleccionado() {
        return anioSeleccionadoActual;
    }

    // Función para actualizar el año seleccionado (llamada desde AJAX)
    function actualizarAnioSeleccionado(anioId) {
        if (!anioId) {
        ...
        $.ajax({
            ...
            async: false, // Hacer síncrona para asegurar que se actualice antes de continuar
    ...
    $('select[name="ano_lectivo_id"]').on('change', function() {
        ...
        // Actualizar el año seleccionado primero (síncrono)
        actualizarAnioSeleccionado(anioId);

        // Luego actualizar los tipos de período
