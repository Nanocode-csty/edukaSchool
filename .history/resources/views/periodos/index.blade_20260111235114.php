...
$(document).ready(function() {
    ...
    $('#btnAplicarFiltros').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                // El response ahora contiene directamente el HTML de la vista parcial
                // Actualizar el contenedor completo de la tabla y estadísticas
    ...
    $('#btnLimpiarFiltros').on('click', function() {
        ...
        // Recargar la página completa para limpiar filtros
