        ...
        <ol class="breadcrumb">
            ...
            @if(isset($module) && $module === 'asistencia')
                <li class="breadcrumb-item {{ !isset($section) ? 'active' : '' }}">
                    @if(isset($section))
                        <a href="{{ route('asistencia.dashboard') }}" class="breadcrumb-link">
                    ...
                    @switch($section)
                        @case('dashboard')
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Dashboard de Asistencia</span>
                            </li>
                            @break
                        ...
                        @case('justificaciones')
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Mis Justificaciones</span>
                            </li>
                            @break
