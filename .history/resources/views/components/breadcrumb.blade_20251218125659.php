                    ...
                    @switch($section)
                            ...
                            <li class="breadcrumb-item {{ !isset($subsection) ? 'active' : '' }}">
                                @if(isset($subsection))
                                    <a href="{{ route('asistencia.misEstudiantes') }}" class="breadcrumb-link">
                                        ...
                                        <span class="breadcrumb-text">Lista de Estudiantes</span>
                                    </a>
                                @else
                                    <i class="fas fa-users"></i>
                                    <span class="breadcrumb-text">Lista de Estudiantes</span>
                        ...
                        @case('justificar')
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Solicitar Justificación</span>
                            </li>
                            @break
                        ...
                        @case('asignatura')
                            <li class="breadcrumb-item">
                                @if(auth()->user()->rol == 'Administrador')
                                    <a href="{{ route('asistencia.admin-index') }}" class="breadcrumb-link">
                                        <i class="fas fa-chart-line"></i>
                                        <span class="breadcrumb-text">Control Académico</span>
                                    </a>
                                @else
                                    <a href="{{ route('asistencia.index') }}" class="breadcrumb-link">
                                        <i class="fas fa-chalkboard-teacher"></i>
                        ...
                        @case('reporte-curso')
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Informe de Clase</span>
                            </li>
                            @break
                        ...
                        @case('reporte-estudiante')
                            ...
                            <li class="breadcrumb-item active">
                                <i class="fas fa-chart-line"></i>
                                <span class="breadcrumb-text">Seguimiento Individual</span>
                            </li>
                            @break
                        ...
                        @case('reporte-general')
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Estadísticas Generales</span>
                            </li>
                            @break
                        ...
                        @case('verificar')
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Revisión de Justificaciones</span>
                            </li>
                            @break
