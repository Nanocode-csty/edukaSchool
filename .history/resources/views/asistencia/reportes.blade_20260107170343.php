            ...
            <div class="box_block">
                ...
                function agregarEventListenersFiltrosDinamicos() {
                    ...
                    function actualizarFiltrosDinamicos() {
                        ...
                        if (filtroContainer) {
                            filtroContainer.innerHTML = '<div class="text-center py-3"><
                            let filterHtml = '';
                ...
                case 'comparativo':
                            ...
                            setTimeout(() => {
                                ...
                                if (tipoReporte === 'comparativo') {
                                    // Los filtros dinámicos se cargarán cuando se seleccionen las fechas
                                    console.log('Filtros comparativos configurados, esperando selección de fechas');
                                    ...
                                    setTimeout(() => {
                                        console.log('Agregando event listeners para filtros dinámicos...');
                                        agregarEventListenersFiltrosDinamicos();

                                        // Agregar un botón de prueba para verificar que los filtros funcionan
                                        setTimeout(() => {
                                            const filtroContainer = document.getElementById('filtroContainer');
                                            if (filtroContainer) {
