        ...
        <div class="col-12">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card text-center p-2 bg-light rounded">
                        <div class="stats-icon mb-1">
                            <i class="fas fa-users fa-lg text-success"></i>
                        </div>
                        <div class="stats-value">
                            <h4 class="text-success mb-1">{{ $estadisticas['total_estudiantes'] ?? 0 }}</h4>
                            <small class="text-muted" style="font-size: 0.75rem;">Mis Estudiantes</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card text-center p-2 bg-light rounded">
                        ...
                        <div class="stats-value">
                            <h4 class="text-primary mb-1">{{ $estadisticas['promedio_asistencia'] ?? 0 }}%</h4>
                            <small class="text-muted" style="font-size: 0.75rem;">Asistencia Promedio</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card text-center p-2 bg-light rounded">
                        ...
                        <div class="stats-value">
                            <h4 class="text-warning mb-1">{{ $estadisticas['total_inasistencias'] ?? 0 }}</h4>
                            <small class="text-muted" style="font-size: 0.75rem;">Inasistencias</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stats-card text-center p-2 bg-light rounded">
                        ...
                        <div class="stats-value">
                            <h4 class="text-danger mb-1">{{ $estadisticas['justificaciones_pendientes'] ?? 0 }}</h4>
                            <small class="text-muted" style="font-size: 0.75rem;">Justificaciones Pendientes</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('asistencia.representante.index') }}" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center p-2 action-card">
                                <i class="fas fa-list mb-1"></i>
                                <span class="fw-bold" style="font-size: 0.85rem;">Lista de Estudiantes</span>
                                <small class="text-muted" style="font-size: 0.7rem;">Ver asistencia detallada</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('notas.misEstudiantes') }}" class="btn btn-outline-success w-100 h-100 d-flex flex-column align-items-center justify-content-center p-2 action-card">
                                <i class="fas fa-graduation-cap mb-1"></i>
                                <span class="fw-bold" style="font-size: 0.85rem;">Ver Calificaciones</span>
                                <small class="text-muted" style="font-size: 0.7rem;">Rendimiento académico</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('notificaciones.index') }}" class="btn btn-outline-info w-100 h-100 d-flex flex-column align-items-center justify-content-center p-2 action-card">
                                <i class="fas fa-bell mb-1"></i>
                                <span class="fw-bold" style="font-size: 0.85rem;">Notificaciones</span>
                                <small class="text-muted" style="font-size: 0.7rem;">Mensajes importantes</small>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <button type="button" class="btn btn-outline-secondary w-100 h-100 d-flex flex-column align-items-center justify-content-center p-2 action-card" onclick="mostrarEstadisticas()">
                                <i class="fas fa-chart-pie mb-1"></i>
                                <span class="fw-bold" style="font-size: 0.85rem;">Más Estadísticas</span>
                                <small class="text-muted" style="font-size: 0.7rem;">Análisis detallado</small>
                            </button>
                        </div>
                    </div>
                </div>
