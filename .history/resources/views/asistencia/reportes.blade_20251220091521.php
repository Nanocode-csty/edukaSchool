                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Total de Tardanzas
                                                <span class="badge badge-warning badge-pill">${estadisticas.total_tardanzas || 0}</span>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Total de Justificados
                                                <span class="badge badge-info badge-pill">${estadisticas.total_justificados || 0}</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
