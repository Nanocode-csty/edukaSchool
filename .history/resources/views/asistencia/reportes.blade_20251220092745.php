                ...
                function generarReporte() {
                    ...
                    reporteContent.innerHTML = `
                        <div class="text-center py-4">
                            ...
                            <!-- Indicadores de Estado de Asistencia durante carga -->
                            <div class="mt-3">
                                <small class="text-muted mb-2 d-block">Indicadores de Estado:</small>
                                <div class="d-flex justify-content-center align-items-center flex-wrap gap-3">
                                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span style="display: inline-block; width: 12px; height: 12px; border-radius: 50%; background-color: #ffc107; margin-right: 5px;"></span>
                                        <small class="text-muted">Tarde</small>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span style="display: inline-block; width: 12px; height: 12px; border-radius: 50%; background-color: #17a2b8; margin-right: 5px;"></span>
                                        <small class="text-muted">Justificado</small>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span style="display: inline-block; width: 12px; height: 12px; border-radius: 50%; background-color: #6c757d; margin-right: 5px;"></span>
                                        <small class="text-muted">Sin Registro</small>
                                    </div>
                                </div>
                            </div>
