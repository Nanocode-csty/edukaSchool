                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <button class="btn btn-success btn-sm mr-2" onclick="exportarPDFSesion({{ $sesion->id }})">
                                                    <i class="fas fa-file-pdf"></i> Exportar PDF
                                                </button>
                                                <button class="btn btn-primary btn-sm" onclick="editarAsistenciaSesion({{ $sesion->id }})">
...
function exportarPDFSesion(sesionId) {
    ...
    // Create download URL
    const url = `{{ route('asistencia.docente.exportar-pdf', ':id') }}`.replace(':id', sesionId);
