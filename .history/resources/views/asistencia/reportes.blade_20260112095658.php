                ...
                $('#vista-previa-reporte').html(`
                    <div class="alert alert-success">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="btn btn-outline-secondary btn-sm" onclick="$('#vista-previa-reporte').html('<div class=\"text-center text-muted\"><i class=\"fas fa-chart-bar fa-3x mb-3\"></i><p>Configura los filtros y genera el reporte para ver la vista previa</p></div>')">
                                <i class="fas fa-times mr-1"></i>Limpiar Vista Previa
                            </button>
                        </div>
                    </div>
