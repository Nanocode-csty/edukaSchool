                                ...
                                <div class="col-md-4">
                                    <div class="card border-success">
                                        <div class="card-body text-center">
                                            ...
                                            <h3 class="text-success">{{ $asistencias->whereIn('tipoAsistencia.codigo', ['A', 'P'])->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card border-danger">
                                        <div class="card-body text-center">
                                            ...
                                            <h3 class="text-danger">{{ $asistencias->where('tipoAsistencia.codigo', 'F')->count() }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <span class="badge badge-{{ in_array($asistencia->tipoAsistencia->codigo, ['A', 'P']) ? 'success' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'danger' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'warning' : 'info')) }} badge-lg">
                                                                        <i class="fas {{ in_array($asistencia->tipoAsistencia->codigo, ['A', 'P']) ? 'fa-check' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'fa-times' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'fa-clock' : 'fa-file-medical')) }} mr-1"></i>
                                                                        {{ in_array($asistencia->tipoAsistencia->codigo, ['A', 'P']) ? 'Presente' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'Falta' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'Tarde' : ($asistencia->tipoAsistencia->codigo == 'J' ? 'Justificada' : $asistencia->tipoAsistencia->nombre))) }}
                                                                    </span>
                                                                </td>
