        ...
        <div class="col-12">
            <div class="box_block">
                ...
                function generarReporte() {
                    ...
                    const totalRegistros = @json($totalAsistencias ?? 0);
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge badge-primary badge-pill">${totalRegistros.toLocaleString()}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="alert alert-light">
                                    <small>
                                        ${totalRegistros > 0 ?
                                            ...
                                            'No se encontraron registros de asistencia para el período seleccionado. Se muestran datos de demostración para visualizar la funcionalidad del sistema.'
                                        }
                                    </small>
                                </div>
                            </div>
