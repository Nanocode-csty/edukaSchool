                            ...
                            if (response.redirected) {
                                ...
                                return response.text().then(text => {
                                    if (text.includes('success')) {
                                        // Generar el mismo nombre de archivo que usa el controlador
                                        const now = new Date();
                                        ...
                                        const archivoNombre = `reporte_${tipoReporte}_${fechaInicio}_${fechaFin}_${timestamp}.pdf`;
                                        const pdfUrl = `/storage/reportes/${archivoNombre}`;
