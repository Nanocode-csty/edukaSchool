...
<body>
    ...
    <div class="stats-section">
        <h3 style="margin: 0 0 15px 0; color: #28a745; font-size: 14px;">Estadísticas de Asistencia</h3>
        <div class="stats-grid">
            ...
            <div class="stat-item">
                <span class="stat-value">{{ max(0, $totalEstudiantes - $asistenciasRegistradas) }}</span>
                <span class="stat-label">Sin Registrar</span>
            </div>
        </div>
        <div style="margin-top: 15px; font-size: 10px; color: #666;">
            <strong>Porcentaje de asistencia:</strong> {{ $asistenciasRegistradas > 0 ? round(($presentes / $asistenciasRegistradas) * 100, 1) : 0 }}%
            @if($tarde > 0)
                | <strong>Tarde:</strong> {{ $tarde }}
            @endif
            @if($justificados > 0)
                | <strong>Justificados:</strong> {{ $justificados }}
            @endif
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    @else
                        <span style="color: #6c757d;">No Registrada</span>
                    @endif
                </td>
                <td style="text-align: center;">
                    @if($asistenciaEstudiante)
