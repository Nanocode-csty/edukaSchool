                ...
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-light btn-sm" type="button" id="toggleCalendarBtn" onclick="console.log('Button clicked'); toggleWeeklyCalendar()">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Also initialize calendar on button click as fallback
    const calendarBtn = document.querySelector('[data-target="#weeklyCalendar"]');
    if (calendarBtn) {
        calendarBtn.addEventListener('click', function() {
            console.log('Calendar button clicked');
            // Wait a bit for collapse animation, then load calendar
            setTimeout(function() {
                const container = document.getElementById('weekly-calendar-container');
                if (container && container.innerHTML.trim() === '') {
                    console.log('Loading calendar via button click');
                    cargarCalendarioSemanal();
                }
            }, 300);
        });
...
function toggleWeeklyCalendar() {
    ...
    if (calendarSection && toggleBtn) {
        if (calendarSection.classList.contains('show') || calendarSection.style.display !== 'none') {
            // Hide calendar
