            ...
            <div class="box_block">
                                    ...
                                    <div class="card-body">
                                        <form id="reportForm">
                                            ...
                                            <div class="row" id="filtrosAdicionales" style="display: none;">
                                                <div class="col-md-6" id="filtroContainer">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    document.getElementById('tipo_reporte').addEventListener('change', function() {
                        ...
                        const allFilters = filtrosAdicionales.querySelectorAll('.form-group');
                        ...
                        if (tipoReporte === 'general') {
                            ...
                            switch(tipoReporte) {
                                case 'por_curso':
                                    // Mostrar solo Curso
                                    document.querySelector('label[for="curso_id"]').parentElement.style.display = 'block';
                                    break;
                                case 'por_estudiante':
                                    // Mostrar solo Estudiante
                                    document.querySelector('label[for="estudiante_id"]').parentElement.style.display = 'block';
                                    break;
                                case 'por_docente':
                                    // Mostrar solo Docente
                                    document.querySelector('label[for="docente_id"]').parentElement.style.display = 'block';
                                    break;
                                case 'comparativo':
                                    // Mostrar todos los filtros para comparativo
                                    allFilters.forEach(filter => filter.style.display = 'block');
                                    break;
                            }
                        }
                    });
