                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="d-flex justify-content-end gap-1 flex-wrap">
                                                        <button type="button" class="btn btn-outline-secondary btn-sm px-2" data-toggle="collapse" data-target="#advancedFilters">
                                                            <i class="fas fa-filter"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-primary btn-sm px-3" onclick="aplicarFiltros()">
                                                            <i class="fas fa-search me-1"></i>Buscar
                                                        </button>
                                                        <a href="{{ route('asistencia.admin-index') }}" class="btn btn-outline-danger btn-sm px-2">
                                                            <i class="fas fa-times"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-outline-success btn-sm px-2" onclick="exportarPDF()">
