                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2 flex-wrap">
                                        ...
                                        <a href="{{ route('asistencia.docente.reportes') }}" class="btn btn-sm" style="background-color: #17a2b8 !important; color: white !important; border: none !important;">
                                            <i class="fas fa-file-alt mr-1"></i>Generar Reportes
                                        </a>
