            ...
            <div class="box_block">
                ...
                <div class="collapse show" id="collapseTablaAsistencias">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        <!-- Navegación Rápida a Otras Funciones -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 2px solid #0A8CB3;">
                                    <div class="card-header" style="background: #0A8CB3; color: white;">
                                        <h5 class="mb-0"><i class="fas fa-compass mr-2"></i>Navegación Rápida</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <a href="{{ route('asistencia.reportes') }}" class="btn btn-success btn-block btn-lg" style="height: 80px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-decoration: none; color: white;">
                                                    <i class="fas fa-chart-line fa-2x mb-2"></i>
                                                    <span>Reportes de Asistencia</span>
                                                </a>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <a href="{{ route('asistencia.verificar') }}" class="btn btn-warning btn-block btn-lg" style="height: 80px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-decoration: none; color: white;">
                                                    <i class="fas fa-clipboard-check fa-2x mb-2"></i>
                                                    <span>Gestionar Justificaciones</span>
                                                </a>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <button class="btn btn-info btn-block btn-lg" style="height: 80px; display: flex; flex-direction: column; align-items: center; justify-content: center;" disabled>
                                        ...
                                        <div class="text-center mt-2">
                                            <small class="text-muted">
                                                ...
                                                Accede rápidamente a las funciones principales del módulo de asistencia
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $('#fecha_inicio, #fecha_fin, #tipo_asistencia').on('change', function() {
...
function configurarCascadaFiltros() {
    ...
    // Grado → Secciones (directamente, sin cursos)
    ...
    // Estudiante → Asignaturas (reload asignaturas based on current filters)
