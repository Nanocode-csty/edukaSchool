                ...
                <div class="card card-body rounded-0 border-0 pt-0 pb-2">
                        ...
                        <div class="col-12">
                            <div class="card border-primary">
                                <div class="card-header bg-primary text-white">
                                    <h5 class="mb-0"><i class="fas fa-info-circle mr-2"></i>Información General del Sistema</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="text-center">
                                                <h3 class="text-primary">{{ $reportesRecientes->count() }}</h3>
                                                <p class="text-muted mb-0">Reportes Generados</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="text-center">
                                                <h3 class="text-success">{{ $totalEstudiantes ?? 0 }}</h3>
                                                <p class="text-muted mb-0">Estudiantes Activos</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="text-center">
                                                <h3 class="text-info">{{ $diasAnalizados ?? 0 }}</h3>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-header" style="background: #28a745; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-bullseye mr-2"></i>Objetivos del Sistema</h5>
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled">
                                        <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Monitorear asistencia estudiantil</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Generar reportes precisos</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Facilitar la toma de decisiones</li>
                                        <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Mejorar la comunicación</li>
                                        <li class="mb-0"><i class="fas fa-check-circle text-success mr-2"></i>Optimizar procesos administrativos</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-header" style="background: #ffc107; color: #333;">
                                    <h5 class="mb-0"><i class="fas fa-trophy mr-2"></i>Metas de Rendimiento</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span>Asistencia General</span>
                                            <span class="badge badge-success">{{ $estadisticasRapidas['porcentaje_asistencia'] }}%</span>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: {{ $estadisticasRapidas['porcentaje_asistencia'] }}%"></div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span>Reportes Generados</span>
                                            <span class="badge badge-primary">{{ $reportesRecientes->count() }}</span>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ min($reportesRecientes->count() * 10, 100) }}%"></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span>Estudiantes Activos</span>
                                            <span class="badge badge-info">{{ $estadisticasRapidas['total_estudiantes'] ?? 0 }}</span>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: {{ $estadisticasRapidas['total_estudiantes'] ? min($estadisticasRapidas['total_estudiantes'] * 2, 100) : 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header" style="background: #17a2b8; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-cogs mr-2"></i>Funcionalidades del Sistema de Reportes</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-md-3 col-6 mb-3">
                                            <div class="feature-card p-3 border rounded">
                                                ...
                                                <small class="text-muted">Personaliza tus reportes</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-3">
                                            <div class="feature-card p-3 border rounded">
                                                ...
                                                <small class="text-muted">Visualiza tendencias</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-3">
                                            <div class="feature-card p-3 border rounded">
                                                ...
                                                <small class="text-muted">PDF y Excel</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-3">
                                            <div class="feature-card p-3 border rounded">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header" style="background: #17a2b8; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-chart-line mr-2"></i>Resumen Ejecutivo</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="row text-center">
                                                @php
                                                    $stats = [
                                                        ['icon' => 'fa-user-check', 'color' => '#28a745', 'value' => $estadisticasRapidas['porcentaje_asistencia'] . '%', 'label' => 'Tasa de Asistencia Promedio'],
                                                        ['icon' => 'fa-user-times', 'color' => '#dc3545', 'value' => number_format($estadisticasRapidas['total_inasistencias']), 'label' => 'Total de Ausencias'],
                                                        ['icon' => 'fa-clock', 'color' => '#ffc107', 'value' => number_format($estadisticasRapidas['total_tardanzas']), 'label' => 'Total de Tardanzas'],
                                                        ['icon' => 'fa-check-circle', 'color' => '#17a2b8', 'value' => number_format($estadisticasRapidas['justificaciones_aprobadas']), 'label' => 'Justificaciones Aprobadas'],
                                                        ['icon' => 'fa-users', 'color' => '#6c757d', 'value' => number_format($estadisticasRapidas['total_estudiantes'] ?? 0), 'label' => 'Estudiantes Activos'],
                                                        ['icon' => 'fa-calendar-alt', 'color' => '#343a40', 'value' => number_format($estadisticasRapidas['dias_analizados'] ?? 0), 'label' => 'Días Analizados']
                                                    ];
                                                @endphp
                                                @foreach($stats as $stat)
                                                <div class="col-md-4 col-6 mb-3">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="stats-icon mr-3" style="background: rgba({{ hexdec(substr($stat['color'], 1, 2)) }}, {{ hexdec(substr($stat['color'], 3, 2)) }}, {{ hexdec(substr($stat['color'], 5, 2)) }}, 0.1); color: {{ $stat['color'] }}; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card border-info">
                                                <div class="card-body text-center">
                                                    <h6 class="text-info"><i class="fas fa-info-circle mr-2"></i>Información del Sistema</h6>
                                                    <hr>
                                                    <p class="small text-muted mb-2">Última actualización: <strong>{{ now()->format('d/m/Y H:i') }}</strong></p>
                                                    <p class="small text-muted mb-2">Tipo de reporte: <strong>General</strong></p>
                                                    <p class="small text-muted mb-0">Estado: <span class="badge badge-success">Activo</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header" style="background: #6f42c1; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-chart-bar mr-2"></i>Análisis de Tendencias</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="text-primary"><i class="fas fa-arrow-up mr-2"></i>Indicadores Positivos</h6>
                                            <ul class="list-unstyled">
                                                <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Asistencia promedio por encima del 80%</li>
                                                <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Baja tasa de ausencias recurrentes</li>
                                                <li class="mb-0"><i class="fas fa-check-circle text-success mr-2"></i>Sistema de justificaciones funcionando correctamente</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6">
                                            <h6 class="text-warning"><i class="fas fa-exclamation-triangle mr-2"></i>Áreas de Atención</h6>
                                            <ul class="list-unstyled">
                                                <li class="mb-2"><i class="fas fa-clock text-warning mr-2"></i>Monitorear tardanzas recurrentes</li>
                                                <li class="mb-2"><i class="fas fa-users text-info mr-2"></i>Identificar estudiantes con bajo rendimiento</li>
                                                <li class="mb-0"><i class="fas fa-calendar-check text-primary mr-2"></i>Mejorar asistencia en días específicos</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header" style="background: #e83e8c; color: white;">
                                    <h5 class="mb-0"><i class="fas fa-clipboard-list mr-2"></i>Informes Adicionales</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="text-info"><i class="fas fa-info-circle mr-2"></i>Información General del Sistema</h6>
                                            <div class="card border-info">
                                                <div class="card-body">
                                                    <p class="small mb-2"><strong>Versión del Sistema:</strong> EDUKA v2.1</p>
                                                    <p class="small mb-2"><strong>Base de Datos:</strong> MySQL/MariaDB</p>
                                                    <p class="small mb-2"><strong>Último Backup:</strong> {{ now()->format('d/m/Y') }}</p>
                                                    <p class="small mb-2"><strong>Reportes Generados:</strong> {{ $reportesRecientes->count() }}</p>
                                                    <p class="small mb-0"><strong>Estado del Sistema:</strong> <span class="badge badge-success">Operativo</span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h6 class="text-warning"><i class="fas fa-lightbulb mr-2"></i>Recomendaciones</h6>
                                            <div class="card border-warning">
                                                <div class="card-body">
                                                    <ul class="list-unstyled small mb-0">
                                                        <li class="mb-2"><i class="fas fa-check-circle text-success mr-2"></i>Mantener asistencia promedio ≥ 85%</li>
                                                        <li class="mb-2"><i class="fas fa-exclamation-triangle text-warning mr-2"></i>Revisar estudiantes con < 70% asistencia</li>
                                                        <li class="mb-2"><i class="fas fa-clock text-info mr-2"></i>Implementar recordatorios de asistencia</li>
                                                        <li class="mb-0"><i class="fas fa-users text-primary mr-2"></i>Mejorar comunicación con representantes</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h6 class="text-primary"><i class="fas fa-calendar-alt mr-2"></i>Próximas Acciones Recomendadas</h6>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="mb-0">Análisis Mensual</h6>
                                                                <small class="text-muted">Revisar tendencias mensuales</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="mb-0">Seguimiento Estudiantil</h6>
                                                                <small class="text-muted">Monitorear casos críticos</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <small class="text-muted">Informar a representantes</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
function initReports() {
    console.log('DOM ready, initializing reports...');
    ...
    console.log('Reports fully initialized');
}

// Check if jQuery and other dependencies are loaded
function checkDependencies() {
    if (typeof $ !== 'undefined' && typeof Chart !== 'undefined' && typeof Swal !== 'undefined') {
...
function setupEvents() {
    ...
    $('#tipo_reporte').on('change', function() {
        console.log('Tipo de reporte changed:', $(this).val());
        handleReportTypeChange();
    });

    // Dynamic filters update on date change
    $('#fecha_inicio, #fecha_fin').on('change', function() {
        console.log('Date changed, loading dynamic filters');
        loadDynamicFilters();
    });
