    ...
    <div class="row mt-4 ml-1 mr-1">
        <div class="col-12">
            <div class="box_block">
                ...
                <script>
                // Inicialización básica sin jQuery/Select2 para evitar conflictos con AdminLTE
                document.addEventListener('DOMContentLoaded', function() {
                    console.log('Página cargada, inicializando elementos...');

                    // Wait for Select2 to be available before setting dates
                    const waitForSelect2 = setInterval(() => {
                        if (typeof $ !== 'undefined' && $.fn.select2) {
                            clearInterval(waitForSelect2);
                            console.log('Select2 loaded, setting default dates...');
                            // Set dates to previous month (December 2025) which has attendance data
                            setPeriodo('mesAnterior');

                            // Initialize UI after Select2 is ready
                            setTimeout(() => {
                                initPageUI();
                            }, 500);
                        }
                    ...
                    setTimeout(() => {
                        clearInterval(waitForSelect2);
                        console.log('Timeout reached, setting dates anyway...');
                        setPeriodo('mesAnterior');

                        // Initialize UI even if Select2 check failed
                        setTimeout(() => {
                            initPageUI();
                        }, 500);
                    }, 3000);
                ...
                // Consolidated UI initialization function
                function initPageUI() {
                                ...
                                if (tipoReporte === 'comparativo') {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        if (filtroContainer) {
                                            ...
                                            testButton.innerHTML = '<i class="fas fa-test"></i> Probar Filtros Dinámicos';
                                            testButton.onclick = function() {
                                                console.log('Botón de prueba clickeado - llamando actualizarFiltrosDinamicos');
                                                actualizarFiltrosDinamicos();
                                            };
                                            filtroContainer.appendChild(testButton);
                                        }
                                    }, 500);
                                }
                            }, 100);
