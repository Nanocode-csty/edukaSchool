                ...
                function configurarFiltrosCascada() {
                    ...
                    function filtrarDocentesPorCursoYNivel() {
                        ...
                        docentesOriginales.forEach(option => {
                            ...
                            if (cursoId && incluir) {
                                // Para el demo, simulamos que docentes enseñan en cursos basados en su ID
                                const docenteId = option.value;
                                const docenteIndex = parseInt(docenteId) || 0;

                                // Lógica más inclusiva: cada docente puede enseñar múltiples cursos
                                // Docentes impares: cursos 1, 4, 10
                                // Docentes pares: cursos 4, 10
                                // Todos los docentes pueden enseñar al menos un curso
                                let cursosDocente = [];
                                if (docenteIndex % 2 === 1) {
                                    // Docentes impares enseñan más cursos
                                    cursosDocente = ['1', '4', '10'];
                                } else {
                                    // Docentes pares enseñan cursos 4 y 10
                                    cursosDocente = ['4', '10'];
                                }

                                // Asegurar que al menos haya un docente disponible para cada curso
                                if (cursosDocente.length === 0) {
                                    cursosDocente = ['1', '4', '10']; // Fallback
                                }
