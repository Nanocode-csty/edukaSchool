...
function createDayCard(date, dayName) {
    ...
    if (date.getTime() === today.getTime()) {
        ...
        card.style.boxShadow = '0 0 10px rgba(0, 123, 255, 0.1)';
    }
    ...
    dayHeader.innerHTML = `
        ...
        <div style="font-size: 1.5rem; font-weight: bold; color: #007bff;">${date.getDate()}</div>
    `;
    ...
    card.addEventListener('click', function() {
        ...
        card.style.boxShadow = '0 0 10px rgba(40, 167, 69, 0.2)';
    });

    // Load sessions for this day (placeholder for now)
