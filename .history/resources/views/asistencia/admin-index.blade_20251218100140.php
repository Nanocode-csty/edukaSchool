...
@section('scripts')
    <script>
        ...
        function aplicarFiltros() {
            // Mostrar loading
            const tablaContainer = document.querySelector('.card-body');
            if (tablaContainer) {
            ...
            // Hacer petición AJAX
            fetch('{{ route("asistencia.api.tabla-asistencias") }}?' + params.toString(), {
                method: 'GET',
                headers: {
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            // Hacer petición AJAX
            fetch('{{ route("asistencia.api.tabla-asistencias") }}?' + currentParams.toString(), {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
