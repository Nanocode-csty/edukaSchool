                                        ...
                                        <div class="card-body">
                                            @if($sesiones->count() > 0)
                                                <div class="table-responsive">
                                                    <table class="table table-hover" style="border: 1px solid #28a745; border-radius: 10px; overflow: hidden;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @if(isset($asistencias) && $asistencias->has($sesion->sesion_id))
                                                                @php $asistencia = $asistencias[$sesion->sesion_id] @endphp
                                                                <tr>
                                                ...
                                                <div class="mt-3 text-center text-muted">
                                                    <small>
                                                        @if(isset($sesion))
                                                            Mostrando {{ $asistencias->count() }} estudiantes de la sesión
                                                        @else
