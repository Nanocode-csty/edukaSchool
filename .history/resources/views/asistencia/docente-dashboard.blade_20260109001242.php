                                    ...
                                    <table id="add-row" class="table-hover table" style="border: 1px solid #0A8CB3; border-radius: 10px; overflow: hidden;">
                                        ...
                                        <tbody id="tbodyClases">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!$clase->tiene_asistencia_hoy)
                                                        <button class="btn btn-sm" onclick="tomarAsistencia({{ $clase->sesion_id }})" style="background-color: #28a745 !important; color: white !important; border: none !important;">
                                                            <i class="fas fa-clipboard-check"></i> Tomar
                                                        </button>
                                                    @else
                                                        <a href="{{ route('asistencia.docente.ver', $clase->sesion_id) }}" class="btn btn-sm" style="background-color: #007bff !important; color: white !important; border: none !important;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2 flex-wrap">
                                    <button class="btn btn-sm" onclick="exportarAsistenciaHoy()" style="background-color: #ffc107 !important; color: #333 !important; border: none !important;">
                                        <i class="fas fa-download mr-1"></i>Exportar Asistencias del Día
                                    </button>
                                    <button class="btn btn-sm" onclick="verEstadisticasSemanales()" style="background-color: #007bff !important; color: white !important; border: none !important;">
