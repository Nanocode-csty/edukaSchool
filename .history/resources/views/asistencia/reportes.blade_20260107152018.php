                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-3">
                                                        <div class="d-flex align-items-center">
                                                            <span class="badge badge-success mr-2" style="width: 16px; height: 16px; border-radius: 50%; padding: 0; display: inline-block; border: 2px solid #fff; box-shadow: 0 0 0 1px #28a745;"></span>
                                                            <small class="text-muted">Presente</small>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="badge badge-danger mr-2" style="width: 16px; height: 16px; border-radius: 50%; padding: 0; display: inline-block; border: 2px solid #fff; box-shadow: 0 0 0 1px #dc3545;"></span>
                                                            <small class="text-muted">Ausente</small>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="badge badge-warning mr-2" style="width: 16px; height: 16px; border-radius: 50%; padding: 0; display: inline-block; border: 2px solid #fff; box-shadow: 0 0 0 1px #ffc107;"></span>
                                                            <small class="text-muted">Tarde</small>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="badge badge-info mr-2" style="width: 16px; height: 16px; border-radius: 50%; padding: 0; display: inline-block; border: 2px solid #fff; box-shadow: 0 0 0 1px #17a2b8;"></span>
                                                            <small class="text-muted">Justificado</small>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="badge badge-secondary mr-2" style="width: 16px; height: 16px; border-radius: 50%; padding: 0; display: inline-block; border: 2px solid #fff; box-shadow: 0 0 0 1px #6c757d;"></span>
