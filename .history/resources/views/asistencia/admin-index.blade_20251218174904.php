...
function limpiarFiltros() {
    ...
    $('#fecha_inicio').val('{{ date("Y-m-d", strtotime("-30 days")) }}');
...
function cargarOpcionesFiltrosAvanzados() {
    ...
    $.get('{{ route("api.niveles") }}', function(data) {
    ...
    // Cargar grados
    $.get('{{ route("api.grados") }}', function(data) {
        $('#grado_id').html('<option value="">Todos los grados</option>');
        data.forEach(function(grado) {
            $('#grado_id').append(`<option value="${grado.id}">${grado.nombre}</option>`);
        });
    });

    // Cargar cursos
    $.get('{{ route("api.cursos") }}', function(data) {
    ...
    // Cargar secciones
    $.get('{{ route("api.secciones") }}', function(data) {
    ...
    // Cargar estudiantes
    $.get('{{ route("api.estudiantes") }}', function(data) {
    ...
    // Cargar docentes
    $.get('{{ route("api.docentes") }}', function(data) {
    ...
    // Cargar asignaturas
    $.get('{{ route("api.asignaturas") }}', function(data) {
