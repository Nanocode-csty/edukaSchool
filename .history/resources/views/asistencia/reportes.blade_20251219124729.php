        ...
        <div class="col-12">
            <div class="box_block">
                ...
                function generarReporte() {
                    ...
                    // Mostrar contenido del reporte con datos reales
                    const reporteContent = document.getElementById('reporteContent');
                    const estadisticas = @json($estadisticasRapidas);
                    const totalRegistros = @json(42); // Total real de registros en asistenciasasignatura

                    reporteContent.innerHTML = `
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle mr-2"></i>
                            Reporte generado exitosamente para el período ${fechaInicio} - ${fechaFin}. Utiliza el botón "Exportar" para descargar el archivo.
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                            ...
                                            <div class="card-body p-2">
                                                ...
                                                <div style="width: 50px; height: 50px; position: relative;">
                                                    <svg width="50" height="50">
                                                        <circle cx="25" cy="25" r="20" stroke="#e9ecef" stroke-width="4" fill="none"></circle>
                                                        <circle cx="25" cy="25" r="20" stroke="#28a745" stroke-width="4" fill="none"
                                                                stroke-dasharray="125.66370614359172"
                                                                stroke-dashoffset="${125.66370614359172 * (1 - ${estadisticas.porcentaje_asistencia}/100)}"
                                                                transform="rotate(-90 25 25)"></circle>
                                                    </svg>
                                                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 12px; font-weight: bold; color: #28a745;">
                                                        ${estadisticas.porcentaje_asistencia}%
                                                    </div>
                                                </div>
                                                </div>
                                                <h6 class="card-title mb-1" style="font-size: 0.8rem;">Asistencia</h6>
                                                    ...
                                                    <div style="width: 50px; height: 50px; position: relative;">
                                                        <svg width="50" height="50">
                                                            ...
                                                            <circle cx="25" cy="25" r="20" stroke="#dc3545" stroke-width="4" fill="none"
                                                                    ...
                                                                    stroke-dashoffset="${2 * Math.PI * 20 * (1 - ${estadisticas.total_inasistencias}/${totalRegistros})}"
                                                                    transform="rotate(-90 25 25)"></circle>
                                                        </svg>
                                                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 12px; font-weight: bold; color: #dc3545;">
                                                            ${estadisticas.total_inasistencias}
                                                        </div>
                                                    </div>
                                                </div>
                                                <h6 class="card-title mb-1" style="font-size: 0.8rem;">Ausencias</h6>
                                                <small class="text-muted">${Math.round(${estadisticas.total_inasistencias}/${totalRegistros}*100)}% del total</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-3">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-center mb-2">
                                                    <div style="width: 50px; height: 50px; position: relative;">
                                                        <svg width="50" height="50">
                                                            <circle cx="25" cy="25" r="20" stroke="#e9ecef" stroke-width="4" fill="none"></circle>
                                                            <circle cx="25" cy="25" r="20" stroke="#ffc107" stroke-width="4" fill="none"
                                                                    stroke-dasharray="${2 * Math.PI * 20}"
                                                                    stroke-dashoffset="${2 * Math.PI * 20 * (1 - ${estadisticas.total_tardanzas}/${totalRegistros})}"
                                                                    transform="rotate(-90 25 25)"></circle>
                                                        </svg>
                                                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 12px; font-weight: bold; color: #ffc107;">
                                                            ${estadisticas.total_tardanzas}
                                                        </div>
                                                    </div>
                                                </div>
                                                <h6 class="card-title mb-1" style="font-size: 0.8rem;">Tardanzas</h6>
                                                <small class="text-muted">${Math.round(${estadisticas.total_tardanzas}/${totalRegistros}*100)}% del total</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-3">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-center mb-2">
                                                    <div style="width: 50px; height: 50px; position: relative;">
                                                        <svg width="50" height="50">
                                                            <circle cx="25" cy="25" r="20" stroke="#e9ecef" stroke-width="4" fill="none"></circle>
                                                            <circle cx="25" cy="25" r="20" stroke="#17a2b8" stroke-width="4" fill="none"
                                                                    stroke-dasharray="${2 * Math.PI * 20}"
                                                                    stroke-dashoffset="${2 * Math.PI * 20 * (1 - ${estadisticas.justificaciones_aprobadas}/10)}"
                                                                    transform="rotate(-90 25 25)"></circle>
                                                        </svg>
                                                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 12px; font-weight: bold; color: #17a2b8;">
                                                            ${estadisticas.justificaciones_aprobadas}
                                                        </div>
                                                    </div>
                                                </div>
                                                <h6 class="card-title mb-1" style="font-size: 0.8rem;">Justificadas</h6>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-light">
                                    <small>
                                        Se analizaron ${totalRegistros} registros de asistencia. La tasa de asistencia promedio es del ${estadisticas.porcentaje_asistencia}%.
                                        ${totalRegistros > 0 ? 'Los datos mostrados corresponden a su base de datos real.' : 'No se encontraron registros de asistencia para el período seleccionado.'}
                                    </small>
                                </div>
                                <div class="mt-3">
                                    <h6>Distribución por Tipo:</h6>
                                    <div class="progress" style="height: 20px;">
                                        <div class="progress-bar bg-success" style="width: ${Math.round((totalRegistros - ${estadisticas.total_inasistencias}) / totalRegistros * 100)}%">
                                            Presente: ${totalRegistros - ${estadisticas.total_inasistencias}}
                                        </div>
                                        <div class="progress-bar bg-danger" style="width: ${Math.round(${estadisticas.total_inasistencias} / totalRegistros * 100)}%">
                                            Ausente: ${estadisticas.total_inasistencias}
                                        </div>
                                    </div>
                                </div>
                            </div>
