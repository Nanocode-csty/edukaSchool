...
function toggleWeeklyCalendar() {
    alert('¡Botón "Ver Calendario" funciona! Creando calendario directamente...');

    const calendarSection = document.getElementById('weeklyCalendar');
    if (calendarSection) {
        // Create calendar content directly
        const calendarHtml = `
            <div class="card-body p-0" style="display: block !important; visibility: visible !important; opacity: 1 !important;">
                <div id="weekly-calendar-container">
