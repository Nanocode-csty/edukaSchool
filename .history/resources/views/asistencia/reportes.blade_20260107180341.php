...
<script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    console.log('🚀 Inicializando página de reportes de asistencia...');
                    ...
                    setTimeout(() => {
                        clearInterval(checkLibraries);
                        console.warn('⚠️ Timeout esperando librerías, inicializando de todas formas');
                        initializePage();
                    }, 5000);
                });
                ...
                function initializePage() {
                    console.log('🎯 Iniciando configuración de página...');

                    // Set default dates (previous month with data)
                ...
                function setupEventListeners() {
                    ...
                    if (tipoReporteSelect) {
                        tipoReporteSelect.addEventListener('change', handleTipoReporteChange);
                    }

                    // Dynamic filters event listeners
                    agregarEventListenersFiltrosDinamicos();

                    // Chart update listeners
                ...
                function handleTipoReporteChange() {
                    ...
                    if (!filtrosAdicionales || !filtroContainer) return;
                    ...
                    // Initialize Select2 for new elements (safely)
                    setTimeout(() => {
                        $('.form-control').each(function() {
                            const elementId = $(this).attr('id');
                            if ($(this).length > 0 && elementId !== 'tipo_reporte' && elementId !== 'formato' &&
                                elementId !== 'fecha_inicio' && elementId !== 'fecha_fin') {
