                    ...
                    <div class="col-12">
                        <div class="quick-nav d-flex justify-content-center">
                            <div class="nav nav-pills" role="tablist">
                                <a class="nav-link active" href="{{ route('asistencia.representante.index') }}">
                                    <i class="fas fa-calendar-check mr-2"></i>Asistencias
                                </a>
                                <a class="nav-link" href="{{ route('notas.misEstudiantes') }}">
...
.quick-nav .nav-pills .nav-link.active {
    background: linear-gradient(135deg, #28aece, #0e4067);
    border-color: #28aece;
    color: white;
