...
function guardarEdicionAsistencia(form) {
    ...
    // In edit mode, collect ALL checked radio buttons - this ensures all students with selected attendance are included
    ...
    console.log('selectedAttendance como referencia:', selectedAttendance);
