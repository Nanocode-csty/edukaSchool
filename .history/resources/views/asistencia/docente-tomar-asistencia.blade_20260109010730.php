                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control student-search" id="search_{{ $clase->sesion_id }}"
                                                                   placeholder="Buscar estudiante por nombre..." data-sesion-id="{{ $clase->sesion_id }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                            ...
                                            <form id="form-asistencia-{{ $clase->sesion_id }}" class="attendance-form" data-sesion-id="{{ $clase->sesion_id }}">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-sm">
                                                        ...
                                                        <tbody id="students-table-{{ $clase->sesion_id }}">
                                                            @php
                                                            ...
                                                            <tr class="student-row" data-student-name="{{ strtolower($matricula->estudiante->persona->nombres . ' ' . $matricula->estudiante->persona->apellidos) }}" data-attendance-type="present">
                                                                <td class="text-center font-weight-bold student-number">{{ $index + 1 }}</td>
                                                                <td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('[id^="students-table-"]').forEach(table => {
        const sesionId = table.id.replace('students-table-', '');
...
function aplicarFiltros(sesionId) {
    ...
    rows.forEach((row, index) => {
        ...
        const attendanceType = row.getAttribute('data-attendance-type') || 'present';
