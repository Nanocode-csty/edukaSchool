...
@section('contenidoplantilla')
                            ...
                            <div class="col-12">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        @if(isset($estadisticas['mensaje_info']))
                                            <div class="alert alert-info mt-3" role="alert">
                                                <i class="fas fa-info-circle me-2"></i>
                                                <strong>Información:</strong> {{ $estadisticas['mensaje_info'] }}
                                            </div>
                                        @endif
                                        @if($estadisticas['total_registros'] == 0 && $estadisticas['total_estudiantes'] > 0)
                                            <div class="alert alert-warning mt-3" role="alert">
                                                <i class="fas fa-exclamation-triangle me-2"></i>
                                                <strong>Nota:</strong> Se encontraron {{ $estadisticas['total_estudiantes'] }} estudiantes matriculados, pero no hay registros de asistencia para el período seleccionado. Las estadísticas muestran 0 porque aún no se ha registrado asistencia.
                                            </div>
                                        @endif
                                    </div>
                                </div>
    ...
    <script>
        ...
        function aplicarFiltrosReporte() {
            ...
            // For teachers, ensure profesor_id is set from hidden field
            @if(auth()->user()->rol === 'Profesor')
                formValues.profesorId = '{{ auth()->user()->docente ? auth()->user()->docente->profesor_id : "" }}';
            @endif
