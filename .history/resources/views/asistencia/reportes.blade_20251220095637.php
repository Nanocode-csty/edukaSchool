            ...
            <div class="box_block">
                ...
                function configurarFiltrosCascada() {
                    ...
                    nivelSelect.addEventListener('change', function() {
                        ...
                        if (nivelId) {
                            // Habilitar curso y filtrar opciones
                            ...
                            cursoOptions.forEach(option => {
                                if (option.value === '') {
                                    option.style.display = 'block'; // Mostrar opción vacía
                                } else {
                                    const dataNivel = option.getAttribute('data-nivel');
                                    if (dataNivel === nivelId) {
                    ...
                    cursoSelect.addEventListener('change', function() {
                        ...
                        // Limpiar estudiante y docente
                        estudianteSelect.value = '';
                        docenteSelect.value = '';

                        if (cursoId) {
                            // Habilitar estudiante y filtrar opciones
