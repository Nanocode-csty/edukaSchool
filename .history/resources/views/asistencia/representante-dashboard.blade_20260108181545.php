                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('asistencia.representante.index') }}" class="btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 action-card">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('notas.misEstudiantes') }}" class="btn btn-outline-success w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 action-card">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="{{ route('notificaciones.index') }}" class="btn btn-outline-info w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 action-card">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <button type="button" class="btn btn-outline-secondary w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 action-card" onclick="mostrarEstadisticas()">
