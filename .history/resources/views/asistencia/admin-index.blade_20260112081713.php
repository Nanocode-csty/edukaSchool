                    ...
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <div class="row mb-3 align-items-end" id="filtrosContainer">
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control filtro-input" id="fecha_inicio" value="{{ $fechaMinima ? \Carbon\Carbon::parse($fechaMinima)->format('Y-m-d') : '' }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-bold text-primary">Fecha Fin</label>
                                <input type="date" class="form-control filtro-input" id="fecha_fin" value="{{ $fechaMaxima ? \Carbon\Carbon::parse($fechaMaxima)->format('Y-m-d') : '' }}">
                            </div>
                            <div class="col-md-3">
...
function aplicarFiltrosRapidos() {
    // Incluir TODOS los filtros aplicados, no solo los principales
    currentFilters = {
        fecha_inicio: $('#fecha_inicio').val() || undefined,
        fecha_fin: $('#fecha_fin').val() || undefined,
        tipo_asistencia: $('#tipo_asistencia').val() || undefined,
        nivel_id: $('#nivel_id').val() || undefined,
        grado_id: $('#grado_id').val() || undefined,
        seccion_id: $('#seccion_filtro_id').val() || undefined,
        estudiante_id: $('#estudiante_id').val() || undefined,
        docente_id: $('#docente_id').val() || undefined,
        asignatura_id: $('#asignatura_id').val() || undefined
    };
