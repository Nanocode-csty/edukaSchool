                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="form-label fw-bold text-primary mb-2" style="font-size: 0.85rem;">
                                                            <i class="fas fa-search me-2"></i>FILTRAR ESTUDIANTE POR
                                                        </label>
                                                        <div class="row g-2">
                                                            <div class="col-4">
                                                                <select name="filtro_estudiante_tipo" id="filtro_estudiante_tipo" class="form-control form-control-sm"
                                                                        style="border-radius: 6px; border: 2px solid #e3f2fd; font-size: 0.75rem;">
                                                                    <option value="dni" {{ ($filtros['filtro_estudiante_tipo'] ?? 'dni') == 'dni' ? 'selected' : '' }}>DNI</option>
                                                                    <option value="nombres" {{ ($filtros['filtro_estudiante_tipo'] ?? 'dni') == 'nombres' ? 'selected' : '' }}>Nombre</option>
                                                                    <option value="apellidos" {{ ($filtros['filtro_estudiante_tipo'] ?? 'dni') == 'apellidos' ? 'selected' : '' }}>Apellido</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-8">
                                                                <input type="text" name="filtro_estudiante_valor" id="filtro_estudiante_valor" class="form-control form-control-sm"
                                                                       placeholder="Ingrese el valor..." value="{{ $filtros['filtro_estudiante_valor'] ?? '' }}"
                                                                       style="border-radius: 6px; border: 2px solid #e3f2fd; font-size: 0.8rem;"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="filter-group-card">
                                                    ...
                                                    <div class="filter-group-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-12 mt-3">
                                                                <label for="estudiante_id" class="form-label estilo-info">
                                                                    <i class="fas fa-user-graduate mr-1"></i>Estudiante
                                                                </label>
                                                                <select name="estudiante_id" id="estudiante_id" class="form-control select-search" style="width: 100% !important;">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            // No need for student search initialization anymore
        });
        ...
        function aplicarFiltros() {
            ...
            // Filtros rápidos
            const filtroEstudianteTipoElement = document.getElementById('filtro_estudiante_tipo');
            const filtroEstudianteValorElement = document.getElementById('filtro_estudiante_valor');
            ...
            const filtroEstudianteTipo = filtroEstudianteTipoElement ? filtroEstudianteTipoElement.value : '';
            const filtroEstudianteValor = filtroEstudianteValorElement ? filtroEstudianteValorElement.value.trim() : '';
            ...
            if (filtroEstudianteTipo && filtroEstudianteValor) {
                params.set('filtro_estudiante_tipo', filtroEstudianteTipo);
                params.set('filtro_estudiante_valor', filtroEstudianteValor);
            }
