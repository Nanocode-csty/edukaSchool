                                ...
                                <div class="card text-center" style="border-left: 4px solid #28a745;">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            ...
                                            <div>
                                                <h3 class="mb-0 text-success">{{ $estadisticasRapidas['porcentaje_asistencia'] }}%</h3>
                                ...
                                <div class="card text-center" style="border-left: 4px solid #dc3545;">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            ...
                                            <div>
                                                <h3 class="mb-0 text-danger">{{ number_format($estadisticasRapidas['total_inasistencias']) }}</h3>
                                ...
                                <div class="card text-center" style="border-left: 4px solid #ffc107;">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            ...
                                            <div>
                                                <h3 class="mb-0 text-warning">{{ number_format($estadisticasRapidas['total_tardanzas']) }}</h3>
                                ...
                                <div class="card text-center" style="border-left: 4px solid #17a2b8;">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            ...
                                            <div>
                                                <h3 class="mb-0 text-info">{{ number_format($estadisticasRapidas['justificaciones_aprobadas']) }}</h3>
