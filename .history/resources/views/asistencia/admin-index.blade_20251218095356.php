                                ...
                                <div class="filter-toolbar mb-3">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap">
                                            <div class="input-group input-group-sm" style="width: 250px;">
                                                ...
                                                <input type="text" name="buscar" id="buscar" class="form-control"
                                                       placeholder="Buscar estudiante..." value="{{ $filtros['buscar'] ?? '' }}">
                                            </div>

                                            <select name="tipo_asistencia_id" id="tipo_asistencia_id" class="form-control form-control-sm" style="width: 150px;">
                                                <option value="">Tipo asistencia</option>
                                            ...
                                            <input type="date" name="fecha_desde" id="fecha_desde" class="form-control form-control-sm"
                                                   style="width: 140px;" placeholder="Desde" value="{{ $filtros['fecha_desde'] ?? '' }}">

                                            <input type="date" name="fecha_hasta" id="fecha_hasta" class="form-control form-control-sm"
                                                   style="width: 140px;" placeholder="Hasta" value="{{ $filtros['fecha_hasta'] ?? '' }}">
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ route('asistencia.admin-index') }}" class="btn btn-outline-secondary btn-sm">
                                                <i class="fas fa-times"></i> Limpiar
                                            </a>
                                            <button type="button" class="btn btn-outline-info btn-sm" onclick="exportarPDF()">
