                                            ...
                                            <div class="row g-4 mb-4">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="buscar" id="buscar" class="form-control form-control-lg"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tipo_asistencia_id" id="tipo_asistencia_id" class="form-control form-control-lg"
                                                                style="border-radius: 8px; border: 2px solid #e3f2fd;">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="fecha_desde" id="fecha_desde" class="form-control form-control-lg"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="fecha_hasta" id="fecha_hasta" class="form-control form-control-lg"
