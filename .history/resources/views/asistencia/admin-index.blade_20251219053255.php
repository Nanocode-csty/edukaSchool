                ...
                <div class="collapse show" id="collapseTablaAsistencias">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <div class="row mb-3 align-items-end" id="filtrosContainer">
                            ...
                            <div class="col-md-2">
                                <label class="form-label fw-bold text-primary">Docente</label>
                                <select class="form-control filtro-input select2-basic" id="docente_id">
                                    <option value="">Todos los docentes</option>
                                    <!-- Se cargarán dinámicamente -->
                                </select>
                            </div>
                            <div class="col-md-2">
                                <label class="form-label fw-bold text-primary">Asignatura</label>
                                <select class="form-control filtro-input select2-basic" id="asignatura_id">
...
$(document).ready(function() {
    ...
    // Cargar docentes y asignaturas en el filtro principal
    cargarDocentes();
    cargarAsignaturas();
...
function configurarCascadaFiltros() {
    ...
    // Note: docente_id and asignatura_id filters removed
}
...
function cargarSecciones(cursoId = null) {
