                                        ...
                                        <table id="add-row" class="table-hover table" style="border: 1px solid #007bff; border-radius: 10px; overflow: hidden;">
                                            ...
                                            <tbody id="tbodyAsistencias">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong>{{ $asistencia->matricula->estudiante->persona->nombres ?? 'Sin nombre' }} {{ $asistencia->matricula->estudiante->persona->apellidos ?? 'Sin apellidos' }}</strong>
                                                    </td>
                                                    <td>
                                                        @if($asistencia->matricula->curso)
                                                            {{ $asistencia->matricula->curso->grado->nombre ?? 'Sin grado' }} {{ $asistencia->matricula->curso->seccion->nombre ?? 'Sin sección' }}
                                                        @else
                                                            Sin curso asignado
                                                        @endif
                                                    </td>
                                                    <td>{{ $asistencia->cursoAsignatura->asignatura->nombre ?? 'Sin asignatura' }}</td>
                                                    <td>
                                                        @if($asistencia->tipoAsistencia)
                                                            ...
                                                            @else
                                                                <span class="badge badge-secondary">{{ $asistencia->tipoAsistencia->codigo }}</span>
                                                            @endif
                                                        @else
