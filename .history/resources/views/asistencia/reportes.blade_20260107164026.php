        ...
        <div class="col-12">
            <div class="box_block">
                ...
                function agregarEventListenersFiltrosDinamicos() {
                    ...
                    fechaInicioInput.addEventListener('change', actualizarFiltrosDinamicos);
                    fechaFinInput.addEventListener('change', actualizarFiltrosDinamicos);
                ...
                function configurarFiltrosCascada() {
                    ...
                    function filtrarDocentesPorCursoYNivel() {
                        ...
                        // Si no hay filtros aplicados, mostrar todos los docentes
                        if (!cursoId && !nivelId) {
                            ...
                            // Filtrar basado en curso o nivel seleccionado
                            docentesOriginales.forEach(option => {
                                if (option.value === '') return; // Mantener opción vacía
                                ...
                                // Si hay curso seleccionado, mostrar todos los docentes (ya que todos pueden enseñar)
                                // En un sistema real, esto se filtraría por docentes que enseñan ese curso específico
                                if (cursoId) {
                                    // Para el demo, todos los docentes pueden enseñar cualquier curso
                                    incluir = true;
                                }

                                // Si hay nivel seleccionado, mostrar todos los docentes (ya que todos pueden enseñar en cualquier nivel)
                                // En un sistema real, esto se filtraría por docentes que enseñan en ese nivel
                                if (nivelId) {
                                    // Para el demo, todos los docentes pueden enseñar en cualquier nivel
                                    incluir = true;
                                }
