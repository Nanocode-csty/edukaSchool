            ...
            <div class="box_block">
                ...
                <div class="collapse show" id="collapseDashboardRepresentante">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <!-- Navegación Principal - Acciones Principales -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card border-success" style="border-width: 2px;">
                                    <div class="card-header" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white;">
                                        <h5 class="mb-0">
                                            <i class="fas fa-compass mr-2"></i>Navegación Principal
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <a href="{{ route('asistencia.representante.index') }}" class="btn btn-primary btn-block py-4 h-100 d-flex flex-column align-items-center justify-content-center" style="min-height: 120px;">
                                                    <i class="fas fa-calendar-check fa-3x mb-3"></i>
                                                    <span class="h5 mb-0">Ver Asistencias</span>
                                                    <small class="text-white-50">Consultar asistencia de estudiantes</small>
                                                </a>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <a href="{{ route('notas.misEstudiantes') }}" class="btn btn-warning btn-block py-4 h-100 d-flex flex-column align-items-center justify-content-center" style="min-height: 120px;">
                                                    <i class="fas fa-chart-bar fa-3x mb-3"></i>
                                                    <span class="h5 mb-0">Ver Calificaciones</span>
                                                    <small class="text-white-50">Revisar notas y calificaciones</small>
                                                </a>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <button type="button" class="btn btn-info btn-block py-4 h-100 d-flex flex-column align-items-center justify-content-center" onclick="mostrarEstadisticas()" style="min-height: 120px;">
                                                    <i class="fas fa-chart-pie fa-3x mb-3"></i>
                                                    <span class="h5 mb-0">Estadísticas</span>
                                                    <small class="text-white-50">Análisis detallado de rendimiento</small>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-3 col-sm-6 mb-3">
                                                <button type="button" class="btn btn-outline-secondary btn-block py-3" onclick="mostrarEstadisticas()">
                                                    ...
                                                    <strong>Más Estadísticas</strong>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
