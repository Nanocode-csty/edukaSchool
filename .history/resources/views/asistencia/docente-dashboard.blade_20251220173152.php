    ...
    <div class="row">
        <div class="col-12">
            ...
            @if(isset($error))
                ...
                <!-- No mostrar el resto del contenido si hay error -->
                @php return; @endphp
            @endif
                                ...
                                <div class="class-item {{ $clase->tiene_asistencia_hoy ? 'completed' : '' }}">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 text-right">
                                            ...
                                            @else
                                                <button class="btn btn-info btn-sm quick-action-btn" onclick="verAsistencia({{ $clase->sesion_id }})">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fas fa-clipboard-check mr-2"></i>Tomar Asistencia</h5>
...
function descargarReporte(reporteId) {
    window.open('{{ route("reportes.descargar", ":id") }}'.replace(':id', reporteId), '_blank');
}
