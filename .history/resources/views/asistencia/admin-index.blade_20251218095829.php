                        ...
                        <div class="row margen-movil" style="padding:20px;">
                            <div class="col-12">
                                ...
                                <div class="filter-toolbar mb-4">
                                    <div class="card" style="border: 1px solid #e1e5e9; border-radius: 8px;">
                                        <div class="card-body p-3">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="row g-3">
                                                        <div class="col-md-4">
                                                            <label class="form-label fw-bold text-muted" style="font-size: 0.8rem;">
                                                                <i class="fas fa-search me-1"></i>BUSCAR ESTUDIANTE
                                                            </label>
                                                            <input type="text" name="buscar" id="buscar" class="form-control form-control-sm"
                                                                   placeholder="Nombre, apellido o DNI..." value="{{ $filtros['buscar'] ?? '' }}">
                                                        </div>

                                                        <div class="col-md-3">
                                                            <label class="form-label fw-bold text-muted" style="font-size: 0.8rem;">
                                                                <i class="fas fa-check-circle me-1"></i>TIPO ASISTENCIA
                                                            </label>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="d-flex justify-content-end gap-2 flex-wrap">
                                                        <button type="button" class="btn btn-outline-secondary btn-sm px-3" data-toggle="collapse" data-target="#advancedFilters">
                                                        ...
                                                        <a href="{{ route('asistencia.admin-index') }}" class="btn btn-outline-danger btn-sm px-3">
                                                            <i class="fas fa-times me-1"></i>Limpiar
                                                        </a>
                                                        <button type="button" class="btn btn-outline-success btn-sm px-3" onclick="exportarPDF()">
                                                    ...
                                                    <div class="filter-group-body">
                                                        <div class="row g-3">
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="profesor_id" id="profesor_id" class="form-control form-control-sm select-search">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="curso_id" id="curso_id" class="form-control form-control-sm select-search">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select name="asignatura_id" id="asignatura_id" class="form-control form-control-sm select-search">
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-end gap-2">
                                                    <button type="submit" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-search"></i> Aplicar Filtros Avanzados
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
...
@section('scripts')
    <script>
        ...
        function aplicarFiltros() {
            ...
            // Agregar parámetros de los filtros rápidos
            const buscar = document.getElementById('buscar').value;
            const tipoAsistencia = document.getElementById('tipo_asistencia_id').value;
            const fechaDesde = document.getElementById('fecha_desde').value;
            const fechaHasta = document.getElementById('fecha_hasta').value;

            if (buscar) urlParams.set('buscar', buscar);
            else urlParams.delete('buscar');

            if (tipoAsistencia) urlParams.set('tipo_asistencia_id', tipoAsistencia);
            else urlParams.delete('tipo_asistencia_id');

            if (fechaDesde) urlParams.set('fecha_desde', fechaDesde);
            else urlParams.delete('fecha_desde');

            if (fechaHasta) urlParams.set('fecha_hasta', fechaHasta);
            else urlParams.delete('fecha_hasta');

            // Resetear página a 1 cuando se aplican filtros
            urlParams.set('page', '1');

            // Redirigir con los nuevos parámetros
            window.location.href = '{{ route("asistencia.admin-index") }}?' + urlParams.toString();
        }
