                ...
                function configurarFiltrosCascada() {
                    ...
                    function filtrarDocentesPorCursoYNivel() {
                        ...
                        docentesOriginales.forEach(option => {
                            ...
                            // Si hay curso seleccionado, filtrar docentes que enseñan ese curso
                            if (cursoId) {
                                // Buscar si este docente tiene asignaturas en el curso seleccionado
                                const docenteId = option.value;
                                // Para simplificar, por ahora incluimos todos los docentes si hay curso seleccionado
                                // En una implementación completa, verificaríamos las relaciones curso-docente
                                incluir = true; // Todos los docentes disponibles
                            }

                            // Si hay nivel seleccionado, podríamos filtrar docentes que enseñan en ese nivel
                            // Por ahora, mantenemos todos los docentes disponibles
