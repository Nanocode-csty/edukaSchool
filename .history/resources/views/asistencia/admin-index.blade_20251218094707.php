                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md-8">
                                                            <label for="buscar" class="form-label estilo-info">
                                                                <i class="fas fa-search mr-1"></i>Buscar por estudiante (Nombre, apellido, DNI)
                                                            </label>
                                                            <input type="text" name="buscar" id="buscar" class="form-control form-control-sm"
                                                                   placeholder="Ej: Juan Pérez, 12345678..." value="{{ $filtros['buscar'] ?? '' }}">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="tipo_asistencia_id" class="form-label estilo-info">
                                                                <i class="fas fa-check-circle mr-1"></i>Tipo de Asistencia
                                                            </label>
