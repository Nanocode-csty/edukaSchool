        ...
        <div class="col-12">
            <div class="box_block">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge badge-danger badge-pill">${estadisticas.total_inasistencias}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        Total de Tardanzas
                                        <span class="badge badge-warning badge-pill">${estadisticas.total_tardanzas}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        Justificaciones Aprobadas
                                        <span class="badge badge-info badge-pill">${estadisticas.justificaciones_aprobadas}</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-light">
                                    <small>
                                        Se analizaron ${totalRegistros} registros de asistencia para el período seleccionado. La tasa de asistencia promedio es del ${estadisticas.porcentaje_asistencia}%.
                                        Los datos mostrados corresponden a su base de datos real.
                                    </small>
                                </div>
                                <div class="mt-3">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="card border-success">
                                                <div class="card-body p-2">
                                                    <h5 class="text-success">${totalRegistros - estadisticas.total_inasistencias}</h5>
                                        ...
                                        <div class="col-6">
                                            <div class="card border-danger">
                                                <div class="card-body p-2">
                                                    <h5 class="text-danger">${estadisticas.total_inasistencias}</h5>
                ...
                function exportarReporte() {
                    ...
                    if (formato === 'pdf') {
                        // Construir URL con parámetros GET para la descarga
                        ...
                        // Crear URL completa
                        const url = `/asistencia/exportar/pdf/admin?${params.toString()}`;

                        // Abrir en nueva ventana/ventana emergente para descarga
