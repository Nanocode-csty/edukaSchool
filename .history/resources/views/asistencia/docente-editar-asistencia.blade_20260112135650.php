...
document.addEventListener('DOMContentLoaded', function () {
    console.log('=== INICIALIZANDO EVENT LISTENERS PARA EDICIÓN ===');
    ...
    console.log(`Encontradas ${attendanceOptions.length} opciones de asistencia`);
    attendanceOptions.forEach((option, index) => {
