...
function configurarCascadaFiltros() {
    ...
    $('#nivel_id').on('change', function() {
        ...
        $('#curso_filtro_id').val('').trigger('change');
    ...
    // Curso → Secciones
    $('#curso_filtro_id').on('change', function() {
        const cursoId = $(this).val();
        cargarSecciones(cursoId);
    ...
    // Docente → Asignaturas (docentes enseñan asignaturas específicas)
