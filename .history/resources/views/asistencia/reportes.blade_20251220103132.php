                ...
                function configurarFiltrosCascada() {
                    ...
                    function filtrarDocentesPorCursoYNivel() {
                        ...
                        docentesOriginales.forEach(option => {
                            ...
                            if (cursoId && incluir) {
                                // Para el demo, simulamos que algunos docentes enseñan ciertos cursos
                                const docenteId = option.value;
                                const docenteIndex = parseInt(docenteId) || 0;

                                // Simular que cada docente enseña en cursos específicos
                                // Docente 1: curso 1, Docente 2: curso 4, Docente 3: curso 10, etc.
                                const cursosPorDocente = {
                                    '1': ['1'],      // Docente 1 enseña curso 1
                                    '2': ['4'],      // Docente 2 enseña curso 4
                                    '3': ['10'],     // Docente 3 enseña curso 10
                                    '4': ['1'],      // Docente 4 enseña curso 1
                                    '5': ['4'],      // Docente 5 enseña curso 4
                                    '6': ['10']      // Docente 6 enseña curso 10
                                };

                                const cursosDocente = cursosPorDocente[docenteId] || [];
