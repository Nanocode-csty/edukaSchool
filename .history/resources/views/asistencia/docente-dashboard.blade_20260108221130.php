                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2 flex-wrap">
                                    <button class="btn btn-sm" onclick="exportarAsistenciaHoy()" style="background-color: #ffc107; color: #333; border: none;">
                                        <i class="fas fa-download mr-1"></i>Exportar Asistencias del Día
                                    </button>
                                    <button class="btn btn-sm" onclick="verEstadisticasSemanales()" style="background-color: #007bff; color: white; border: none;">
