                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="filter-actions">
                                                        <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="collapse" data-target="#advancedFilters" title="Filtros Avanzados">
                                                            <i class="fas fa-filter"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-primary btn-sm" onclick="aplicarFiltros()">
                                                            <i class="fas fa-search me-1"></i>Buscar
                                                        </button>
                                                        <a href="{{ route('asistencia.admin-index') }}" class="btn btn-outline-danger btn-sm" title="Limpiar Filtros">
                                                            <i class="fas fa-times"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-outline-success btn-sm" onclick="exportarPDF()" title="Exportar PDF">
