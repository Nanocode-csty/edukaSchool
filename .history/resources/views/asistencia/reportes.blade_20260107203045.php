...
function setupEvents() {
    ...
    $('#tipo_reporte').off('change').on('change', function() {
        console.log('Tipo de reporte changed:', $(this).val());
        handleReportTypeChange();
    });

    // Dynamic filters update on date change
    $('#fecha_inicio, #fecha_fin').off('change').on('change', function() {
        console.log('Date changed, loading dynamic filters');
        loadDynamicFilters();
    });

    // Quick period buttons - use direct event binding
    ...
    // Clear dates button
    $('.limpiar-btn').off('click').on('click', function(e) {
        e.preventDefault();
    ...
    $('#generarReporteBtn').off('click').on('click', function(e) {
        e.preventDefault();
