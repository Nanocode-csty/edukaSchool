        ...
        <div class="col-12">
            <div class="box_block">
                ...
                <div class="card mb-4">
                    ...
                    <div id="weeklyCalendar" class="card-body p-0 calendar-hidden">
...
function toggleWeeklyCalendar() {
    ...
    console.log('toggleWeeklyCalendar called');
    console.log('calendarSection:', calendarSection);
    console.log('toggleBtn:', toggleBtn);

    if (calendarSection && toggleBtn) {
        console.log('Calendar section found, current classes:', calendarSection.className);
        console.log('Current display style:', calendarSection.style.display);

        if (calendarSection.classList.contains('calendar-hidden')) {
            console.log('Showing calendar');
            // Show calendar
            calendarSection.classList.remove('calendar-hidden');
            calendarSection.classList.add('show');
            calendarSection.style.display = 'block';
            calendarSection.style.visibility = 'visible';
            calendarSection.style.opacity = '1';
            console.log('After showing - display:', calendarSection.style.display, 'visibility:', calendarSection.style.visibility);
            if (icon) {
                icon.classList.remove('fa-chevron-down');
                icon.classList.add('fa-chevron-up');
            }
            ...
            if (container) {
                console.log('Container innerHTML length:', container.innerHTML.trim().length);
                if (container.innerHTML.trim() === '') {
                    console.log('Loading calendar content...');
                    cargarCalendarioSemanal();
                } else {
                    console.log('Calendar content already loaded');
                }
            } else {
            ...
            // Hide calendar
            calendarSection.classList.add('calendar-hidden');
            calendarSection.classList.remove('show');
            calendarSection.style.display = 'none';
            calendarSection.style.visibility = 'hidden';
            console.log('After hiding - display:', calendarSection.style.display, 'visibility:', calendarSection.style.visibility);
            if (icon) {
                icon.classList.remove('fa-chevron-up');
                icon.classList.add('fa-chevron-down');
            }
        ...
        console.log('ERROR: Calendar section or button not found');
    }
}
