        ...
        <div class="col-12">
            <div class="box_block">
                ...
                function configurarFiltrosCascada() {
                    ...
                    // Función para aplicar filtros bidireccionales reconstruyendo las opciones
                    function aplicarFiltrosBidireccionales() {
                        ...
                        console.log('Aplicando filtros bidireccionales:', {
                            nivel: nivelSeleccionado,
                            curso: cursoSeleccionado,
                            estudiante: estudianteSeleccionado
                        });

                        // Reconstruir opciones de cursos
                        reconstruirOpcionesCursos(nivelSeleccionado, estudianteSeleccionado);

                        // Reconstruir opciones de estudiantes
                        reconstruirOpcionesEstudiantes(cursoSeleccionado, nivelSeleccionado);
                    ...
                    // Función para reconstruir opciones de cursos
                    function reconstruirOpcionesCursos(nivelId, estudianteId) {
                        ...
                        cursosOriginales.forEach(option => {
                            ...
                            if (estudianteId && incluir) {
                                const estudianteOption = estudiantesOriginales.find(opt => opt.value === estudianteId);
                                if (estudianteOption) {
                            ...
                            if (incluir) {
                                ...
                                console.log(`Agregando curso: ${option.text}, nivel=${cursoNivel}`);
                            }
                        });
                    }

                    // Función para reconstruir opciones de estudiantes
                    function reconstruirOpcionesEstudiantes(cursoId, nivelId) {
                        // Limpiar opciones actuales (excepto la vacía)
                        ...
                        estudiantesOriginales.forEach(option => {
                            ...
                            if (incluir) {
                                ...
                                console.log(`Agregando estudiante: ${option.text}, curso=${estudianteCurso}`);
                            }
                        });
                    }
