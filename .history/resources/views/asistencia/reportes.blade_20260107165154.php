                ...
                case 'comparativo':
                            ...
                            setTimeout(() => {
                                ...
                                if (tipoReporte === 'comparativo') {
                                    // Si ya hay fechas seleccionadas, cargar filtros dinámicos inmediatamente
                                    const fechaInicio = document.getElementById('fecha_inicio').value;
                                    const fechaFin = document.getElementById('fecha_fin').value;

                                    if (fechaInicio && fechaFin) {
                                        console.log('Fechas ya seleccionadas, cargando filtros dinámicos para reporte comparativo');
                                        // Simular cambio de fecha para activar filtros dinámicos
                                        actualizarFiltrosDinamicos();
                                    } else {
                                        console.log('Esperando selección de fechas para cargar filtros dinámicos');
                                        filtroContainer.innerHTML = '<div class="alert alert-info"><i class="fas fa-calendar-alt mr-2"></i>Por favor selecciona las fechas de inicio y fin para cargar las opciones de filtro disponibles.</div>';
                                    }
                                }
                            }, 100);
                        }
