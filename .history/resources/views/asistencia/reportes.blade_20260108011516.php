...
@push('styles')
<script>
    // Add class to body for ultra-specific styling
    document.addEventListener('DOMContentLoaded', function() {
        document.body.classList.add('asistencia-reportes');
    });
</script>
@endpush
                                ...
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-md-3 col-6 mb-2">
                                            <div class="kpi-card p-2 rounded text-white" style="background: #007bff;">
                                                <i class="fas fa-users fa-lg mb-1"></i>
                                                <h5>{{ number_format($estadisticasRapidas['total_estudiantes'] ?? 0) }}</h5>
                                                <small class="d-block">Estudiantes Activos</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-2">
                                            <div class="kpi-card p-2 rounded text-white" style="background: #6c757d;">
                                                <i class="fas fa-clock fa-lg mb-1"></i>
                                                <h5>{{ number_format($estadisticasRapidas['dias_analizados'] ?? 0) }}</h5>
                                                <small class="d-block">Días Analizados</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-2">
                                            <div class="kpi-card p-2 rounded text-white" style="background: #28a745;">
                                                <i class="fas fa-chart-line fa-lg mb-1"></i>
                                                <h5>{{ $estadisticasRapidas['porcentaje_asistencia'] }}%</h5>
                                                <small class="d-block">Tasa Promedio Institucional</small>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-6 mb-2">
                                            <div class="kpi-card p-2 rounded text-white" style="background: #17a2b8;">
                                                <i class="fas fa-shield-alt fa-lg mb-1"></i>
                                                <h5>{{ number_format($estadisticasRapidas['justificaciones_aprobadas'] ?? 0) }}</h5>
                                                <small class="d-block">Justificaciones Aprobadas</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
/* Force icon centering for reports view - ultra specific */
body.asistencia-reportes .main-header .logo-header .topbar-toggler-container,
body.asistencia-reportes .main-header .logo-header .topbar-toggler.more,
body.asistencia-reportes .main-header .logo-header .topbar-toggler.more .icon-wrapper,
body.asistencia-reportes .main-header .logo-header .topbar-toggler.more i.icon-options-vertical {
...
function handleReportTypeChange() {
    ...
    switch(tipo) {
        case 'por_curso':
            ...
            break;
        case 'por_estudiante':
            html = '<div class="form-group"><label>Estudiante</label><select class="form-control filter-select select2" id="estudiante_id">' +
                   (window.reportesData.estudianteOptions || '<option value="">Todos los estudiantes</option>') +
                   '</select></div>';
            break;
        case 'por_docente':
            html = '<div class="form-group"><label>Docente</label><select class="form-control filter-select select2" id="docente_id">' +
        ...
        case 'comparativo':
            html = `
                <div class="row">
                    <div class="col-md-6"><div class="form-group"><label>Nivel</label><select class="form-control filter-select select2" id="nivel_id"><option value="">Seleccionar nivel...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Curso</label><select class="form-control filter-select select2" id="curso_id"><option value="">Seleccionar curso...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Estudiante</label><select class="form-control filter-select select2" id="estudiante_id"><option value="">Seleccionar estudiante...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Docente</label><select class="form-control filter-select select2" id="docente_id"><option value="">Seleccionar docente...</option></select></div></div>
                </div>
            `;
