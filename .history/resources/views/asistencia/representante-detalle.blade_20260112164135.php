...
<x-breadcrumb :module="'asistencia'" :section="'representante-detalle'" />
    ...
    @if(isset($error) || !$estudiante)
        <div class="container-fluid margen-movil-2">
            <div class="row mt-4 ml-1 mr-1">
                <div class="col-md-12">
                    <div class="alert alert-danger">
                        <h4><i class="fas fa-exclamation-triangle"></i> Error al cargar los detalles del estudiante</h4>
                        <p>{{ $error ?? 'No se pudo cargar la información del estudiante. Puede que no tenga permisos o que haya un problema con los datos.' }}</p>
                        <a href="{{ route('asistencia.representante.dashboard') }}" class="btn btn-primary">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody id="tbodyAsistencias">
                            ...
                            <tr>
                                ...
                                <td>{{ $asistencia->cursoAsignatura && $asistencia->cursoAsignatura->docente ? ($asistencia->cursoAsignatura->docente->nombres ?? '') . ' ' . ($asistencia->cursoAsignatura->docente->apellidos ?? '') : 'N/A' }}</td>
                                <td>
