                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="incluir_estadisticas" style="width: 20px; height: 20px;">
                                                    <label class="form-check-label fw-bold text-dark ml-2" for="incluir_estadisticas" style="cursor: pointer;">
                                                        <i class="fas fa-chart-pie text-primary mr-2"></i>Incluir estadísticas detalladas
                                                    </label>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="incluir_graficos" style="width: 20px; height: 20px;">
                                                    <label class="form-check-label fw-bold text-dark ml-2" for="incluir_graficos" style="cursor: pointer;">
                                                        <i class="fas fa-chart-bar text-success mr-2"></i>Incluir gráficos (solo PDF)
                                                    </label>
                                                    <small class="form-text text-muted d-block ml-4">
                                                        <i class="fas fa-info-circle mr-1"></i>
