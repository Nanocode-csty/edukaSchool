...
function seleccionarDia(fecha) {
    ...
    if (attendanceSection) {
        attendanceSection.innerHTML = `
            <div class="text-center py-5">
                ...
                <h4>Cargando asistencia...</h4>
                <p class="text-muted">Por favor espera mientras se carga la información.</p>
            </div>
        `;
    }
    ...
    .then(html => {
        ...
        if (newAttendanceSection && attendanceSection) {
            ...
            console.log('Asistencia actualizada para fecha:', fecha);
        } else {
            throw new Error('No se pudo encontrar la sección de asistencia en la respuesta');
        }
    })
    .catch(error => {
        ...
        if (attendanceSection) {
            attendanceSection.innerHTML = `
                <div class="alert alert-danger text-center">
                    ...
                    <h5>Error al cargar la asistencia</h5>
                    <p>
