                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="incluir_estadisticas" style="transform: scale(1.2);">
                                                    <label class="form-check-label fw-bold text-dark" for="incluir_estadisticas">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="incluir_graficos" style="transform: scale(1.2);">
                                                    <label class="form-check-label fw-bold text-dark" for="incluir_graficos">
