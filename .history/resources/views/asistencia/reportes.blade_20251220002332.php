            ...
            <div class="box_block">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    document.getElementById('tipo_reporte').addEventListener('change', function() {
                        ...
                        if (tipoReporte === 'general') {
                            ...
                            // Re-inicializar select2 para los nuevos elementos usando la función global
                            setTimeout(() => {
                                $('.form-control').each(function() {
                                    if ($(this).attr('id') !== 'tipo_reporte' && $(this).attr('id') !== 'formato') {
                                        window.initSelect2('#' + $(this).attr('id'), {
                            ...
                            }, 500); // Increased delay to ensure select2 is fully loaded
                        }
                    });
                ...
                function initSelect2WhenReady() {
                    if (typeof window.initSelect2 === 'function') {
                        // Usar la función global del template principal
                        $('.form-control').each(function() {
                            if ($(this).attr('id') !== 'tipo_reporte' && $(this).attr('id') !== 'formato') {
                                window.initSelect2('#' + $(this).attr('id'), {
                                    placeholder: $(this).find('option:first').text() || 'Seleccionar...',
                        ...
                        // Si la función global no está lista, esperar
                        setTimeout(initSelect2WhenReady, 200);
                    }
                }

                // Inicializar select2 después de que todo esté cargado
                window.addEventListener('load', function() {
                    setTimeout(initSelect2WhenReady, 1000); // Esperar 1 segundo después de load
                });
                </script>
            </div>
        </div>
