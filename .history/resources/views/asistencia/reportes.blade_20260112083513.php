...
function manejarCambioTipoReporte() {
    ...
    $('#estudiante_reporte').hide();
    $('#grado_reporte').hide();

    // Mostrar filtros según el tipo de reporte seleccionado
    if (tipoReporte === 'por_estudiante') {
        $('#filtros-adicionales').show();
        $('#estudiante_reporte').show();
        // Aquí podrías cargar estudiantes dinámicamente
    } else if (tipoReporte === 'por_grado') {
        $('#filtros-adicionales').show();
        $('#grado_reporte').show();
        // Aquí podrías cargar grados dinámicamente
    }
    // Para otros tipos (general, comparativo, por_docente), no mostrar filtros adicionales
}
