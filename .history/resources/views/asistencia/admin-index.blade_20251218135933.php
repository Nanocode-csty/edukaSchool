...
@section('scripts')
    <script>
        // Inicializar Select2 inmediatamente cuando el DOM esté listo
        $(document).ready(function() {
            console.log('DOM ready, initializing Select2...');

            // Forzar inicialización de Select2 para todos los elementos select-search
            $('.select-search').each(function() {
                const $select = $(this);
                const placeholder = $select.data('placeholder') || 'Seleccionar...';

                console.log('Initializing Select2 for:', $select.attr('id'));
            ...
            // Configurar placeholders específicos con override
            if ($('#profesor_id').length) {
                $('#profesor_id').select2({
        ...
        // Backup initialization in case DOM ready doesn't fire
