...
function guardarEdicionAsistencia(form) {
    ...
    // Use the selectedAttendance object instead of relying on checked radio buttons
    ...
    // Fallback: If selectedAttendance is empty, try to collect from checked radio buttons
    if (!hasSelections) {
        console.log('selectedAttendance vacío, usando fallback con radio buttons marcados');
