...
<!-- Debug: Test FontAwesome loading -->
<div style="position: fixed; top: 10px; right: 10px; background: yellow; padding: 5px; z-index: 9999; font-size: 12px;">
    FontAwesome Test: <i class="fas fa-star"></i> <i class="fas fa-heart"></i> <i class="fas fa-check"></i>
</div>
                                        ...
                                        <div class="row text-center">
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <a href="{{ route('asistencia.representante.index') }}" class="btn btn-outline-primary btn-block py-2">
                                                    <i class="fas fa-list fa-lg mb-1" style="font-family: 'Font Awesome 6 Free'; font-weight: 900; display: inline-block !important;"></i><br>
                                            ...
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <a href="{{ route('notas.misEstudiantes') }}" class="btn btn-outline-success btn-block py-2">
                                                    <i class="fas fa-graduation-cap fa-lg mb-1" style="font-family: 'Font Awesome 6 Free'; font-weight: 900; display: inline-block !important;"></i><br>
                                                    <small><strong>Ver Notas</strong></small>
                                                </a>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <a href="{{ route('notificaciones.index') }}" class="btn btn-outline-info btn-block py-2">
                                                    <i class="fas fa-bell fa-lg mb-1" style="font-family: 'Font Awesome 6 Free'; font-weight: 900; display: inline-block !important;"></i><br>
                                            ...
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-secondary btn-block py-2" onclick="mostrarEstadisticas()">
                                                    <i class="fas fa-chart-pie fa-lg mb-1" style="font-family: 'Font Awesome 6 Free'; font-weight: 900; display: inline-block !important;"></i><br>
...
/* Specifically hide any text containing CSS-like patterns */
body::before,
body::after,
*::before,
*::after {
...
/* Hide any text that looks like CSS */
div:contains("{"), div:contains("}"), div:contains("botman"), div:contains("chatwindow") {
    display: none !important;
}
</style>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-pap+O0r2gnUkWtcUNHG/eIRQsA1jnhXfJ9IMct/pAWy+U3zOV5XX5XZ1GJwKQHK8P8kkIcZId8fs6joYgRrT9w==" crossorigin="anonymous" referrerpolicy="no-referrer">
