                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="estudiante_id" name="estudiante_id">
                                                        ...
                                                        @foreach($estudiantes as $estudiante)
                                                        <option value="{{ $estudiante->estudiante_id }}" data-curso="{{ $estudiante->matricula?->curso_id }}" data-nivel="{{ $estudiante->matricula?->grado?->nivel_id }}">{{ $estudiante->persona->apellidos }}, {{ $estudiante->persona->nombres }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
