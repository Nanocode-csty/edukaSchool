                    ...
                    <table class="table table-striped table-hover" id="tablaEstudiantes">
                        ...
                        <tbody id="tbodyEstudiantes">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <strong>{{ $item['estudiante']->persona ? trim(($item['estudiante']->persona->apellido_paterno ?? '') . ' ' . ($item['estudiante']->persona->apellido_materno ?? '')) : '' }}, {{ $item['estudiante']->persona ? $item['estudiante']->persona->nombres : '' }}</strong>
                                        <br><small class="text-muted">{{ $item['estudiante']->dni }}</small>
                                    </div>
                                </td>
                                <td>
                                    @if($item['curso'])
