                                ...
                                <div class="stats-compact d-flex justify-content-between align-items-center p-3 rounded" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 1px solid #dee2e6;">
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-info stat-badge" id="totalJustificaciones">{{ $justificaciones->total() }}</span>
                                        </div>
                                        <small class="text-muted d-block">Total</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-warning stat-badge" id="totalPendientes">{{ $justificaciones->where('estado', 'pendiente')->count() }}</span>
                                        </div>
                                        <small class="text-muted d-block">Pendientes</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-success stat-badge" id="totalAprobadas">{{ $justificaciones->where('estado', 'aprobada')->count() }}</span>
                                        </div>
                                        <small class="text-muted d-block">Aprobadas</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-danger stat-badge" id="totalRechazadas">{{ $justificaciones->where('estado', 'rechazada')->count() }}</span>
                                        </div>
