            ...
            <div class="box_block">
                ...
                function exportarReporte() {
                    ...
                    if (formato === 'pdf') {
                        ...
                        let url = `/asistencia/exportar/excel/admin?fecha_inicio=${encodeURIComponent(fechaInicio)}&fecha_fin=${encodeURIComponent(fechaFin)}&formato=${encodeURIComponent(formato)}&tipo_reporte=${encodeURIComponent(tipo)}`;
