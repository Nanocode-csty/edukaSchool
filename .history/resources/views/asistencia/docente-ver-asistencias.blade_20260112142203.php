                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <span class="badge badge-{{ $asistencia->tipoAsistencia->codigo == 'A' ? 'success' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'danger' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'warning' : 'info')) }} badge-lg">
                                                                        <i class="fas {{ $asistencia->tipoAsistencia->codigo == 'A' ? 'fa-check' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'fa-times' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'fa-clock' : 'fa-file-medical')) }} mr-1"></i>
                                                                        {{ $asistencia->tipoAsistencia->codigo == 'A' ? 'Presente' : ($asistencia->tipoAsistencia->codigo == 'F' ? 'Falta' : ($asistencia->tipoAsistencia->codigo == 'T' ? 'Tarde' : ($asistencia->tipoAsistencia->codigo == 'J' ? 'Justificada' : $asistencia->tipoAsistencia->nombre))) }}
                                                                    </span>
                                                                </td>
