        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Asistencias de Mis Estudiantes</h4>
                    <button class="btn btn-primary btn-round ml-auto" onclick="mostrarEstadisticasGenerales()">
                    ...
                    <table class="table table-striped table-hover" id="tablaEstudiantes">
                        ...
                        <tbody id="tbodyEstudiantes">
                            ...
                            <tr>
                                ...
                                <td>{{ $estudiante->matricula->curso->grado->nombre }}</td>
                                <td>{{ $estudiante->matricula->seccion->nombre }}</td>
                                <td>
