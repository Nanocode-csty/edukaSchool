                ...
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-light btn-sm" type="button" data-toggle="collapse" data-target="#weeklyCalendar" aria-expanded="false">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <button type="button" class="btn btn-outline-light btn-sm" onclick="cambiarDia(-1)">
                                                            <i class="fas fa-chevron-left"></i> Día Anterior
                                                        </button>
                                                        <span class="text-white font-weight-bold mx-2">{{ $fecha_seleccionada ? $fecha_seleccionada->format('l, d/m/Y') : date('l, d/m/Y') }}</span>
                                                        <button type="button" class="btn btn-outline-light btn-sm" onclick="cambiarDia(1)">
                                                            Día Siguiente <i class="fas fa-chevron-right"></i>
                                                        </button>
                                                    </div>
...
// Function to expand all class attendance panels
function expandirTodasLasClases() {
    const panels = document.querySelectorAll('[id^="attendance-panel-"]');
    panels.forEach(panel => {
        panel.style.display = 'block';
    });

    // Scroll to first expanded panel
    const firstPanel = document.querySelector('[id^="attendance-panel-"]');
    if (firstPanel) {
    ...
    Swal.fire({
        icon: 'success',
        title: '¡Expandido!',
        text: 'Todas las secciones de asistencia han sido expandidas',
        timer: 1500,
        showConfirmButton: false
    });
}
