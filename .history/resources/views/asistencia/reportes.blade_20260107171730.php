    ...
    <div class="row mt-4 ml-1 mr-1">
        <div class="col-12">
            <div class="box_block">
                ...
                // Función global para actualizar opciones de
                ...
                function configurarFiltrosCascada() {
                    ...
                    function filtrarCursosPorNivel() {
                        ...
                        // Obtener TODAS las opciones de cursos disponibles (no solo las actuales filtradas por fecha)
                        // Las opciones ya están filtradas por fecha desde la API, ahora filtramos por nivel
                        const todasLasOpciones = Array.from(cursoSelect.querySelectorAll('option')).filter(option => option.value !== '');
