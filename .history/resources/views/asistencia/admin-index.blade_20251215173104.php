                            ...
                            <tbody>
                                @foreach($asistencias as $index => $asistencia)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <div class="font-semibold text-gray-900">{{ $asistencia->fecha->format('d/m/Y') }}</div>
                                                <div class="text-sm text-gray-600">{{ $asistencia->fecha->format('l') }}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div>
                                                <div class="text-sm text-gray-600">{{ $asistencia->hora_registro->format('H:i') }}</div>
                                                <div class="text-sm text-gray-500">{{ $asistencia->hora_registro->format('d/m/Y') }}</div>
                                            </div>
                                        </td>
