                                            ...
                                            <div class="row g-4 mb-4">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <script>
                                                            // Initialize Select2 immediately for this specific element
                                                            document.addEventListener('DOMContentLoaded', function() {
                                                                if (typeof $ !== 'undefined' && $.fn.select2) {
                                                                    ...
                                                                    console.log('Select2 initialized for estudiante_id');
                                                                }
                                                            });
                                                        </script>
                                                    </div>
...
@section('scripts')
    <script>
        // Inicializar Select2 usando la función global
        $(document).ready(function() {
            ...
            $('.select-search').each(function() {
                ...
                // Usar la función global initSelect2
                window.initSelect2('#' + elementId, { placeholder: placeholder });
            });
