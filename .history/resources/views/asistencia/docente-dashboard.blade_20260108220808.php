                                    ...
                                    <table id="add-row" class="table-hover table" style="border: 1px solid #0A8CB3; border-radius: 10px; overflow: hidden;">
                                        ...
                                        <tbody id="tbodyClases">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!$clase->tiene_asistencia_hoy)
                                                        <button class="btn btn-sm" onclick="tomarAsistencia({{ $clase->sesion_id }})" style="background-color: #28a745; color: white; border: none;">
                                                            <i class="fas fa-clipboard-check"></i> Tomar
                                                        </button>
                                                    @else
                                                        <a href="{{ route('asistencia.docente.ver', $clase->sesion_id) }}" class="btn btn-sm" style="background-color: #007bff; color: white; border: none;">
