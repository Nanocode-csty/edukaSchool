...
function setupEventHandlers() {
    ...
    // Date change for dynamic filters
...
function handleReportTypeChange() {
    ...
    switch(tipo) {
        case 'por_curso':
            html = '<div class="form-group"><label>Curso</label><select class="form-control select2" id="curso_id"><option value="">Todos los cursos</option></select></div>';
            break;
        case 'por_estudiante':
            html = '<div class="form-group"><label>Estudiante</label><select class="form-control select2" id="estudiante_id"><option value="">Todos los estudiantes</option></select></div>';
            break;
        case 'por_docente':
            html = '<div class="form-group"><label>Docente</label><select class="form-control select2" id="docente_id"><option value="">Todos los docentes</option></select></div>';
            break;
        case 'comparativo':
            html = `
                <div class="row">
                    <div class="col-md-6"><div class="form-group"><label>Nivel</label><select class="form-control select2" id="nivel_id"><option value="">Seleccionar nivel...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Curso</label><select class="form-control select2" id="curso_id"><option value="">Seleccionar curso...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Estudiante</label><select class="form-control select2" id="estudiante_id"><option value="">Seleccionar estudiante...</option></select></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Docente</label><select class="form-control select2" id="docente_id"><option value="">Seleccionar docente...</option></select></div></div>
                </div>
            `;
    ...
    container.html(tipo === 'comparativo' ? '<div class="alert alert-info">Selecciona fechas para cargar filtros con datos de asistencia.</div>' : html);
...
// Load dynamic filters based on attendance records
    ...
    fetch(estadisticasUrl)
        ...
        .then(estadisticasData => {
            if (estadisticasData.success) {
                // Update charts
                updateCharts(estadisticasData.tendencia_mensual, estadisticasData.distribucion_tipos);
...
function updateCharts(tendenciaMensual, distribucionTipos) {
...
@endpush                        console.log('Ejecutando filtrarCursosPorNivel');
