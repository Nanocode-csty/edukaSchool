                                                ...
                                                <div style="width: 50px; height: 50px; position: relative;">
                                                    <svg width="50" height="50">
                                                        ...
                                                        <circle cx="25" cy="25" r="20" stroke="#dc3545" stroke-width="4" fill="none"
                                                                stroke-dasharray="125.66370614359172"
                                                                stroke-dashoffset="${125.66370614359172 * (1 - ${estadisticas.total_inasistencias}/42)}"
                                                                transform="rotate(-90 25 25)"></circle>
                                                    </svg>
                                                ...
                                                <div style="width: 50px; height: 50px; position: relative;">
                                                    <svg width="50" height="50">
                                                        ...
                                                        <circle cx="25" cy="25" r="20" stroke="#ffc107" stroke-width="4" fill="none"
                                                                stroke-dasharray="125.66370614359172"
                                                                stroke-dashoffset="${125.66370614359172 * (1 - ${estadisticas.total_tardanzas}/42)}"
                                                                transform="rotate(-90 25 25)"></circle>
                                                    </svg>
                                                ...
                                                <div style="width: 50px; height: 50px; position: relative;">
                                                    <svg width="50" height="50">
                                                        ...
                                                        <circle cx="25" cy="25" r="20" stroke="#17a2b8" stroke-width="4" fill="none"
                                                                stroke-dasharray="125.66370614359172"
                                                                stroke-dashoffset="${125.66370614359172 * (1 - ${estadisticas.justificaciones_aprobadas}/10)}"
                                                                transform="rotate(-90 25 25)"></circle>
                                                    </svg>
