    ...
    @if($asistencias->isNotEmpty())
        @php
            ...
            foreach($asistencias as $index => $asistencia) {
                ...
                $debugInfo[] = "Registro {$index}: {$codigo}";
            ...
            $tasaAsistencia = $totalRegistros > 0 ? round(($totalPresentes / $totalRegistros) * 100, 1) : 0;

            // Debug: mostrar información en el PDF para diagnóstico
            $debugText = "Debug: " . implode(', ', array_slice($debugInfo, 0, 5)) . "...";
        @endphp
