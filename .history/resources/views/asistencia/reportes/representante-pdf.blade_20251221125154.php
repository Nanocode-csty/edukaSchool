...
<body>
    ...
    <div class="info-section">
        <div class="info-row">
            ...
            <div class="info-value">{{ $estudiante->persona->nombres ?? 'N/A' }} {{ $estudiante->persona->apellidos ?? 'N/A' }}</div>
        </div>
        <div class="info-row">
            <div class="info-label">DNI:</div>
            <div class="info-value">{{ $estudiante->persona->dni ?? 'N/A' }}</div>
        </div>
        <div class="info-row">
    ...
    <div class="periodo-info">
        Período: {{ \Carbon\Carbon::create()->month((int)$mes)->format('F') }} {{ $anio }}
    </div>
