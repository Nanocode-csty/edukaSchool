...
<body>
        ...
        <div class="info-section">
            ...
            <div class="stats-grid">
                <div class="stats-row">
                    ...
                    <div class="stats-cell">
                        <strong>{{ $asistencias->where('tipoAsistencia.codigo', 'P')->count() }}</strong><br>
                        <small>Presentes</small>
                    </div>
                    <div class="stats-cell">
                        <strong>{{ $asistencias->where('tipoAsistencia.codigo', 'A')->count() }}</strong><br>
                        <small>Ausentes</small>
                    </div>
                    <div class="stats-cell">
                        <strong>{{ round(($asistencias->where('tipoAsistencia.codigo', 'P')->count() / $asistencias->count()) * 100, 1) }}%</strong><br>
    ...
    <div class="footer">
        ...
        <p>Página {{ $asistencias->currentPage() }} de {{ $asistencias->lastPage() }}</p>
    </div>
</body>
</html>
