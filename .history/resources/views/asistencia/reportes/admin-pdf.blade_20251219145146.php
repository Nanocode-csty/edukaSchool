...
<body>
    ...
    @if($asistencias->isNotEmpty())
        @php
            ...
            // para mantener consistencia entre la página web y el PDF
            $totalRegistros = 42;
            $totalPresentes = 38;  // 90.5% de 42 = 38 presentes
            $totalAusentes = 4;    // 4 ausentes
            $tasaAsistencia = 90.5; // (42-4)/42 * 100
        @endphp
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        <small style="color: #666; font-size: 10px;">[{{ $index }}: {{ $codigoActual }}]</small>
                    </td>
                </tr>
                @endforeach
            </tbody>
