...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ $estudiante->matricula->curso->grado->nombre }} {{ $estudiante->matricula->seccion->nombre }}</div>
        </div>
        <div class="info-row">
            <div class="info-label">Año Lectivo:</div>
            <div class="info-value">{{ $estudiante->matricula->curso->anioLectivo->nombre }}</div>
        </div>
    </div>
