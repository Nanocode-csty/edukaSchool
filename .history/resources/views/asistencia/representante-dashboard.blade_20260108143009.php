...
/* Ensure no stray text appears */
body * {
    /* Hide any text that might be accidentally displayed */
}
body *:not(.card-title):not(.card-text):not(.btn):not(.badge):not(.text-muted):not(.text-white):not(.text-primary):not(.text-success):not(.text-info):not(.text-warning):not(.text-danger):not(p):not(span):not(div):not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(small):not(strong):not(em):not(i):not(b) {
    /* Only allow specific text elements to display text */
}
</style>
