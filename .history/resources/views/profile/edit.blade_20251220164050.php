                ...
                <div class="row align-items-center">
                    <div class="col-md-3 text-center">
                        <div class="position-relative">
                            <img src="{{ $persona->foto_url ? asset('storage/' . $persona->foto_url) : asset('adminlte/assets/img/profile.jpg') }}"
                                 alt="Foto de perfil"
                            ...
                            <input type="file" id="photo-input" name="photo" class="form-control mt-2" accept="image/*" style="max-width: 300px;">
                        </div>
                    </div>
                    <div class="col-md-9">
