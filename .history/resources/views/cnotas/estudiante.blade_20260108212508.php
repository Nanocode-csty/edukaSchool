                    ...
                    <div class="row justify-content-center align-items-center flex-wrap">
                        ...
                        <div class="col px-2" style="text-align:justify;">
                            <p style="margin-bottom: 0px; font-family: 'Quicksand', sans-serif; font-weight: 600; color: #004a92;">
                                Consulta detallada de las calificaciones de {{ $estudiante->persona ? $estudiante->persona->nombres : $estudiante->nombres }} {{ $estudiante->persona ? trim(($estudiante->persona->apellido_paterno ?? '') . ' ' . ($estudiante->persona->apellido_materno ?? '')) : $estudiante->apellidos }}. Se muestran las notas por período y el promedio final de cada asignatura.
                            </p>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar-lg mr-3"
                                        ...
                                        {{ substr($estudiante->persona ? $estudiante->persona->nombres : $estudiante->nombres, 0, 1) }}{{ substr($estudiante->persona ? ($estudiante->persona->apellido_paterno ?? $estudiante->persona->apellido_materno ?? '') : $estudiante->apellidos, 0, 1) }}
                                    </div>
                                    <!-- Información personal del estudiante -->
                                    <div class="ml-3">
                                        <h4 class="text-primary mb-1" style="color:#0a7c9e !important; font-weight:bold">{{ $estudiante->persona ? trim(($estudiante->persona->apellido_paterno ?? '') . ' ' . ($estudiante->persona->apellido_materno ?? '')) : $estudiante->apellidos }},
                                            {{ $estudiante->persona ? $estudiante->persona->nombres : $estudiante->nombres }}</h4>
