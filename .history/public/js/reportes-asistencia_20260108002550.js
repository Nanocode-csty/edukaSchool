...
// Save complete report to history when generating preview
function saveReportToHistory(params, totalRegistros) {
    ...
    // Generate and save complete report with physical file
    const saveData = {
        tipo_reporte: params.tipo_reporte || 'general',
        fecha_inicio: params.fecha_inicio,
        fecha_fin: params.fecha_fin,
        formato: 'pdf', // Default format for generated reports
    ...
    // Save complete report with physical file
    fetch('/asistencia/guardar-reporte-exportado/pdf', {
        method: 'POST',
        headers: {
...
// Export report (download only, don't save to history)
