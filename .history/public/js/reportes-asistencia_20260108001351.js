...
function saveReportToHistory(params, totalRegistros) {
    console.log('Saving report preview to history...');
    console.log('Report params:', params);
    console.log('Total registros:', totalRegistros);

    // Save report preview to history
    const saveData = {
    ...
    console.log('Sending preview data:', saveData);
    ...
    .then(data => {
        console.log('Save preview response data:', data);
        if (data.success) {
            console.log('Report preview saved successfully:', data.reporte_id);
            // Refresh the reports list to show the new preview
            refreshReportsList();
        } else {
            console.error('Error saving report preview:', data.message);
        }
    })
    .catch(error => {
        console.error('Error saving report preview:', error);
        // Don't show alert for preview saves, just log the error
    });
}
