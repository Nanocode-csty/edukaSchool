...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('asistencia')->name('asistencia.')->group(function () {
        ...
        Route::get('/api/niveles', [InfNivelController::class, 'apiIndex'])->name('api.niveles');
        Route::get('/api/grados', [InfGradoController::class, 'apiIndex'])->name('api.grados');
        Route::get('/api/cursos', [InfCursoController::class, 'apiIndex'])->name('api.cursos');
        Route::get('/api/secciones', [InfSeccionController::class, 'apiIndex'])->name('api.secciones');
        Route::get('/api/estudiantes', [InfEstudianteController::class, 'apiIndex'])->name('api.estudiantes');
        Route::get('/api/docentes', [InfDocenteController::class, 'apiIndex'])->name('api.docentes');
        Route::get('/api/asignaturas', [InfAsignaturaController::class, 'apiIndex'])->name('api.asignaturas');
    });
