...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/calificaciones/representante', [NotasController::class, 'representanteCalificaciones'])->name('calificaciones.representante')->withoutMiddleware('auth');
    ...
    Route::prefix('asistencia')->name('asistencia.')->group(function () {
        ...
        Route::prefix('docente')->name('docente.')->group(function () {
            Route::get('/', [AsistenciaController::class, 'docenteDashboard'])
                ->name('index');
