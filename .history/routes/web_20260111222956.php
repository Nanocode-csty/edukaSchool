...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('periodos')->name('periodos.')->group(function () {
        Route::get('/dashboard', [App\Http\Controllers\PeriodosController::class, 'dashboard'])->name('dashboard');
        ...
        // Descuentos
        Route::get('/descuentos', [App\Http\Controllers\PeriodosController::class, 'descuentos'])->name('descuentos');
        Route::post('/descuentos/crear', [App\Http\Controllers\PeriodosController::class, 'crearDescuento'])->name('descuentos.crear');
    ...
    Route::prefix('asistencia')->name('asistencia.')->group(function () {
        ...
        Route::prefix('docente')->name('docente.')->group(function () {
            ...
            Route::get('/reportes', [AsistenciaController::class, 'docenteReportes'])
                ->name('reportes');
