...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('asistencia')->name('asistencia.')->group(function () {
        ...
        Route::get('/dashboard', [AsistenciaController::class, 'dashboard'])
            ->name('dashboard');
        ...
        Route::get('/api/estudiantes-por-filtros', [AsistenciaController::class, 'getEstudiantesPorFiltros']);
        ...
        // Reportes
        Route::get('/reporte-general', [App\Http\Controllers\AsistenciaExportController::class, 'reporteGeneral'])
