<?php $__env->startSection('titulo', 'Editar Estudiante'); ?>
                                        ...
                                        <form id="formularioEstudiante" method="POST" action="#" autocomplete="off"
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text"
                                                        class="form-control <?php $__errorArgs = ['apellidoPaterno'];
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        id="apellidoPaterno" name="apellidoPaterno"
                                                        placeholder="Apellido paterno" maxlength="100"
                                                        value="<?php echo e($estudiante->persona->apellidoPaterno); ?>" readonly>
                                                    <?php if($errors->has('apellidoPaterno')): ?>
                                                        <span
                                                            class="invalid-feedback d-block text-start"><?php echo e($errors->first('apellidoPaterno')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                <label class="col-12 col-md-2 col-form-label">Apellido Materno </label>
                                                <div class="col-12 col-md-4">
                                                    <input type="text"
                                                        class="form-control <?php $__errorArgs = ['apellidoMaterno'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        ...
                                                        value="<?php echo e($estudiante->persona->apellidoMaterno); ?>" readonly>
                                                    <?php if($errors->has('apellidoMaterno')): ?>
                                                        <span
                                                            class="invalid-feedback d-block text-start"><?php echo e($errors->first('apellidoMaterno')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        ...
                                                        value="<?php echo e($estudiante->persona->nombres); ?>" readonly>
                                                    <?php if($errors->has('nombres')): ?>
                                                        <span
                                                            class="invalid-feedback d-block text-start"><?php echo e($errors->first('nombres')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <input type="text"
                                                        value="<?php echo e($estudiante->persona->genero == 'M' ? 'Masculino' : 'Femenino'); ?>"
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        ...
                                                        <option value="" disabled
                                                            <?php echo e(old('genero', $estudiante->persona->genero ?? '') == '' ? 'selected' : ''); ?>>
                                                            Seleccionar sexo
                                                        </option>

                                                        <option value="M"
                                                            <?php echo e(old('genero', $estudiante->persona->genero ?? '') == 'M' ? 'selected' : ''); ?>>
                                                            Masculino
                                                        </option>

                                                        <option value="F"
                                                            <?php echo e(old('genero', $estudiante->persona->genero ?? '') == 'F' ? 'selected' : ''); ?>>
                                                            Femenino
                                                        </option>
                                                    </select>
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        ...
                                                        value="<?php echo e($estudiante->persona->dni); ?>" inputmode="numeric"
                                                        readonly>
                                                    <?php $__errorArgs = ['dni'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?> disabled-format"
                                                        ...
                                                        value="<?php echo e($estudiante->persona->fecha_nacimiento); ?>" readonly>
                                        ...
                                        <div class="row mb-3 align-items-center d-flex justify-content-center gap-4">
                                            ...
                                            <div class="col-12 col-md-4 d-flex justify-content-center">
                                                <div class="text-center">
                                                    <?php if(!empty($estudiante->persona->foto_url) || $estudiante->persona->foto_url != 0): ?>
                                                        <img id="img-preview"
                                                            src="<?php echo e(asset('storage/estudiantes/' . $estudiante->persona->foto_url)); ?>"
                                                            alt="Foto del estudiante" class="img-fluid rounded mt-2"
                                                            data-original="<?php echo e($estudiante->persona->foto_url ? asset('storage/estudiantes/' . $estudiante->persona->foto_url) : ''); ?>"
                                                            style="min-height:160px; max-height:180px; border:1px solid #DAA520; padding:4px; "
                                                            object-fit="cover" draggable="false"
                                                            oncontextmenu="return false">
                                                    <?php else: ?>
                                                        <img id="img-preview"
                                                            src="<?php echo e(asset('imagenes/imgEstudiante.png')); ?>"
                                    ...
                                    function previewImage(event) {
                                        ...
                                        if (input.files && input.files[0]) {
                                            ...
                                            if (!file.type.startsWith('image/')) {
                                                ...
                                                preview.src = original || "<?php echo e(asset('imagenes/imgEstudiante.png')); ?>";
                                                return;
                                            }
...
unset($__errorArgs, $__bag); ?>">
                                                    <option value="" disabled
                                                        <?php echo e(old('region') == '' ? 'selected' : ''); ?>>
                                                        Seleccionar
                                                        Región</option>
                                                </select>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    <div class="invalid-feedback d-block text-start"><?php echo e($message); ?></div>
                                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>">
                                                    <option value="" disabled
                                                        <?php echo e(old('provincia') == '' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <select id="distrito" name="distrito"
                                                    class="form-control <?php $__errorArgs = ['distrito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                    <option value="" disabled
                                                        <?php echo e(old('distrito') == '' ? 'selected' : ''); ?>>
                                                        Seleccionar
                                                        Distrito</option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <input type="text"
                                                    class="form-control <?php $__errorArgs = ['calleEstudiante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('calleEstudiante')); ?>">
                                                <?php $__errorArgs = ['calleEstudiante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <input type="text" class="form-control" id="numeroEstudiante"
                                                    ...
                                                    value="<?php echo e(old('numeroEstudiante')); ?>" inputmode="numeric">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="text" class="form-control" id="urbanizacionEstudiante"
                                                    ...
                                                    maxlength="20" value="<?php echo e(old('urbanizacionEstudiante')); ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="text" class="form-control" id="referenciaEstudiante"
                                                    ...
                                                    value="<?php echo e(old('referenciaEstudiante')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e($estudiante->persona->telefono); ?>" inputmode="numeric"
                                                        maxlength="11">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        maxlength="100" value="<?php echo e($estudiante->persona->email); ?>"
                                                        inputmode="email">
                                                    <div class="input-group-append">
                                                        <span
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <script>
                                            $('#email').on('input', function() {
                                                ...
                                                if (email.length <= 120) {
                                                    $.ajax({
                                                        url: "<?php echo e(route('verificar.email.docente')); ?>",
                                                        method: 'GET',
                                                        data: {
                                                            email
                                                        },
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        const regionEstudiante = <?php echo json_encode($estudiante->persona?->direccion?->idRegion, 15, 512) ?>;
        const provinciaEstudiante = <?php echo json_encode($estudiante->persona?->direccion?->idProvincia, 15, 512) ?>;
        const distritoEstudiante = <?php echo json_encode($estudiante->persona?->direccion?->idDistrito, 15, 512) ?>;
    </script>
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ronaldoroblesromero/Herd/edukaSchool/resources/views/ceinformacion/estudiantes/editar/index.blade.php ENDPATH**/ ?>