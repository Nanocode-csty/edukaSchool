<?php $__env->startSection('titulo', 'Registro y listado de estudiantes'); ?>
<?php $__env->startSection('contenidoplantilla'); ?>
    ...
    <div class="container-fluid margen-movil-2" id="contenido-principal" style="position: relative;">
        <div class="row mt-4 ml-1 mr-1">
            <div class="col-12">
                <div class="card">
                    <div class="estilo-info btn btn-block btn_header header_6" data-toggle="" aria-expanded="true"
                        aria-controls="">
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row d-flex align-items-center justify-content-center gap-4 my-4">
                            <div class="col-md-3 d-flex align-items-center justify-content-center">
                                ...
                                <a id="btnRegistrar" href="<?php echo e(route('estudiantes.create')); ?>"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row mb-2 d-flex align-items-center">
                            ...
                            <div class="col-12 col-md-6 mb-md-0 d-flex justify-content-start">
                                <a href="#" id="nuevoRegistroBtns"
                                    class="btn w-100 mt-3 btn-color d-flex justify-content-between align-items-center"
                                    type="button">
                                    <i class="ti ti-user-plus me-2 mx-2" style="font-size:24px"></i> FILTRAR ESTUDIANTE
                                </a>
                            </div>
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            <?php echo $__env->make('ccomponentes.loader', ['id' => 'loaderTabla'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <div id="tabla-estudiantes">
                                <?php echo $__env->make('ceinformacion.estudiantes.estudiante', [
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `<?php echo e(route('estudiantes.index')); ?>?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/ceinformacion/estudiantes/registrar.blade.php ENDPATH**/ ?>