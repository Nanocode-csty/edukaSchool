<?php $__env->startSection('titulo','Administrar Asistencias'); ?>
<?php $__env->startSection('contenidoplantilla'); ?>
<?php if (isset($component)) { $__componentOriginale19f62b34dfe0bfdf95075badcb45bc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale19f62b34dfe0bfdf95075badcb45bc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['module' => 'asistencia','section' => 'admin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['module' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('asistencia'),'section' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('admin')]); ?>
                    ...
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2 flex-wrap">
                                    <a href="<?php echo e(route('asistencia.reportes')); ?>" class="btn btn-outline-success btn-sm" title="Ver reportes de asistencia">
                                        <i class="fas fa-chart-line mr-1"></i>Reportes
                                    </a>
                                    <a href="<?php echo e(route('asistencia.verificar')); ?>" class="btn btn-outline-warning btn-sm" title="Gestionar justificaciones">
                        ...
                        <div class="row mb-3 align-items-end" id="filtrosContainer">
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control filtro-input" id="fecha_inicio" value="<?php echo e($fechaMinima ? \Carbon\Carbon::parse($fechaMinima)->format('Y-m-d') : ''); ?>">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-bold text-primary">Fecha Fin</label>
                                <input type="date" class="form-control filtro-input" id="fecha_fin" value="<?php echo e($fechaMaxima ? \Carbon\Carbon::parse($fechaMaxima)->format('Y-m-d') : ''); ?>">
                            </div>
                            <div class="col-md-3">
...
function aplicarFiltrosRapidos() {
    // Solo incluir los filtros principales para estadísticas consistentes
    // Las estadísticas siempre muestran el panorama general del rango de fechas
    currentFilters = {
        fecha_inicio: $('#fecha_inicio').val() || undefined,
        fecha_fin: $('#fecha_fin').val() || undefined,
        tipo_asistencia: $('#tipo_asistencia').val() || undefined
    };
    ...
    currentPage = 1;
    console.log('Filtros aplicados:', currentFilters); // Debug
    cargarDatos();
}
...
function cargarDatos(pagina = currentPage) {
    ...
    $.ajax({
        url: '<?php echo e(route("asistencia.api.tabla-asistencias")); ?>',
        method: 'GET',
        data: filtros,
...
function cargarOpcionesFiltrosAvanzados() {
    ...
    $.get('<?php echo e(route("asistencia.api.niveles")); ?>', function(data) {
...
function configurarCascadaFiltros() {
    ...
    $('#docente_id').on('change', function() {
        ...
        cargarAsignaturas(docenteId); // Reload subjects with new teacher filter
    });
}

function cargarGrados(nivelId = null) {
    let url = '<?php echo e(route("asistencia.api.grados")); ?>';
    if (nivelId) {
...
function cargarCursos(gradoId = null) {
    let url = '<?php echo e(route("asistencia.api.cursos")); ?>';
    if (gradoId) {
...
function cargarSecciones(gradoId = null) {
    let url = '<?php echo e(route("asistencia.api.secciones")); ?>';
    if (gradoId) {
        url += '?grado_id=' + gradoId;
    }
...
function cargarEstudiantes(seccionId = null) {
    let url = '<?php echo e(route("asistencia.api.estudiantes")); ?>';
    let params = [];
...
function cargarDocentes() {
    $.get('<?php echo e(route("asistencia.api.docentes")); ?>', function(data) {
        ...
        console.log('Status:', status);
        console.log('Response:', xhr.responseText);
        console.log('URL:', '<?php echo e(route("asistencia.api.docentes")); ?>');
    });
}

function cargarAsignaturas(docenteId = null) {
    let url = '<?php echo e(route("asistencia.api.asignaturas")); ?>';
    let params = [];
...
function cargarDatosIniciales() {
    // Obtener las fechas por defecto de los inputs
    currentFilters = {
        fecha_inicio: $('#fecha_inicio').val(),
        fecha_fin: $('#fecha_fin').val(),
        tipo_asistencia: $('#tipo_asistencia').val()
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ronaldoroblesromero/Herd/edukaSchool/resources/views/asistencia/admin-index.blade.php ENDPATH**/ ?>