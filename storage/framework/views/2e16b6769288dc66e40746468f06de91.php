<?php $__env->startSection('titulo', 'Registro y listado de matrículas'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center ">
                            ...
                            <div class="col-md-6 d-flex justify-content-md-end justify-content-start estilo-info">
                                <form id="formBuscar" method="GET" action="<?php echo e(route('matriculas.index')); ?>" class="w-100"
                                    style="max-width: 100%;">
                                    <div class="input-group">
                                        <input id="buscarpor" type="text" class="form-control mt-3" name="buscarpor"
                                            autocomplete="off" placeholder="Número de Matrícula" value="<?php echo e($buscarpor); ?>"
                            ...
                            <script>
                                ...
                                document.getElementById('buscarpor').addEventListener('input', function() {
                                    const valor = this.value.trim();

                                    if (valor === '') {
                                        //fetch para las solicitudes
                                        fetch("<?php echo e(route('matriculas.index')); ?>", {
                                                headers: {
                                            ...
                                            .then(html => {
                                                document.querySelector('#tabla-matriculas').innerHTML = html;
                                            });
                                    }
                                });
                            </script>
                        ...
                        <div id="tabla-matriculas" style="position: relative;">
                            <?php echo $__env->make('cmatricula.matricula', [
                                'matricula' => $matricula,
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        // Función para anular matrícula con SweetAlert
        async function anularMatricula(matriculaId, numeroMatricula) {
            const result = await Swal.fire({
                title: '¿Anular matrícula?',
                text: '¿Estás seguro de que deseas ANULAR la matrícula N° ' + numeroMatricula +
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = `/matriculas/${matriculaId}/anular`;
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/cmatricula/index.blade.php ENDPATH**/ ?>