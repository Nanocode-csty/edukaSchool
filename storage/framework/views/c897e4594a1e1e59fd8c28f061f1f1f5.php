    ...
    <div class="breadcrumb-container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('rutarrr1')); ?>" class="breadcrumb-link">
            ...
            <?php elseif(request()->is('rutarrr1')): ?>
            ...
            <?php if(isset($module) && $module === 'asistencia'): ?>
                ...
                <?php if(isset($section)): ?>
                    <?php switch($section):
                        ...
                        <?php case ('docente-dashboard'): ?>
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('asistencia.docente.dashboard')); ?>" class="breadcrumb-link">
                                    <i class="fas fa-chalkboard-teacher"></i>
                                    <span class="breadcrumb-text">Docente</span>
                                </a>
                            </li>
                        ...
                        <?php case ('docente-ver-asistencia'): ?>
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('asistencia.docente.dashboard')); ?>" class="breadcrumb-link">
                                    <i class="fas fa-chalkboard-teacher"></i>
                                    <span class="breadcrumb-text">Docente</span>
                        ...
                        <?php case ('representante'): ?>
                            <?php if(isset($dashboard) && $dashboard === 'asistencia.representante.dashboard'): ?>
                                <li class="breadcrumb-item">
                                    <a href="<?php echo e(route('asistencia.representante.dashboard')); ?>" class="breadcrumb-link">
                                        <i class="fas fa-tachometer-alt"></i>
                        ...
                        <?php case ('representante-detalle'): ?>
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('asistencia.representante.index')); ?>" class="breadcrumb-link">
                                    <i class="fas fa-user-friends"></i>
                                    <span class="breadcrumb-text">Mis Estudiantes</span>
                                </a>
                            </li>
                        ...
                        <?php case ('representante-dashboard'): ?>
                            <li class="breadcrumb-item active">
                                <i class="fas fa-tachometer-alt"></i>
                                <span class="breadcrumb-text">Panel Principal</span>
                            </li>
                        ...
                        <?php case ('representante-estudiante'): ?>
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('notas.misEstudiantes')); ?>" class="breadcrumb-link">
                                    <i class="fas fa-chart-bar"></i>
                                    <span class="breadcrumb-text">Calificaciones</span>
                                </a>
                            </li>
                        ...
                        <?php case ('docente-editar'): ?>
                            ...
                            <li class="breadcrumb-item active">
                                ...
                                <span class="breadcrumb-text">Editar Asistencia</span>
                            </li>
                            <?php break; ?>
            ...
            <?php if(isset($module) && $module === 'conceptospago'): ?>
            ...
            <?php if(isset($module) && $module === 'periodos'): ?>
                ...
                <?php if(isset($section)): ?>
                    <?php switch($section):
                        case ('index'): ?>
                            <li class="breadcrumb-item active">
                                <i class="fas fa-list"></i>
                                <span class="breadcrumb-text">Lista de Períodos</span>
                            </li>
                            <?php break; ?>
                        ...
                        <?php case ('crear'): ?>
                            <li class="breadcrumb-item active">
                                <i class="fas fa-plus"></i>
                                <span class="breadcrumb-text">Crear Período</span>
                            </li>
                            <?php break; ?>
                        ...
                        <?php case ('editar'): ?>
                            <li class="breadcrumb-item active">
                                <i class="fas fa-edit"></i>
                                <span class="breadcrumb-text">Editar Período</span>
                            </li>
                            <?php break; ?>
            ...
            <?php if(isset($section) && $section === 'notificaciones'): ?>
                <li class="breadcrumb-item active">
                    <i class="fas fa-bell"></i>
                    <span class="breadcrumb-text">Notificaciones</span>
                </li>
            <?php endif; ?>
                ...
                <?php $__currentLoopData = $items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($loop->last): ?>
                        <li class="breadcrumb-item active" aria-current="page">
                            <?php if(isset($item['icon'])): ?> <i class="<?php echo e($item['icon']); ?>"></i> <?php endif; ?>
                            <span class="breadcrumb-text"><?php echo e($item['label']); ?></span>
                        </li>
                    <?php else: ?>
                        <li class="breadcrumb-item">
...
<?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/components/breadcrumb.blade.php ENDPATH**/ ?>