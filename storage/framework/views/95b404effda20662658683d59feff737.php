...
<head>
    ...
    <title><?php echo $__env->yieldContent('titulo', 'Inicio | Intranet Eduka Perú'); ?></title>
    ...
    <!-- Fonts and icons -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/webfont/webfont.min.js')); ?>"></script>
    <script>
        WebFont.load({
            google: {
            ...
            custom: {
                ...
                urls: ["<?php echo e(asset('adminlte/assets/css/fonts.min.css')); ?>"]
            },
            active: function() {
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/assets/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/assets/css/atlantis.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/custom.css')); ?>">

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/assets/css/demo.css')); ?>">
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo e(asset('adminlte/plugins/fontawesome-free/css/all.css')); ?>">
    <!-- jQuery (requerido) -->
    <!-- PARA EL CALENDAR-->
    <script src="<?php echo e(asset('https://cdn.jsdelivr.net/npm/flatpickr/dist/l10n/es.js')); ?>"></script>
    ...
    <?php echo $__env->yieldPushContent('css-extra'); ?>

    
    <?php if(request()->routeIs('asistencia.reportes')): ?>
        <style>
...
<body>
    ...
    <style>
        body {
            background-image: url("<?php echo e(asset('imagenes/imgFondoIntranet.png')); ?>");
            z-index: -1;
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header" style="margin: 0 !important; padding: 0 !important; border: none !important;">
            <!-- Logo Header -->
            <div class="logo-header" style="height: 70px !important;">
                ...
                <div style="display: flex; align-items: center; height: 70px;">
                    <a class="logo" href="<?php echo e(route('rutarrr1')); ?>"
                        style="margin: 0 !important; padding: 0 !important; display: inline-block;">

                        <img src="<?php echo e(asset('imagenes/Imagen1.png')); ?>" alt="Logo de la empresa"
                            style="height: 70px; margin: 0 !important; padding: 0 !important; display: block;">
                    </a>

                    <!-- Sidebar Toggle Button (después del logo, todas las pantallas) -->
                    <button class="btn text-white p-2 sidebar-toggle d-inline-block ml-3"
                        onclick="toggleCustomSidebar()" title="Menú lateral"
                        style="font-size: 27px; background: rgba(14, 64, 103, 0.8); ">
                        <i id="icon-menu" class="ti ti-menu"></i>
                    </button>
                </div>


                <!-- Options Menu Toggle Button (derecha, desde 991px) -->
                <button class="btn btn-link text-white p-2 options-toggle d-lg-none" onclick="toggleMobileMenu()"
                    title="Opciones"
                    style="font-size: 1.2rem; position: absolute; top: 50%; right: 15px; transform: translateY(-50%); z-index: 1070; cursor: pointer; background: rgba(14, 64, 103, 0.8); border-radius: 4px;">
            ...
            <div id="mobile-navbar-bar" class="mobile-navbar-bar d-md-none mobile-navbar-hidden">
                <div class="mobile-navbar-content">
                    <!-- Ir a inicio -->
                    <a class="mobile-navbar-item evitar-recarga" href="<?php echo e(route('rutarrr1')); ?>" title="Ir a inicio">
                    ...
                    <div class="mobile-navbar-item" onclick="toggleMobileNotifications()" title="Notificaciones">
                        ...
                        <span class="notification-badge badge badge-danger" id="mobile-notification-count"
                    ...
                    <?php if(auth()->user()->hasRole('Administrador')): ?>
                        <div class="mobile-navbar-item" onclick="toggleMobileOperations()"
                    ...
                    <div class="mobile-navbar-item" onclick="toggleMobileProfile()" title="Perfil">
                        <div class="mobile-navbar-profile">
                            <img src="<?php echo e(auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?t=' . time() : asset('adminlte/assets/img/profile.jpg')); ?>"
            ...
            <style>
                ...
                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(1) {
                    animation-delay: 0.15s;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(2) {
                    animation-delay: 0.25s;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(3) {
                    animation-delay: 0.35s;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(4) {
                    animation-delay: 0.45s;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(5) {
                    animation-delay: 0.55s;
                }

                .mobile-navbar-bar:not(.mobile-navbar-hidden) .mobile-navbar-item:nth-child(6) {
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <div class="tooltip-wrapper">
                                <a class="nav-link evitar-recarga" href="<?php echo e(route('rutarrr1')); ?>">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <div class="tooltip-wrapper">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
                                    ...
                                    <span class="notification-badge badge badge-danger" id="notificationCount"
                                        style="display: none;"></span>
                                </a>
                                <div class="custom-tooltip">Notificaciones</div>
                                <ul class="dropdown-menu dropdown-menu-right notification-dropdown"
                                    id="notificationDropdown" aria-labelledby="navbarDropdown">
                                    <li class="dropdown-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>Notificaciones</span>
                                            <a href="<?php echo e(route('notificaciones.index')); ?>" class="text-primary">Ver
                                                todas</a>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li class="dropdown-footer text-center">
                                        <a href="<?php echo e(route('notificaciones.index')); ?>"
                                            class="btn btn-sm btn-primary">Ver todas las notificaciones</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <div id="modalMensaje" class="modal-overlay" style="display: none;">
                            <div class="modal-content">
                                <a class="logo mb-3" style="text-align: center;">
                                    <img src="<?php echo e(asset('img_eduka.png')); ?>" alt="Logo" style="height: 60px;">
                                </a>
                                ...
                                <form method="POST" action="<?php echo e(route('send.email')); ?>">
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            ...
                                            value="<?php echo e(auth()->user()->nombres); ?>">
                                    </div>
                                            ...
                                            <div class="quick-actions-items">
                                                <div class="row m-0">
                                                    <a class="col-6 col-md-4 p-0"
                                                        href="<?php echo e(route('matriculas.create')); ?>">
                                                        <div class="quick-actions-item">
                                                            <i class="flaticon-file-1"></i>
                                                            <span class="text">Matrícula Regular</span>
                                                        </div>
                                                    </a>
                                                    <a class="col-6 col-md-4 p-0" href="<?php echo e(route('notas.inicio')); ?>">
                                                        <div class="quick-actions-item">
                                                    ...
                                                    <a class="col-6 col-md-4 p-0"
                                                        href="<?php echo e(route('notas.consulta')); ?>">
                                                        <div class="quick-actions-item">
                                                    ...
                                                    <a class="col-6 col-md-4 p-0"
                                                        href="<?php echo e(route('registrarcurso.index')); ?>">
                                                        <div class="quick-actions-item">
                                                            <i class="flaticon-file-1"></i>
                                                    ...
                                                    <a class="col-6 col-md-4 p-0"
                                                        href="<?php echo e(route('registrardocente.index')); ?>">
                                                        <div class="quick-actions-item">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="<?php echo e(auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?v=' . time() : asset('adminlte/assets/img/profile.jpg')); ?>"
                                        class="avatar-img rounded-circle">
                                </div>
                            </a>
                                    ...
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img
                                                    src="<?php echo e(auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?t=' . time() : asset('adminlte/assets/img/profile.jpg')); ?>"
                                                    class="avatar-img rounded"></div>
                                            <div class="u-text">
                                                <h4><?php echo e(auth()->user()->nombres); ?><br><?php echo e(auth()->user()->apellidos); ?>

                                                </h4>

                                                <a class="badge fw-bold"
                                                    style="background-color: #347f65 !important; border: none; color:white;"><?php echo e(auth()->user()->username); ?></a>
                                            </div>
                                        </div>
                ...
                <div class="sidebar-content">
                    <div class="user nuevo-user">
                        <div class="avatar-sm float-left mr-2">
                            <img src="<?php echo e(asset('imagenes/imgDocente.png')); ?>" alt="..."
                        ...
                        <div class="info">
                            <a data-toggle="collapse" aria-expanded="true">
                                ...
                                <span>
                                    ...
                                    <span class="user-level"><?php echo e(auth()->user()->rol); ?></span>
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="dashboard">
                                <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('asistencia.docente.tomar-asistencia')); ?>">
                                                <span class="sub-item">Tomar Asistencia</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('asistencia.docente.ver-asistencias')); ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('asistencia.docente.estadisticas')); ?>">
                        ...
                        <?php if(auth()->user()->hasRole('Administrador')): ?>
                            ...
                            <li class="nav-item active mt-3">
                                ...
                                <div class="collapse" id="pagos">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('conceptospago.index')); ?>">
                            ...
                            <li class="nav-item active mt-3">
                                ...
                                <div class="collapse" id="asistencia-admin">
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('asistencia.reportes')); ?>">
                                                <span class="sub-item">Reportes de Asistencia</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo e(route('asistencia.verificar')); ?>">
                            ...
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#notas-admin"
                                    class="collapsed d-flex align-items-center justify-content-between"
                                    aria-expanded="false"
                                    style="background-color: #5C6BC0 !important; border-radius: 9px; color: white !important;">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-clipboard-list"></i>
                                        <p style="color: white !important; margin-bottom: 0;">Gestión de Notas</p>
                                    </div>
                                    <i class="fas fa-angle-down rotate-icon d-none "></i>
                                </a>
                                <div class="collapse" id="notas-admin">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('notas.inicio')); ?>">
                                                <span class="sub-item">Registrar Calificaciones</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('notas.consulta')); ?>">
                                                <span class="sub-item">Consultar Boletas</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <?php if(auth()->user()->hasRole('Docente')): ?>
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#asistencia-docente"
                                    class="collapsed d-flex align-items-center justify-content-between docente-sidebar-btn"
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-chalkboard-teacher"></i>
                                        <p class="docente-sidebar-text">Mis Asistencias</p>
                                    </div>
                                </a>
                                <div class="collapse" id="asistencia-docente">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('asistencia.docente.dashboard')); ?>">
                            ...
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#notas-docente"
                                    class="collapsed d-flex align-items-center justify-content-between"
                                    aria-expanded="false"
                                    style="background-color: #5C6BC0 !important; border-radius: 9px; color: white !important;">
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="collapse" id="notas-docente">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('notas.inicio')); ?>">
                                                <span class="sub-item">Registrar Calificaciones</span>
                        ...
                        <?php if(auth()->user()->hasRole('representante')): ?>
                            <li class="nav-item active mt-3">
                                <a data-toggle="collapse" href="#asistencia-representante"
                                    class="collapsed d-flex align-items-center justify-content-between"
                                    aria-expanded="false"
                                    style="background-color: #347f65 !important ; border-radius: 9px; color: white !important;">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-user-friends"></i>
                                        <p style="color: white !important; margin-bottom: 0;">Mis Estudiantes</p>
                                    </div>
                                </a>
                                <div class="collapse" id="asistencia-representante">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('asistencia.representante.dashboard')); ?>">
                                                <span class="sub-item">Panel Principal</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('asistencia.representante.index')); ?>">
                                                <span class="sub-item">Ver Asistencias</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('notas.misEstudiantes')); ?>">
                        ...
                        <?php if(auth()->user()->hasRole('Administrador')): ?>
                            ...
                            <li class="nav-item active mb-2">
                                ...
                                <div class="collapse" id="base">
                                    ...
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('asignaturas.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Asignaturas</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('periodos-evaluacion.index')); ?>"
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('registrarcurso.index')); ?>" class="evitar-recarga">
                            ...
                            <li class="nav-item active mb-2">
                                ...
                                <div class="collapse" id="Estudiantil">
                                    ...
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('estudiantes.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Estudiantes</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo e(route('registrarrepresentante.index')); ?>"
                                                class="evitar-recarga">
                            ...
                            <li class="nav-item active mb-2">
                                ...
                                <div class="collapse" id="Personal">
                                    ...
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('registrardocente.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Docentes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('cursoasignatura.index')); ?>" class="evitar-recarga">
                            ...
                            <li class="nav-item active mb-2">
                                ...
                                <div class="collapse" id="Educativa">
                                    ...
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('registrarnivel.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Niveles Educativos</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('aulas.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Aulas</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo e(route('grados.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Grados</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo e(route('secciones.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Secciones</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo e(route('aniolectivo.index')); ?>" class="evitar-recarga">
...
-->
                            <li class="nav-item active mb-2">
                                ...
                                <div class="collapse" id="Sistema">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="<?php echo e(route('feriados.index')); ?>" class="evitar-recarga">
                                                <span class="sub-item">Feriados</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('comunicado.index')); ?>" class="evitar-recarga">
        ...
        <div class="main-panel">
            <?php if(Request::is('rutarrr1')): ?>
                <div class="content">
                    <div class="panel-header"
                        style="
        background: linear-gradient(135deg, #053255, #0e4067, #053255);
     ...
     ">
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <h5 class="text-white op-7 mb-2">Sistema Intranet del <?php echo e(Auth()->user()->rol); ?>
                                ...
                                <div class="ml-md-auto py-2 py-md-0">
                                    ...
                                    <a href="<?php echo e(route('landing')); ?>" target="_blanck"
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                                    <img src="<?php echo e(asset('imagenes/logo-icon.png')); ?>"
                                        ...
                                        <div class="card-head-row ">
                                            ...
                                            <div class="card-tools">
                                                <button id="btn-export"
                                                    class="btn btn-info btn-border btn-round btn-sm d-flex align-items-center"
                                                    style="color:#0e4067 !important; border-color:#0e4067 !important; font-weight:bold;">
                                                    <i class="ti ti-download mx-2" style="font-size:17px"></i>
                                                    <span>
                                        ...
                                        <div class="carousel-container d-block "
                                            ...
                                            <div id="flyerCarousel" class="carousel slide" data-ride="carousel"
                                                ...
                                                <div class="carousel-inner">
                                                    ...
                                                    <?php $firstShown = false; ?>

                                                    <?php $__empty_1 = true; $__currentLoopData = $flyer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <?php
                                                        ...
                                                        <?php if(($hoy->between($fechaInicio, $fechaLimite) && $publico == auth()->user()->rol) || $publico == 'General'): ?>
                                                            <div
                                                                class="carousel-item <?php echo e(!$firstShown ? 'active' : ''); ?> ">
                                                                <img src="<?php echo e($foto); ?>" alt="Flyer"
        ...
        <?php endif; ?>
        <div class="content">
            <?php echo $__env->yieldContent('contenidoplantilla'); ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-success shadow-lg">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <p class="mt-2"><?php echo e(session('modal_success')); ?></p>
                            </div>
  ...
  <div class="custom-template">
   ...
   <div class="custom-toggle">
    ...
    <!-- Core JS Files -->
    <script src="<?php echo e(asset('adminlte/assets/js/core/jquery.3.2.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('adminlte/assets/js/core/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('adminlte/assets/js/core/bootstrap.min.js')); ?>"></script>

    <!-- jQuery UI -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')); ?>"></script>

    <!-- jQuery Scrollbar -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js')); ?>"></script>

    <!-- Chart JS -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/chart.js/chart.min.js')); ?>"></script>

    <!-- jQuery Sparkline -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js')); ?>"></script>

    <!-- Chart Circle -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/chart-circle/circles.min.js')); ?>"></script>

    <!-- Datatables -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/datatables/datatables.min.js')); ?>"></script>

    <!-- Bootstrap Notify -->


    <!-- jQuery Vector Maps -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jqvmap/jquery.vmap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js')); ?>"></script>

    <!-- Sweet Alert -->
    <script src="<?php echo e(asset('adminlte/assets/js/plugin/sweetalert/sweetalert.min.js')); ?>"></script>

    <!-- Atlantis JS -->
    <script src="<?php echo e(asset('adminlte/assets/js/atlantis.min.js')); ?>"></script>

    <!-- Atlantis DEMO methods, don't include it in your project! -->
    <script src="<?php echo e(asset('adminlte/assets/js/setting-demo.js')); ?>"></script>

    <script>
        if (performance.getEntriesByType("navigation")[0]?.type === "back_forward") {
            location.href = "<?php echo e(route('login.index')); ?>"; // redirige directo si vuelve con botón atrás
        }
    </script>
  ...
  =========================*/
    ...
    <script>
        ...
        function loadNotifications() {
            fetch('<?php echo e(route('notificaciones.recent')); ?>')
        ...
        function updateNotificationDropdown(notifications) {
            ...
            if (notifications.length === 0) {
                list.innerHTML =
                    '<li class="dropdown-item text-center"><small class="text-muted">No hay notificaciones</small></li>';
                return;
            }
        ...
        window.addEventListener('resize', function() {
            ...
            if (window.innerWidth >= 992 && mobileNavbar && !mobileNavbar.classList.contains(
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            customSidebar.innerHTML = `
                <div class="custom-sidebar-header">
                    <div class="custom-user-info">
                        <img src="<?php echo e(auth()->user()->foto_url ? asset('storage/' . auth()->user()->foto_url) . '?v=' . time() : asset('imagenes/imgDocente.png')); ?>" alt="User" class="custom-user-avatar">
                        <div class="custom-user-details">
                            <div class="custom-user-name"><?php echo e(auth()->user()->nombres); ?></div>
                            <div class="custom-user-role"><?php echo e(auth()->user()->rol); ?></div>
                        </div>
                    </div>
                </div>
                <nav class="custom-sidebar-nav">
                        ...
                        <div class="custom-nav-group">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="matriculas-content">
                                    <a href="<?php echo e(route('matriculas.create')); ?>" class="custom-nav-link">
                                        <i class="fas fa-plus-circle"></i>
                                        <span>Nueva Matrícula</span>
                                    </a>
                                    <a href="<?php echo e(route('matriculas.index')); ?>" class="custom-nav-link">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="pagos-content">
                                    <a href="<?php echo e(route('conceptospago.index')); ?>" class="custom-nav-link">
                                        <i class="fas fa-tags"></i>
                                        <span>Conceptos de Pago</span>
                                    </a>
                                    <a href="<?php echo e(route('pagos.index')); ?>" class="custom-nav-link">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="asistencias-content">
                                    <a href="<?php echo e(route('asistencia.admin-index')); ?>" class="custom-nav-link">
                                        <i class="fas fa-chart-bar"></i>
                                        <span>Administrar</span>
                                    </a>
                                    <a href="<?php echo e(route('asistencia.reportes')); ?>" class="custom-nav-link">
                                        <i class="fas fa-file-alt"></i>
                                        <span>Reportes</span>
                                    </a>
                                    <a href="<?php echo e(route('asistencia.verificar')); ?>" class="custom-nav-link">
                            ...
                            <!-- Gestión de Notas -->
                            <div class="custom-nav-section">
                                <div class="custom-section-header notas-header" data-toggle="notas">
                                    <div class="custom-section-icon">
                                        <i class="fas fa-star"></i>
                                    </div>
                                    <span class="custom-section-title">Gestión de Notas</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="notas-content">
                                    <a href="<?php echo e(route('notas.inicio')); ?>" class="custom-nav-link">
                                        <i class="fas fa-edit"></i>
                                        <span>Registrar Calificaciones</span>
                                    </a>
                                    <a href="<?php echo e(route('notas.consulta')); ?>" class="custom-nav-link">
                                        <i class="fas fa-search"></i>
                                        <span>Consultar Boletas</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="custom-nav-group">
                            ...
                            <div class="custom-nav-section">
                                <div class="custom-section-header mantenedores-header" data-toggle="academica">
                                    ...
                                    <span class="custom-section-title">Gestión Académica</span>
                                    <i class="fas fa-chevron-down custom-section-arrow"></i>
                                </div>
                                <div class="custom-section-content" id="academica-content">
                                    <a href="<?php echo e(route('asignaturas.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-book"></i>
                                        <span>Asignaturas</span>
                                    </a>
                                    <a href="<?php echo e(route('periodos-evaluacion.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-calendar-alt"></i>
                                        <span>Periodos de Evaluación</span>
                                    </a>
                                    <a href="<?php echo e(route('registrarcurso.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-graduation-cap"></i>
                                        <span>Registrar Cursos</span>
                                    </a>
                                    <a href="<?php echo e(route('periodos.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-calendar-check"></i>
                                        <span>Períodos de Matrícula</span>
                                    </a>
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="estudiantil-content">
                                    <a href="<?php echo e(route('estudiantes.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-user-plus"></i>
                                        <span>Estudiantes</span>
                                    </a>
                                    <a href="<?php echo e(route('registrarrepresentante.index')); ?>" class="custom-nav-link mantenedores-link">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="docente-content">
                                    <a href="<?php echo e(route('registrardocente.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-user-graduate"></i>
                                        <span>Docentes</span>
                                    </a>
                                    <a href="<?php echo e(route('cursoasignatura.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-clipboard-list"></i>
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="plan-content">
                                    <a href="<?php echo e(route('registrarnivel.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-layer-group"></i>
                                        <span>Niveles</span>
                                    </a>
                                    <a href="<?php echo e(route('aulas.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-door-open"></i>
                                        <span>Aulas</span>
                                    </a>
                                    <a href="<?php echo e(route('grados.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-sort-numeric-up"></i>
                                        <span>Grados</span>
                                    </a>
                                    <a href="<?php echo e(route('secciones.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-th-large"></i>
                                        <span>Secciones</span>
                                    </a>
                                    <a href="<?php echo e(route('aniolectivo.index')); ?>" class="custom-nav-link mantenedores-link">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="sistema-content">
                                    <a href="<?php echo e(route('feriados.index')); ?>" class="custom-nav-link mantenedores-link">
                                        <i class="fas fa-calendar-times"></i>
                                        <span>Feriados</span>
                                    </a>
                                    <a href="<?php echo e(route('comunicado.index')); ?>" class="custom-nav-link mantenedores-link">
                            ...
                            <div class="custom-nav-section">
                                ...
                                <div class="custom-section-content" id="usuarios-content">
                                    <a href="<?php echo e(route('usuarios.index')); ?>" class="custom-nav-link mantenedores-link">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="custom-nav-section">
                            <div class="custom-section-header docente-section-header" data-toggle="docente-principal">
                                <div class="custom-section-icon">
                                    <i class="fas fa-chalkboard-teacher"></i>
                                </div>
                            ...
                            <div class="custom-section-content" id="docente-principal-content">
                                <a href="<?php echo e(route('asistencia.docente.dashboard')); ?>" class="custom-nav-link">
                                    <i class="fas fa-tachometer-alt"></i>
                                    <span>Panel Principal</span>
                                </a>
                                <a href="<?php echo e(route('asistencia.docente.tomar-asistencia')); ?>" class="custom-nav-link">
                                    <i class="fas fa-clipboard-check"></i>
                                    <span>Tomar Asistencia</span>
                                </a>
                                <a href="<?php echo e(route('asistencia.docente.ver-asistencias')); ?>" class="custom-nav-link">
                                    <i class="fas fa-eye"></i>
                                    <span>Ver Asistencias</span>
                                </a>
                                <a href="<?php echo e(route('asistencia.docente.estadisticas')); ?>" class="custom-nav-link">
                        ...
                        <!-- Gestión de Notas Section -->
                        <div class="custom-nav-section">
                            <div class="custom-section-header docente-section-header" data-toggle="docente-notas">
                                <div class="custom-section-icon">
                                    <i class="fas fa-book-open"></i>
                                </div>
                                <span class="custom-section-title">Detalle Notas</span>
                                <i class="fas fa-chevron-down custom-section-arrow"></i>
                            </div>
                            <div class="custom-section-content" id="docente-notas-content">
                                <a href="<?php echo e(route('notas.inicio')); ?>" class="custom-nav-link">
                                    <i class="fas fa-edit"></i>
                                    <span>Registrar Calificaciones</span>
                                </a>
                    ...
                    <?php if(auth()->user()->hasRole('representante')): ?>
                        ...
                        <div class="custom-nav-section">
                            ...
                            <div class="custom-section-content" id="representante-estudiantes-content">
                                <a href="<?php echo e(route('asistencia.representante.dashboard')); ?>" class="custom-nav-link">
                                    <i class="fas fa-home"></i>
                                    <span>Panel Principal</span>
                                </a>
                                <a href="<?php echo e(route('asistencia.representante.index')); ?>" class="custom-nav-link">
                                    <i class="fas fa-eye"></i>
                                    <span>Ver Asistencias</span>
                                </a>
                                <a href="<?php echo e(route('notas.misEstudiantes')); ?>" class="custom-nav-link">
                                    <i class="fas fa-chart-line"></i>
                    ...
                    <?php if(auth()->user()->hasRole('Estudiante')): ?>
                        <!-- Mi Panel Section -->
                        <div class="custom-nav-section">
                            ...
                            <div class="custom-section-content" id="estudiante-panel-content">
                                <a href="<?php echo e(route('estudiante.dashboard')); ?>" class="custom-nav-link">
                                    <i class="fas fa-tachometer-alt"></i>
                                    <span>Dashboard</span>
                                </a>
                                <a href="<?php echo e(route('estudiante.asistencia')); ?>" class="custom-nav-link">
                                    <i class="fas fa-calendar-check"></i>
                                    <span>Mi Asistencia</span>
                                </a>
                                <a href="<?php echo e(route('estudiante.calificaciones')); ?>" class="custom-nav-link">
                                    <i class="fas fa-chart-bar"></i>
            ...
            customStyles.textContent = `
                ...
                .matriculas-header {
                    background: #28a745;
                    border-radius-bottom-left: none !important;
                ...
                /* GESTIÓN ACADÉMICA - Color dorado */
                .periodos-header {
                ...
                .docente-sidebar-text {
                    color: white !important;
                    margin-bottom: 0 !important;
                }

                /* Original sidebar docente button */
                .sidebar .nav .nav-item a.docente-sidebar-btn {
                    background: #007bff !important;
                    color: white !important;
                    border-radius: 9px !important;
                    border: 2px solid #0056b3 !important;
                ...
                .sidebar .nav .nav-item a.docente-sidebar-btn .docente-sidebar-text {
                    color: white !important;
                    margin-bottom: 0 !important;
                }

                /* Force override for docente sidebar button */
                a.docente-sidebar-btn[aria-expanded] {
                    background: #007bff !important;
                    color: white !important;
                }

                a.docente-sidebar-btn[aria-expanded]:hover {
                    background: #0056b3 !important;
                    color: white !important;
                }

                .representante-header {
                    background: #347f65 !important;
                    color: white !important;
                    border: 2px solid #2e5f4f !important;
                }
            ...
            sectionHeaders.forEach(header => {
                header.addEventListener('click', function(e) {
                    ...
                    // If clicking on a link, let the event bubble up naturally
                });
            });

            // Add submenu functionality
            const submenuHeaders = customSidebar.querySelectorAll('.custom-submenu-header');
            submenuHeaders.forEach(header => {
                header.addEventListener('click', function(e) {
                    e.stopPropagation(); // Prevent triggering parent section toggle

                    const toggleId = this.getAttribute('data-toggle');
                    const content = document.getElementById(toggleId + '-content');

                    if (content) {
                        // Toggle show class on submenu content
                        content.classList.toggle('show');

                        // Toggle arrow rotation
                        const arrow = this.querySelector('.custom-submenu-arrow');
                        if (arrow) {
                            arrow.classList.toggle('rotated');
                        }

                        console.log('Toggled submenu:', toggleId);
                    }
                });
            });

            // Fix navigation for sidebar links
            const sidebarLinks = customSidebar.querySelectorAll('.custom-nav-link');
            sidebarLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    if (sidebarVisible) {
                        customSidebar.style.setProperty('left', '-280px', 'important');
        ...
        function toggleCustomSidebar() {
            ...
            try {
                ...
                const nuevologo = document.getElementById('icon-menu');
                ...
                if (sidebar) {
                    if (sidebarVisible) {
                        ...
                        nuevologo.className = 'ti ti-menu';
                    } else {
                ...
                mobileNotifications.innerHTML = `
                    <div class="mobile-dropdown-content">
                        ...
                        <div class="mobile-dropdown-footer">
                            <a href="<?php echo e(route('notificaciones.index')); ?>" class="btn btn-primary btn-sm">Ver todas</a>
                        </div>
                    </div>
                `;
                        ...
                        <div class="mobile-dropdown-body">
                            <div class="mobile-profile-info">
                                ...
                                <div class="mobile-profile-details">
                                    <h6><?php echo e(auth()->user()->nombres); ?> <?php echo e(auth()->user()->apellidos); ?></h6>
                                    <span class="badge"><?php echo e(auth()->user()->rol); ?></span>
                                </div>
                            </div>
                            <hr>
                            <a href="<?php echo e(route('profile.show')); ?>" class="mobile-dropdown-link">
    ...
    <?php echo $__env->yieldPushContent('js-extra'); ?>
    ...
    <?php if(Request::is('rutarrr1')): ?>
        ...
        <script>
            window.botmanWidget = {
                ...
                chatServer: '/botman',
                title: '🤖 Tío Edú',
                introMessage: '👋 <b>¡Hola <?php echo e(auth()->user()->nombres); ?>!</b> <br> Soy tu Tío Edú, asistente virtual de Eduka Perú. Escribe "menu" para ver lo que puedo hacer por ti.',
                ...
                bubbleAvatarUrl: '<?php echo e(asset('imagenes/imgTioEduka.png')); ?>',
...
<?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/cplantilla/bprincipal.blade.php ENDPATH**/ ?>