<?php $__env->startSection('titulo', 'Años Lectivos'); ?>
<?php $__env->startSection('contenidoplantilla'); ?>
    ...
    <?php echo $__env->make('ccomponentes.loader', ['id' => 'loaderPrincipalAnioLectivo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> 
                ...
                <div class="card">
                    <div class="estilo-info btn btn-block btn_header header_6">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-md-5 mb-md-0 d-flex justify-content-start">
                                <a href="<?php echo e(route('aniolectivo.create')); ?>" id="nuevoRegistroBtns"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            <?php echo $__env->make('ccomponentes.loader', ['id' => 'loaderTablaAnioLectivo'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <div id="tabla-aniolectivo" style="position: relative;">
                                <?php echo $__env->make('ceinformacion.añolectivo.tabla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchAnioLectivo(url = null) {
                ...
                const fetchUrl = url ||
                    `<?php echo e(route('aniolectivo.index')); ?>?buscarpor=${encodeURIComponent(valorBuscar)}`;
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/ceinformacion/añolectivo/registrar.blade.php ENDPATH**/ ?>