<?php $__env->startSection('titulo','Gestión de Períodos Académicos'); ?>
<?php $__env->startSection('contenidoplantilla'); ?>
<?php if (isset($component)) { $__componentOriginale19f62b34dfe0bfdf95075badcb45bc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale19f62b34dfe0bfdf95075badcb45bc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['module' => 'periodos','section' => 'gestion']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['module' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('periodos'),'section' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('gestion')]); ?>
            ...
            <div class="box_block">
                ...
                <div class="collapse show" id="collapseTablaPeriodos">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2" style="background: transparent;">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2 flex-wrap">
                                    <!-- Acciones rápidas eliminadas según requerimientos -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <a href="<?php echo e(route('periodos.create')); ?>" class="btn btn-success">
                        ...
                        <div class="row mb-3 align-items-end" id="filtrosContainer">
                            <div class="col-md-4">
                                ...
                                <select class="form-control filtro-input filtro-auto" id="estado" name="estado">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control filtro-input filtro-auto" id="tipo_periodo" name="tipo_periodo">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div id="activeFilters" class="flex-fill">
                                        <small class="text-muted">Sin filtros aplicados</small>
                                    </div>
                                    <button type="button" class="btn btn-sm btn-outline-secondary d-none" id="btnLimpiarFiltros" title="Limpiar todos los filtros">
                                ...
                                <div class="stats-compact d-flex justify-content-between align-items-center p-3 rounded" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 1px solid #dee2e6;">
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-info stat-badge"><?php echo e($periodos->total()); ?></span>
                                        </div>
                                        <small class="text-muted d-block">Total Períodos</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-success stat-badge"><?php echo e($periodos->filter(fn($p) => $p->estaActivo())->count()); ?></span>
                                        </div>
                                        <small class="text-muted d-block">Activos</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-warning stat-badge"><?php echo e($periodos->filter(fn($p) => $p->estaProximo())->count()); ?></span>
                                        </div>
                                        <small class="text-muted d-block">Próximos</small>
                                    </div>
                                    <div class="stat-item text-center">
                                        <div class="stat-value">
                                            <span class="badge badge-secondary stat-badge"><?php echo e($periodos->filter(fn($p) => $p->haTerminado())->count()); ?></span>
                                        </div>
                        ...
                        <div class="table-responsive table-container" style="position: relative;">
                            <!-- Overlay de carga -->
                            <?php echo $__env->make('ccomponentes.loader', ['id' => 'tableLoadingOverlay'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <table id="add-row" class="table-hover table" style="border: 1px solid #0A8CB3; border-radius: 10px; overflow: hidden;">
                                ...
                                <tbody id="tbodyPeriodos">
                                    <?php $__empty_1 = true; $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($periodo->nombre); ?></strong>
                                                <?php if($periodo->descripcion): ?>
                                                    <br><small class="text-muted"><?php echo e(Str::limit($periodo->descripcion, 40)); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td><code><?php echo e($periodo->codigo); ?></code></td>
                                            <td>
                                                <?php if($periodo->tipo_periodo === 'PREINSCRIPCION'): ?>
                                                    <span class="badge badge-info"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php elseif($periodo->tipo_periodo === 'INSCRIPCION'): ?>
                                                    <span class="badge badge-success"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php elseif($periodo->tipo_periodo === 'MATRICULA'): ?>
                                                    <span class="badge badge-primary"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php elseif($periodo->tipo_periodo === 'ACADEMICO'): ?>
                                                    <span class="badge badge-warning"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php elseif($periodo->tipo_periodo === 'CIERRE'): ?>
                                                    <span class="badge badge-secondary"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php else: ?>
                                                    <span class="badge badge-secondary"><?php echo e($periodo->tipo_periodo); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($periodo->anoLectivo->nombre ?? 'N/A'); ?></td>
                                            <td><?php echo e($periodo->fecha_inicio->format('d/m/Y')); ?></td>
                                            <td><?php echo e($periodo->fecha_fin->format('d/m/Y')); ?></td>
                                            <td>
                                                <span class="badge <?php echo e($periodo->estado === 'ACTIVO' ? 'badge-success' : 'badge-secondary'); ?>">
                                                    <?php echo e($periodo->estado); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($periodo->estaActivo()): ?>
                                                    <span class="badge badge-success">
                                                        <i class="fas fa-play"></i> ACTIVO
                                                    </span>
                                                <?php elseif($periodo->estaProximo()): ?>
                                                    <span class="badge badge-warning">
                                                        <i class="fas fa-clock"></i> PRÓXIMO
                                                    </span>
                                                <?php elseif($periodo->haTerminado()): ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('periodos.edit', $periodo)); ?>" class="btn btn-sm btn-info" title="Editar período">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-info">
                                    <h6><i class="fas fa-shield-alt"></i> Sistema Seguro de Gestión de Períodos</h6>
                                    <ul class="mb-0">
                                        <li><strong>Activación Automática:</strong> Los períodos se activan automáticamente según sus fechas programadas</li>
                                        <li><strong>Orden Sistemático:</strong> El orden de los períodos se determina automáticamente por tipo (Pre-inscripción → Inscripción → Matrícula → Académico → Cierre)</li>
                                        ...
                                        <li><strong>Validación de Consistencia:</strong> El sistema previene conflictos entre períodos del mismo tipo</li>
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle"></i> Los períodos no se pueden activar/desactivar manualmente para evitar inconsistencias en los datos.
                                        </small>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    // Función para mostrar/ocultar indicador de carga sobre la tabla
    ...
    function updateActiveFilters() {
        ...
        const clearBtn = $('#btnLimpiarFiltros');

        let activeFilters = [];

        if (estado) {
            activeFilters.push(`Estado: ${estado}`);
        }
        if (tipo_periodo) {
            activeFilters.push(`Tipo: ${tipo_periodo}`);
        }

        if (activeFilters.length > 0) {
            activeFiltersDiv.html(`<small class="text-primary fw-bold">${activeFilters.join(', ')}</small>`);
            clearBtn.removeClass('d-none');
        } else {
            activeFiltersDiv.html('<small class="text-muted">Sin filtros aplicados</small>');
    ...
    function applyFilters() {
        ...
        if (tipo_periodo) params.tipo_periodo = tipo_periodo;

        // Hacer petición AJAX
        $.ajax({
            url: '<?php echo e(route("periodos.index")); ?>',
            type: 'GET',
            data: params,
            headers: {
            ...
            success: function(response) {
                ...
                $('#estadisticasContainer').replaceWith($(response).find('#estadisticasContainer'));
                $('#tbodyPeriodos').html($(response).find('#tbodyPeriodos').html());
                $('#paginacionContainer').replaceWith($(response).find('#paginacionContainer'));
            ...
            error: function(xhr, status, error) {
                ...
                Swal.fire({
                    title: 'Error',
                    text: 'Hubo un problema al filtrar los períodos. Por favor, inténtalo de nuevo.',
                    icon: 'error',
    ...
    // Aplicar filtros automáticamente cuando cambien los selectores
    $('.filtro-auto').on('change', function() {
        // Limpiar timeout anterior
        clearTimeout(filterTimeout);

        // Aplicar filtros con delay de 300ms para evitar llamadas excesivas
    ...
    $('#btnLimpiarFiltros').on('click', function() {
        ...
        // Aplicar filtros inmediatamente (sin delay)
        setTimeout(function() {
            applyFilters();
        }, 100);
    });

    // Inicializar indicadores de filtros
    updateActiveFilters();
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ronaldoroblesromero/Herd/edukaSchool/resources/views/periodos/index.blade.php ENDPATH**/ ?>