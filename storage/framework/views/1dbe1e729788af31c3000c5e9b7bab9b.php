<?php $__env->startSection('title', 'Eduka School | Trujillo - Perú'); ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top edu-navbar">
            <div class="container edu-nav-container">
                ...
                <a class="navbar-brand d-flex align-items-center" href="#inicio">
                    <img src="<?php echo e(asset('imagenes/Imagen1.png')); ?>" alt="EDUKA" style="height:70px;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-lg-center edu-menu text-center text-lg-start">
                        ...
                        <li class="nav-item ms-lg-4 mt-3 mt-lg-0">
                            <a class="edu-btn-login d-inline-block" href="<?php echo e(route('login.index')); ?>" target="_blank">
                                Portal Académico
                            </a>
                        </li>
                    </ul>
        ...
        <section id="admision" class="process-section">
            <div class="container">
                ...
                <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="500">
                    <a href="<?php echo e(route('login.index')); ?>" class="btn btn-custom btn-primary-custom btn-lg">
...
<?php echo $__env->make('layout.eduka', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ronaldo Robles\Music\eduka_11012026_Final_V6\resources\views/landing/index.blade.php ENDPATH**/ ?>