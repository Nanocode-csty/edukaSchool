<?php $__env->startSection('titulo', 'Registro y listado de pagos'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4 align-items-center ">
                            ...
                            <div class="col-md-6 d-flex justify-content-md-end justify-content-start estilo-info">
                                <form method="GET" action="<?php echo e(route('matriculas.index')); ?>" class="w-100"
                                    ...
                                    <div class="input-group">
                                        <input id="buscarpor" type="text" class="form-control mt-3" name="buscarpor"
                                            ...
                                            value="<?php echo e($buscarpor); ?>" aria-label="Buscar por número de matrícula"
                        ...
                        <?php if($pagos->count() > 0): ?>
                            ...
                            <div id="tabla-pagos" style="position: relative;">
                                <?php echo $__env->make('cpagos.pagos.pagos', [
                                    'pagos' => $pagos,
...
<?php echo $__env->make('cplantilla.bprincipal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ronaldoroblesromero/Herd/edukaSchool/resources/views/cpagos/pagos/index.blade.php ENDPATH**/ ?>