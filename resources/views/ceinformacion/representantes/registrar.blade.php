                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row d-flex align-items-center justify-content-center gap-4 my-4">
                            <div class="col-md-3 d-flex align-items-center justify-content-center">
                                ...
                                <a id="btnRegistrar" href="{{ route('representante.create') }}"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row mb-2 d-flex align-items-center">
                            ...
                            <div class="col-12 col-md-6 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('estudiantes.create') }}" id="nuevoRegistroBtns"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('representante.index') }}?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
