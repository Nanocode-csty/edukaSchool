            ...
            @foreach ($anoslectivos as $anio)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @else
                            <span
                                class="badge bg-secondary text-white fw-bold px-3 py-1 rounded-pill">{{ $anio->estado }}</span>
                        @endif
                    </td>
                    <td class="text-center">
                        <button class="btn btn-outline-primary btn-sm toggle-detalle"
                            data-id="{{ $anio->ano_lectivo_id }}">
                        ...
                        @else
                            <a href="{{ route('aniolectivo.edit', $anio->ano_lectivo_id) }}"
                                class="btn btn-sm btn-outline-primary" title="Editar">
                                <i class="ti ti-edit"></i>
                            </a>
                            <form action="{{ route('aniolectivo.destroy', $anio->ano_lectivo_id) }}" method="POST"
