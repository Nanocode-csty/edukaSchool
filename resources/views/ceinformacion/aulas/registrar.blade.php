...
@section('contenidoplantilla')
    ...
    @include('ccomponentes.loader', ['id' => 'loaderPrincipalAulas']) {{-- Usa este ID --}}
                ...
                <div class="card">
                    <div class="estilo-info btn btn-block btn_header header_6">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-md-5 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('aulas.create') }}" id="nuevoRegistroBtns"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            @include('ccomponentes.loader', ['id' => 'loaderTablaAulas'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('aulas.index') }}?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
