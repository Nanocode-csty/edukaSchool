...
@section('contenidoplantilla')
    ...
    @include('ccomponentes.loader', ['id' => 'loaderPrincipalSecciones']) {{-- Usa este ID --}}
                    ...
                    <div class="estilo-info btn btn-block btn_header header_6">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-md-5 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('secciones.create') }}" id="nuevoRegistroBtns"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row mb-2 d-flex align-items-center">
                            ...
                            <div class="col-12 col-md-6 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('docente.create') }}" id="nuevoRegistroBtns"
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            @include('ccomponentes.loader', ['id' => 'loaderTablaSecciones'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('secciones.index') }}?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
