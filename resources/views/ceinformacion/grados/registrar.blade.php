...
@section('contenidoplantilla')
    ...
    @include('ccomponentes.loader', ['id' => 'loaderPrincipalGrados']) {{-- Usa este ID --}}
                ...
                <div class="card">
                    <div class="estilo-info btn btn-block btn_header header_6">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-md-5 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('grados.create') }}" id="nuevoRegistroBtns"
                    ...
                    <div class="card-body" style="background-color: #fff">
                                ...
                                <div class="dropdown w-100">
                                    ...
                                    <ul class="dropdown-menu shadow w-100">
                                        ...
                                        @foreach ($niveles as $nivel)
                                            <li>
                                                <a class="dropdown-item filtro-opcion" data-id="{{ $nivel->nivel_id }}">
                                                    {{ $nivel->nombre }}
                                                </a>
                                            </li>
                                        @endforeach
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            @include('ccomponentes.loader', ['id' => 'loaderTablaGrados'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('grados.index') }}?buscarpor=${encodeURIComponent(buscar)}&nivel_id=${nivelId}&page=${page}`;
