                    ...
                    <div class="card card-body rounded-0 border-0 pt-0">
                        <div class="row margen-movil" style="padding:20px;">
                            <div class="col-12">
                                ...
                                <form id="formNivel" method="POST" action="{{ route('registrarnivel.store') }}"
                                    ...
                                    <div class="card" style="border: none">
                                        ...
                                        <div class="card-body"
                                            ...
                                            <x-form.field name="nombre" label="Nombre de Nivel Educativo" />
                                    ...
                                    <div class="row  d-flex justify-content-between align-items-center gap-4">
                                        ...
                                        <a id="cancelar" href="{{ route('registrarnivel.index') }}"
