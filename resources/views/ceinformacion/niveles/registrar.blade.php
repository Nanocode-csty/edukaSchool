...
@section('contenidoplantilla')
    ...
    @include('ccomponentes.loader', ['id' => 'loaderPrincipalNiveles']) {{-- Usa este ID --}}
                ...
                <div class="card">
                    <div class="estilo-info btn btn-block btn_header header_6">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-12 col-md-5 mb-md-0 d-flex justify-content-start">
                                <a href="{{ route('registrarnivel.create') }}" id="nuevoRegistroBtn"
                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            @include('ccomponentes.loader', ['id' => 'loaderTablaNiveles'])

                            <div id="tabla-niveles" style="position: relative;">
                                @include('ceinformacion.niveles.tabla', ['niveles' => $niveles])
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('registrarnivel.index') }}?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const regresarBtns = document.querySelectorAll(
                'a.btn-danger[href="{{ route('registrarnivel.index') }}"]');
