                    ...
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div class="row d-flex align-items-center justify-content-center gap-4 my-4">
                            <div class="col-md-3 d-flex align-items-center justify-content-center">
                                ...
                                <a id="btnRegistrar" href="{{ route('estudiantes.create') }}"
                ...
                <div class="box_block">
                    <div class="card-body" style="background-color: #fff">
                        ...
                        <div id="tabla-wrapper" style="position: relative; min-height: 200px;">
                            ...
                            @include('ccomponentes.loader', ['id' => 'loaderTabla'])
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function cargarTabla(buscar = '', page = 1) {
                ...
                const url =
                    `{{ route('estudiantes.index') }}?buscarpor=${encodeURIComponent(buscar)}&page=${page}`;
