                ...
                @foreach ($pagos as $index => $pago)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @endphp
                            <span class="{{ $estaVencido && $pago->estado !== 'Pagado' ? 'text-danger font-weight-bold' : '' }}">
                                {{ $fechaVencimiento->format('d/m/Y') }}
                                @if($estaVencido && $pago->estado !== 'Pagado')
                        ...
                        <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu shadow border-0 rounded-3"
                                        ...
                                        <script>
                                            ...
                                            if (typeof window.mercadoPagoInitialized === 'undefined') {
                                                ...
                                                try {
                                                    window.mp = new MercadoPago("{{ config('services.mercadopago.public_key') }}", {
                                                        locale: 'es-PE' // 🇵🇪 Perú
                                                    });
                            ...
                            @else
                                <a id="btn-nuevo" class="text-center dropdown-item fw-bold"
                                    href="{{ route('pagos.show', $pago->pago_id) }}"
