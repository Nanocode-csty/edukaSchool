<div class="card mt-4 " style="border: none">
    ...
    <div class="card-body"
        ...
        <x-form.field name="telefono" label="Teléfono" type="text" inputmode="numeric" maxlength="11" />

        <x-form.field name="email" label="Correo electrónico" type="email" inputmode="email" maxlength="100">
...
<script>
    ...
    $('#email').on('input', function() {
        ...
        timeout = setTimeout(function() {
            ...
            $.ajax({
                url: "{{ route('verificar.email.representante') }}",
                method: 'GET',
                data: {
                    email
                },
