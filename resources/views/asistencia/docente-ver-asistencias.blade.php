                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @php
                                                $estudiantesMatriculados = $sesion->cursoAsignatura->curso->matriculas()->with('estudiante.persona')->where('estado', 'Matriculado')->get();
                                                $totalEstudiantes = $estudiantesMatriculados->count();

                                                // Solo contar asistencias de estudiantes matriculados
                                                $asistenciasRegistradas = 0;
                                                $presentes = 0;
                                                $ausentes = 0;

                                                foreach($estudiantesMatriculados as $matricula) {
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card bg-warning">
                                                        <div class="card-body text-center">
                                                            <h4>{{ max(0, $totalEstudiantes - $asistenciasRegistradas) }}</h4>
                                            ...
                                            @else
                                                <div class="text-center py-5">
                                                    ...
                                                    <button class="btn btn-primary" onclick="editarAsistenciaSesion({{ $sesion->sesion_id ?? 'null' }})">
                                                        <i class="fas fa-edit"></i> Editar Asistencia
                                                    </button>
                                                </div>
                                            @endif
